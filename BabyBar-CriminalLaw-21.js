const examData = [
    ...
    },
    {
        ...
        ans: 3,
        exp: "Persons are guilty of conspiracy to commit a particular crime when they agree to commit it. At common law, burglary is defined as breaking and entering into the dwelling of another at night for the purpose of committing a larceny or any felony therein. Since the agreement was to break into an office rather than a dwelling, and to do so at lunchtime rather than nighttime, it was not a conspiracy to commit burglary. At common law, larceny is defined as intentionally taking and carrying off the personal property of another with the intent to permanently deprive the owner of it. Since the agreement was to copy but not carry off the professor's notes, it was not a conspiracy to commit larceny. A, B, and C are thus incorrect."
    },
    {
        id: 18,
        ...
        ans: 0,
        exp: "Murder is the unlawful killing of another with malice aforethought. Even if there is no intent to kill, malice aforethought can be implied when there is a reckless indifference to an unjustifiably high risk to human life. This is also known as depraved heart murder. Here, because the defendant shot as close as he could to his friend as his friend ran in front of a concrete wall, a court would likely find he acted with reckless indifference to an unjustifiably high risk to human life. Consequently, he could be charged with murder. D is therefore incorrect.\n\nIn most cases, voluntary manslaughter requires the defendant to kill in the 'heat of passion.' This requires some type of provocation that causes the defendant to lose self-control. B is incorrect because there was no provocation. A defendant can be found guilty of involuntary manslaughter when his or her behavior is grossly negligent and an accidental death results. As stated above, a court would likely find the defendant's actions to be more than negligence, so C is incorrect."
    },
    {
        id: 19,
    ...
    },
    {
        ...
        ans: 3,
        exp: "Embezzlement is the conversion of personal property known to be another's with the intent to defraud, by a person in lawful possession of the property. Since the seller's possession was the result of fraud and therefore not lawful, he is not guilty of embezzlement. A and C are therefore incorrect. Larceny by trick is committed when the defendant fraudulently induces the victim to deliver possession of personal property to the defendant. If the victim transfers title to the property involved, the crime of larceny by trick has not been committed. Since the buyer's intention was to make the seller the owner of the money, he transferred title to the money, and therefore B and C are incorrect."
    },
    {
        id: 22,
    ...
    },
    {
        ...
        ans: 2,
        exp: "At common law, burglary is defined as breaking and entering into the dwelling of another at night with the intent to commit a larceny or felony therein. If, at the time the defendant entered, he did not intend to commit an act that would amount to a crime, he cannot be guilty of burglary.\n\nA 'breaking' occurs when the defendant creates the opening through which he or she enters, even though no force is used. A and B are incorrect, because by opening the door to the victim's apartment, the defendant created the opening through which he entered, thus committing the necessary breaking. The crime of burglary is committed, if at all, at the time the unlawful entry takes place with the requisite state of mind. Conduct performed subsequently (i.e., leaving a note) does not undo a crime that has already been committed. D is therefore incorrect."
    },
    {
        id: 24,
