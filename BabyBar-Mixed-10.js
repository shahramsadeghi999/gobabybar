const examData = [
    ...
    },
    {
        ...
        ans: 0,
        exp: "Rule: A possessor of land owes licensees a duty to warn of or make safe known dangerous artificial conditions that the licensee is unlikely to discover through reasonable care[cite: 4]. Leaving loosened, unattached floorboards in place on an entryway creates a deceptive, concealed trap that shifts underfoot[cite: 4]. The homeowner is liable because she affirmatively directed the contractor to leave the boards in that dangerous condition and failed to warn her social guest[cite: 4]. Concurrently, an independent contractor owes a general duty of reasonable care to foreseeable entrants on the work site, and creating an active concealed hazard without barricading or posting a warning constitutes active operational negligence[cite: 4]. Both are liable (Option A)[cite: 4]. Option B is incorrect because possessors must warn licensees of hidden dangerous traps[cite: 4]. Options C and D are incorrect because an employer's detailed control over an unsafe method does not eliminate the contractor's independent duty to warn of physical hazards he created[cite: 4]."
    },
    {
        id: 3,
        topic: "Mixed",
        ...
        ans: 1,
        exp: "Rule: Under the Restatement (Second) of Contracts § 302, a third party is an intended beneficiary if recognition of a right to performance in the beneficiary is appropriate to effectuate the intention of the parties and the performance satisfies an obligation of the promisee or confers a gift/benefit[cite: 4]. An intended third-party beneficiary need not be identified or in existence at the time the contract is executed, so long as the beneficiary is identifiable at the time performance is due[cite: 4]. The man promised to pay 'anyone from whom you buy a minivan,' making the dealership an intended creditor/third-party beneficiary once the purchase occurred (Option B)[cite: 4]. Option A is incorrect because the dealership did not sell the vehicle in reliance on the man's promise (it was unaware at the time of sale)[cite: 4]. Option C is incorrect because the suretyship provision applies only to collateral promises made directly to a creditor to answer for another's debt; a direct primary promise made to the debtor to pay a future obligation falls outside the Statute of Frauds[cite: 4]. Option D is incorrect because intended beneficiaries do not need to be identified at formation[cite: 4]."
    },
    {
        id: 4,
        topic: "Mixed",
        ...
        ans: 2,
        exp: "Rule: Involuntary manslaughter at common law consists of an unintentional killing caused by criminal negligence (gross deviation from reasonable care) or committed during the commission of an unlawful misdemeanor (misdemeanor-manslaughter rule)[cite: 4]. Driving at an excessive speed around a sharp curve resulting in a fatal collision constitutes criminal negligence, and the statutory misdemeanor of reckless driving directly proximately caused the victim's death, establishing involuntary manslaughter (Option C)[cite: 4]. Option A is incorrect because speeding around a rural curve does not exhibit depraved-heart malice (wanton indifference to human life equivalent to murder)[cite: 4]. Option B is incorrect because voluntary manslaughter requires adequate provocation / heat of passion or imperfect self-defense[cite: 4]. Option D is incorrect because the vehicular death was caused by criminal negligence and an unlawful misdemeanor[cite: 4]."
    },
    {
        id: 5,
        topic: "Mixed",
        ...
        ans: 3,
        exp: "Rule: A private nuisance requires a substantial and unreasonable interference with the use and enjoyment of land[cite: 4]. Under traditional and prevailing common law principles, mere aesthetic unpleasantness or unsightly conditions (such as rusted machinery or visual clutter on adjacent land) do not, by themselves, constitute an actionable private nuisance absent physical emissions (smoke, odor, noise, vibrations) or a spite fence (Option D)[cite: 4]. Option A is incorrect because property depreciation is a measure of damages, not the substantive test for liability[cite: 4]. Option B is incorrect because nuisance redresses non-encroaching, intangible invasions[cite: 4]. Option C is incorrect because departure from local custom tends to support, rather than defend against, an unreasonable interference claim[cite: 4]."
    },
    {
        id: 6,
        topic: "Mixed",
        ...
        ans: 2,
        exp: "Rule: Under UCC § 2-207(2), between merchants, additional terms contained in an acceptance automatically become part of the contract UNLESS: (a) the offer expressly limits acceptance to the terms of the offer, (b) they materially alter the contract, or (c) objection is given within a reasonable time[cite: 4]. While arbitration clauses are frequently held to be material alterations in many jurisdictions, arguing that the arbitration clause did not materially alter the agreement (e.g., that arbitration is customary in the textile/cotton trade without unreasonable surprise) is the seller's only viable legal argument to incorporate the clause into the contract (Option C)[cite: 4]. Option A is incorrect because procedural efficiency does not govern contract incorporation under § 2-207[cite: 4]. Option B is incorrect because additional non-contradictory terms drop out if they are material alterations[cite: 4]. Option D is incorrect because UCC § 2-207 abolished the common law counteroffer/last-shot rule for non-conditional acknowledgments[cite: 4]."
    },
    {
        id: 7,
        topic: "Mixed",
        ...
        ans: 1,
        exp: "Rule: Under general contract interpretation and insurance law, courts strictly construe forfeiture provisions and warranties against the insurer (contra proferentem) to avoid harsh forfeitures[cite: 4]. Statements regarding medical history and past diseases are construed as representations of honest belief rather than strict warranties; thus, a clause requiring truthful statements is interpreted to require 'truthfulness to the best of the applicant's knowledge and belief'[cite: 4]. Because the woman had no subjective knowledge of the childhood illness, she did not breach the condition (Option B)[cite: 4]. Option A is incorrect because courts refuse to enforce literal strict warranty forfeitures for unknowable medical facts[cite: 4]. Options C and D are incorrect because the clause is phrased as an express condition, but its substantive scope is modified by the knowledge-and-belief standard[cite: 4]."
    },
    {
        id: 8,
        topic: "Mixed",
        ...
        ans: 2,
        exp: "Rule: In an action for private nuisance, the plaintiff must prove that the defendant caused a substantial and unreasonable interference with the use and enjoyment of real property[cite: 4]. When an interference affects an unusually sensitive or delicate commercial or scientific activity (hypersensitive use), the interference is not an actionable nuisance unless it would substantially interfere with an ordinary, standard use of land in the locality (Amphitheaters, Inc. v. Portland Meadows)[cite: 4]. The scientist can prevail only if the interference is found to be substantial and unreasonable under standard nuisance balancing (Option C)[cite: 4]. Option A is incorrect because industrial electricity transmission is a common utility activity, not an abnormally dangerous activity imposing strict liability[cite: 4]. Option B is incorrect because notice does not make a non-nuisance into a nuisance if the use is abnormally sensitive[cite: 4]. Option D is incorrect because nuisance protects against non-physical interference with use and enjoyment without requiring structural damage[cite: 4]."
    },
    {
        id: 9,
        topic: "Mixed",
        ...
        ans: 1,
        exp: "Rule: Under the traditional common law bilateral approach to conspiracy, the crime requires a genuine mutual agreement between two or more persons (plurality of agreement) with the specific intent to achieve an unlawful objective[cite: 4]. A feigned agreement with an undercover government agent who does not intend to commit the crime does not satisfy the common law bilateral requirement; there is no conspiracy because there is only one genuine guilty mind[cite: 4]. (Note: Under the Model Penal Code unilateral approach, an individual can be guilty of conspiracy for agreeing with an undercover officer, but this jurisdiction explicitly adheres to the common law rule) (Option B)[cite: 4]. Option A is incorrect because paying for and taking delivery is an overt act[cite: 4]. Option C is incorrect because plurality of agreement is fundamental to common law conspiracy[cite: 4]. Option D is incorrect because subjective belief cannot satisfy the bilateral requirement at common law[cite: 4]."
    },
    {
        id: 10,
        topic: "Mixed",
        ...
        ans: 1,
        exp: "Rule: When a jury returns an excessive damage verdict unsupported by the evidence, the trial judge in federal court may not unilaterally reduce the award without violating the Seventh Amendment right to a jury trial; however, the judge may order a remittitur[cite: 4]. Under remittitur, the judge conditionally grants a new trial on damages unless the plaintiff accepts a reduced damage amount determined by the court (Option B)[cite: 4]. Option A is incorrect because a renewed judgment as a matter of law under Rule 50(b) cannot be granted if no Rule 50(a) motion was made before submission, and a judge cannot unilaterally rewrite a jury verdict[cite: 4]. Option C is incorrect because ordering an unconditional new trial wastes judicial resources when remittitur provides a viable remedy[cite: 4]. Option D is incorrect because remittitur is fully constitutional under the Seventh Amendment[cite: 4]."
    },
    {
        id: 11,
        topic: "Mixed",
        ...
        ans: 2,
        exp: "Rule: Under UCC § 2-708(2), if the standard resale measure of damages (contract price minus resale price) is inadequate to put the seller in as good a position as performance would have done, the seller is a 'lost volume seller' and is entitled to recover the profit (including reasonable overhead) that the seller would have made from full performance by the buyer[cite: 4]. A retailer who can obtain more units from the manufacturer than it can sell would have made two sales instead of one but for the buyer's breach; therefore, reselling at the same price does not mitigate the lost sale (Option C)[cite: 4]. Option A is incorrect because the lost volume seller doctrine overrides standard resale offsets[cite: 4]. Option B is incorrect because lack of resale notice under § 2-706 bars resale damages, but does not bar lost profit recovery under § 2-708(2)[cite: 4]. Option D is incorrect because an action for the price under § 2-709 is unavailable where goods were resold[cite: 4]."
    },
    {
        id: 12,
        topic: "Mixed",
        ...
        ans: 2,
        exp: "Rule: Under UCC § 2-609, when reasonable grounds for insecurity arise, a party may demand adequate assurance of due performance and suspend performance until received[cite: 4]. However, once the other party provides adequate assurance of performance according to commercial standards (promptly sending audited financial statements and a bank credit report), the demanding party must resume performance[cite: 4]. Continued refusal to deliver after receiving adequate assurance constitutes a total breach of contract by the supplier (Option C)[cite: 4]. Option A is incorrect because requirements contracts are valid under UCC § 2-306[cite: 4]. Option B is incorrect because grounds for insecurity entitle a party to demand assurances, not cancel unilaterally after adequate assurances are provided[cite: 4]. Option D is incorrect because insecurity permitted demanding assurances, but the breach occurred by refusing delivery after satisfaction[cite: 4]."
    },
    {
        id: 13,
        topic: "Mixed",
        ...
        ans: 3,
        exp: "Rule: A landowner is privileged to use reasonable, non-deadly force to defend land against trespassers, which includes erecting visible fences and standard barbed-wire barriers[cite: 4]. While landowners may not use hidden mechanical devices designed to inflict deadly force (spring guns as in Katko v. Briney), an ordinary barbed-wire fence is a standard boundary barrier where the danger is open, apparent, and easily observed by any adult climbing it[cite: 4]. Because the hazard was open and apparent and standard boundary fencing does not constitute excessive or deadly force, the landowner is not liable (Option D)[cite: 4]. Option A is incorrect because installing standard barbed wire on top of a boundary fence is not categorized as using deadly mechanical force[cite: 4]. Option B is incorrect because landowners may fence their boundaries regardless of wild game presence[cite: 4]. Option C is incorrect because trespasser status alone does not resolve the issue if a spring gun or trap were used[cite: 4]."
    },
    {
        id: 14,
        topic: "Mixed",
        ...
        ans: 1,
        exp: "Rule: The common-law firefighters' rule (professional rescuers doctrine) bars firefighters and police officers from recovering against a tortfeasor whose negligence created the emergency that required the officer's presence at the scene[cite: 4]. The rule applies strictly to risks inherent in responding to the specific crisis; it does NOT bar recovery for independent acts of negligence committed by third parties that injure an officer while engaged in normal travel or unrelated duties[cite: 4]. Because the fatigued factory worker's collision was an independent traffic accident unrelated to the emergency the officer had handled, the firefighters' rule does not bar the suit (Option B)[cite: 4]. Option A is incorrect because the firefighters' rule applies to police officers[cite: 4]. Option C is incorrect because 'but-for' timing does not connect the factory worker's negligence to the emergency scene[cite: 4]. Option D is incorrect because on-the-job injuries are not barred unless arising from the specific hazard being confronted[cite: 4]."
    },
    {
        id: 15,
        topic: "Mixed",
        ...
        ans: 1,
        exp: "Rule: Under the suretyship provision of the Statute of Frauds, a collateral promise to answer for the debt of another must be evidenced by a writing signed by the party to be charged[cite: 4]. The writing does not need to be delivered to the creditor or executed at the time of agreement; an informal written letter or memorandum addressed to a third party (such as the son) satisfies the Statute of Frauds if it describes the essential terms and is signed by the promisor[cite: 4]. Because the mother wrote and signed a letter identifying the loan, debt amount, maturity, and guaranty promise, the Statute of Frauds is satisfied (Option B)[cite: 4]. Option A is incorrect because the suretyship provision applies to any dollar amount, unlike UCC § 2-201[cite: 4]. Option C is incorrect because a subsequent signed memorandum satisfies the writing requirement for prior oral promises[cite: 4]. Option D is incorrect because the primary loan performable within six weeks is not barred by the one-year Statute of Frauds[cite: 4]."
    },
    {
        id: 16,
        topic: "Mixed",
        ...
        ans: 2,
        exp: "Rule: Assault requires an intentional act causing reasonable apprehension of immediate harmful or offensive bodily contact[cite: 4]. The golfer swung at the caddie's head intending to frighten him, causing the caddie to duck in reasonable apprehension, establishing completed assault[cite: 4]. Battery requires an intentional harmful or offensive bodily contact[cite: 4]. Under the doctrine of transferred intent (which applies between intentional torts), the intent to commit an assault transfers to satisfy the intent requirement for battery when the physical contact actually ensues, even if the golfer did not intend the contact or the club head broke[cite: 4]. The caddie recovers for both assault and battery (Option C)[cite: 4]. Options A, B, and D are incorrect because the elements and transferred intent satisfy both torts[cite: 4]."
    },
    {
        id: 17,
        topic: "Mixed",
        ...
        ans: 3,
        exp: "Rule: In tort actions involving physical injury or bodily harm, a plaintiff is entitled to recover 'parasitic' damages for emotional distress (pain and suffering, fear of future disease) that naturally flows from or is accompanied by the actual physical harm caused by the tortious product[cite: 4]. The rule barring stand-alone emotional distress without physical impact does not apply because the plaintiff has already suffered demonstrable physical bodily injury (asbestosis) caused by asbestos exposure (Option D)[cite: 4]. Option A is incorrect because emotional distress need not cause physical injury when it results from an existing physical injury[cite: 4]. Option B is incorrect because parasitic fear-of-cancer damages are recoverable in connection with an existing disease without pleading an independent cause of action for increased risk[cite: 4]. Option C is incorrect because strict liability still requires parasitic connection to physical bodily harm[cite: 4]."
    },
    {
        id: 18,
        topic: "Mixed",
        ...
        ans: 0,
        exp: "Rule: Under the Statute of Frauds, a contract for the sale of an interest in real property is unenforceable unless evidenced by a signed writing[cite: 4]. Under the part performance doctrine, an oral land contract is enforced in equity only if the buyer does at least two of the following: takes physical possession, pays all or part of the purchase price, and makes valuable improvements[cite: 4]. Here, the buyer merely paid a $10,000 down payment; paying money alone without taking possession or making improvements does not take an oral land contract out of the Statute of Frauds (Option A)[cite: 4]. Option B is incorrect because retention of earnest money is not an exclusive remedy absent an express liquidated damages agreement[cite: 4]. Option C is incorrect because inheriting a home does not excuse a contractual duty[cite: 4]. Option D is incorrect because a seller occupies until closing[cite: 4]."
    },
    {
        id: 19,
        topic: "Mixed",
        ...
        ans: 2,
        exp: "Rule: Under UCC § 2-311(1) and general contract rules, an agreement for sale that leaves particulars of performance (such as assortment) to be specified by one of the parties is valid and binding[cite: 4]. Under UCC § 2-311(3), where a specification would materially affect the other party's performance but is not seasonably made, the other party is excused for any resulting delay and may proceed to perform or treat the failure as a breach[cite: 4]. However, a non-material delay of a single day (March 2 instead of March 1) where delivery was not due until May/June and the seller suffered zero prejudice or material change of position does not justify cancellation under the doctrine of substantial performance / non-material delay (Option C)[cite: 4]. Option A is incorrect because a binding contract was formed upon agreement[cite: 4]. Option B is incorrect because timing of assortment specification in installment delivery contracts is construed as a promise/covenant rather than a strict express condition of forfeiture[cite: 4]. Option D is incorrect because UCC § 2-311(3)(b) permits, but does not impose an affirmative duty on, the seller to make the selection[cite: 4]."
    },
    {
        id: 20,
        topic: "Mixed",
        ...
        ans: 2,
        exp: "Rule: Under strict products liability (Restatement (Second) of Torts § 402A), a commercial retailer in the distribution chain is strictly liable for selling a defective, unreasonably dangerous product that causes physical injury, regardless of whether the retailer was at fault or could have discovered the defect[cite: 4]. A beverage containing a decomposed snail is defective and unreasonably dangerous[cite: 4]. Furthermore, a consumer's failure to discover a defect (failing to inspect the bottle) is ordinary contributory negligence, which is not a defense to strict products liability (Option C)[cite: 4]. Option A is incorrect because failure to inspect does not bar strict products liability[cite: 4]. Option B is incorrect because retailers are strictly liable even if the defect was caused entirely by the upstream bottler[cite: 4]. Option D is incorrect because exclusive control pertains to res ipsa loquitur in negligence, not strict products liability[cite: 4]."
    },
    {
        id: 21,
        topic: "Mixed",
        ...
        ans: 3,
        exp: "Rule: Under the UCC § 2-601 perfect tender rule, a buyer may reject goods if the tender fails in any respect to conform to the contract, including timeliness of delivery[cite: 4]. However, under UCC § 1-303 and § 2-202, trade usage supplements and explains agreement terms[cite: 4]. If an established trade usage permits computer manufacturers a 30-day delivery leeway unless expressly negated, the August 15 delivery was conforming under the contract as interpreted through trade usage, meaning the bank wrongfully rejected the tender (Option D)[cite: 4]. Option A is incorrect because the perfect tender rule applies regardless of whether the breach was material[cite: 4]. Option B is incorrect because subjective belief regarding a good bargain does not modify delivery terms[cite: 4]. Option C is incorrect because a transportation strike does not excuse delay under an F.O.B. destination term unless an explicit force majeure clause applies[cite: 4]."
    },
    {
        id: 22,
        topic: "Mixed",
        ...
        ans: 1,
        exp: "Rule: Under the learned intermediary doctrine, a pharmaceutical manufacturer satisfies its duty to warn by warning the prescribing physician rather than the patient[cite: 4]. However, the learned intermediary doctrine applies strictly to prescription medications; it does NOT apply to over-the-counter (OTC) drugs sold directly to consumers without a physician's prescription[cite: 4]. Because this was an over-the-counter drug, the manufacturer owed a direct duty to warn the purchasing public on the package label, making the learned intermediary argument completely unviable and the LEAST promising defense (Option B)[cite: 4]. Options A, C, and D are standard, viable defenses addressing idiosyncratic allergic reactions, unforeseeable product misuse (triple dosing), and comparative fault[cite: 4]."
    },
    {
        id: 23,
        topic: "Mixed",
        ...
        ans: 1,
        exp: "Rule: Under the parol evidence rule (Restatement (Second) of Contracts § 217), extrinsic oral evidence is admissible to establish that the written agreement was subject to an oral condition precedent to legal effectiveness (a condition that must occur before contractual obligations become binding)[cite: 4]. Because the parties mutually understood that the contract was conditional on the rejection of the other bid, and that condition precedent failed to occur (the other bid was accepted), the contract never became effective, discharging the builder from any duty to perform (Option B)[cite: 4]. Option A is incorrect because economic efficiency theories do not excuse contract breach[cite: 4]. Option C is incorrect because conditioning a commitment on an external event outside the party's sole control is not illusory[cite: 4]. Option D is incorrect because oral conditions precedent to contract effectiveness are not barred by the parol evidence rule[cite: 4]."
    },
    {
        id: 24,
        topic: "Mixed",
        ...
        ans: 2,
        exp: "Rule: Involuntary manslaughter requires an unintentional killing resulting from criminal negligence (gross negligence involving a substantial and unjustifiable risk of death or serious bodily injury, representing a gross deviation from the standard of care)[cite: 3, 4]. While unconscious conduct is normally involuntary, an actor who knowingly creates the risk by voluntarily taking a double dose of an intoxicating sedative immediately before driving an automobile is criminally negligent, establishing proximate cause and mens rea at the time the dangerous conduct was initiated[cite: 3, 4]. Defendant is guilty of involuntary manslaughter (Option C)[cite: 3, 4]. Option A is incorrect because antecedent criminal negligence in driving while ingesting sedatives supplies the required culpability[cite: 3, 4]. Option B is incorrect because abusing a prescription in violation of physician warnings is not shielded by medical authorization[cite: 3, 4]. Option D is incorrect because vehicular manslaughter is not a strict liability offense; criminal negligence must be established[cite: 3, 4]."
    },
    {
        id: 25,
        topic: "Mixed",
