const examData = [
    ...
    },
    {
        ...
        ans: 1,
        exp: "Rule: An intervening force is superseding (relieving an initial negligent actor of liability) only if it is extraordinary and unforeseeable. Where an intervening hazard—such as a common road defect or pothole—is ordinary, foreseeable, and prevalent on the roadway, it is a concurring dependent intervening force, not a superseding cause. Because potholes were frequently found in that area and encountering a road imperfection while speeding is a foreseeable risk, the pothole does not break the chain of proximate cause (Option B)[cite: 3]. Option A is incorrect because statutory violation establishes breach of duty, but does not address the defendant's specific proximate cause / superseding cause defense[cite: 3]. Option C is incorrect because municipal immunity abolition addresses the state's liability, not whether an intervening force is superseding[cite: 3]. Option D is incorrect because concurring 'but-for' causes do not insulate a negligent driver whose unreasonable speed contributed to the loss of control[cite: 3]."
    },
    {
        id: 5,
        topic: "Mixed",
    ...
    },
    {
        ...
        ans: 0,
        exp: "Rule: Under the doctrine of mutual mistake (Sherwood v. Walker; Restatement (Second) of Contracts § 152), a contract is voidable by the adversely affected party if both parties were mistaken about a basic assumption of fact at the time of contract formation that has a material effect on the agreed exchange of performances. Both the breeder and the farmer contracted under the mutual belief that the animal was a barren beef cow ($200) rather than a fertile breeding cow ($1,000+). Because the mutual mistake went to the very nature and essential character of the subject matter, the seller may rescind (Option A)[cite: 3]. Option B is incorrect because price disparity alone without a mutual mistake as to a basic assumption does not warrant rescission[cite: 3]. Options C and D are incorrect because the mistake was not an error in market valuation, but an essential mutual mistake regarding the animal's biological identity and capacity[cite: 3]."
    },
    {
        id: 11,
        topic: "Mixed",
