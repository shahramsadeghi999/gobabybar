...
const examData = [
    {
        ...
        ans: 3,
        exp: "(D) is the correct response. Either party may have its performance excused under the doctrine of mutual mistake if both parties were mistaken about a basic assumption on which the contract was based[cite: 6]. Because both parties shared the identical mistaken belief that the yacht was 50 feet underwater, and the equipment limitations made this depth a basic assumption of the contract, the mutual mistake doctrine applies[cite: 6]. (A) is incorrect because the salvage company justifiably relied on the owner's specific representation of the depth, meaning they did not assume the risk of the mistake[cite: 6]. (B) is incorrect because the parties were not merely uncertain; they shared an actual, identical mistaken belief[cite: 6]. (C) is incorrect because the failure to allocate risk alone is insufficient; the mistake must go to a basic assumption of the contract[cite: 6]."
    },
    {
        id: 2,
        ...
        ans: 1,
        exp: "(B) is the correct response. The distributor's failure to disclose the change he made to the release constituted a fraudulent misrepresentation, making reformation appropriate even though the manufacturer did not read the release before signing it[cite: 6]. When a party's manifestation of assent is induced by the other party's fraudulent misrepresentation as to the contents of a writing, the recipient is entitled to reformation if they were justified in relying on the misrepresentation[cite: 6]. (A) is incorrect because only the manufacturer was mistaken; the distributor intentionally altered the document, so the mistake was not mutual[cite: 6]. (C) is incorrect because the parol evidence rule does not bar evidence of prior negotiations offered to show that a written agreement was procured by fraud[cite: 6]. (D) is incorrect because failing to read a document when fraudulently induced to believe it matches a prior agreement does not constitute a failure to act in good faith, so the reliance remains justified[cite: 6]."
    },
    {
        id: 3,
        ...
        ans: 2,
        exp: "(C) is the correct response. An offer invites acceptance in any manner and by any medium reasonable in the circumstances[cite: 6]. The client's note constituted an offer to have the CPA perform services, and under these circumstances, the CPA's actual performance of the services was a reasonable method of accepting the offer[cite: 6]. The combination of the client's note and the CPA's performance created an implied-in-fact contract (a contract resulting from conduct rather than explicit words)[cite: 6]. (A) is incorrect because essential terms, such as price, can be supplied by a court through reasonable implication when a service is requested and performed[cite: 6]. (B) is incorrect because it implies reliance on promissory estoppel, which is unnecessary when an actual implied-in-fact contract has been formed[cite: 6]. (D) is incorrect because mutual assent can be manifested through conduct (performance) rather than explicit spoken words[cite: 6]."
    },
    {
        id: 4,
        ...
        ans: 3,
        exp: "(D) is the correct response. Under the doctrine of Hadley v. Baxendale, damages are not recoverable for loss that the party in breach did not have reason to foresee as a probable result of the breach when the contract was made[cite: 6]. The early-completion incentive pay is a special circumstance beyond the ordinary course of events[cite: 6]. Because the supplier did not know, and had no reason to know, about this specific bonus provision, the lost incentive pay was not a foreseeable result of the delay[cite: 6]. (A) is incorrect because a breaching party is not strictly liable for all direct damages if those damages flow from unknown special circumstances[cite: 6]. (B) is incorrect because even if time was of the essence, the supplier had no reason to foresee the specific extraordinary penalty/bonus structure[cite: 6]. (C) is incorrect because a breaching party can be liable for special damages if they simply *knew* or *had reason to know* of them; an express agreement to be responsible is not required[cite: 6]."
    },
    {
        id: 5,
        ...
        ans: 0,
        exp: "(A) is the correct response. When a contract conditions one party's duty upon the non-occurrence of an event, that party can waive the benefit of the condition through conduct[cite: 6]. The CEO, knowing the developer was violating the no-gaming condition, encouraged him to keep working, thereby waiving the benefit of the condition[cite: 6]. This implied promise induced the developer to continue working, making the waiver irrevocable and excusing the condition to avoid a disproportionate forfeiture[cite: 6]. (B) is incorrect because the clause defined required conduct, not a measure of damages in the event of breach, so it was not a penalty clause[cite: 6]. (C) is incorrect because the contract expressly stated the duty to pay was 'conditioned on' the abstention, meaning a court cannot merely interpret it as a promise[cite: 6]. (D) is incorrect because strict compliance is required for express conditions, regardless of whether the breach was 'material' to the final product quality[cite: 6]."
    },
    {
        id: 6,
        ...
        ans: 3,
        exp: "(D) is the correct response. When an offer invites acceptance by either a promise or performance, the beginning of performance generally constitutes acceptance[cite: 6]. When the horologist began work on October 4, that action acted as an acceptance of the collector's offer[cite: 6]. Because the contract was already formed on October 4, the collector's subsequent death on October 6 did not terminate the offer or the contract[cite: 6]. (A) is incorrect because the contract was formed by performance on October 4; the October 7 note merely served to provide necessary notice to avoid discharge, and would have been effective even if the horologist had learned of the death before sending it[cite: 6]. (B) and (C) are incorrect because the offer had already been successfully accepted prior to the collector's death, so the death could not terminate the offer[cite: 6]."
    },
    {
        id: 7,
        ...
        ans: 3,
        exp: "(D) is the correct response. Where a written contract is only partially integrated (intended as a final expression of some terms but not all), the Parol Evidence Rule does not prevent proof of a prior or contemporaneous oral agreement that is a consistent 'addition to' the writing[cite: 6]. Because the one-page document lacked a merger clause and completely omitted a completion time, it was a partial integration. The oral 45-day deadline supplements the writing without contradicting any of its express terms, making it admissible[cite: 6]. (A) is incorrect because the parties reached an actual oral agreement just prior to signing; it was not merely preliminary negotiation[cite: 6]. (B) is incorrect because courts may look outside the four corners of a document to find consistent additional terms if the writing is only partially integrated[cite: 6]. (C) is incorrect because the writing is not ambiguous; rather, it is completely silent on the issue of time, making it a case of supplementation rather than interpretation[cite: 6]."
    },
    {
        id: 8,
        ...
        ans: 1,
        exp: "(B) is the correct response. When a party fails to comply with a licensing or registration requirement, a contract for their services is unenforceable on public policy grounds ONLY if the requirement has a regulatory purpose designed to protect the public[cite: 6]. Where a licensure requirement is designed merely to raise money (revenue-raising), a court will not refuse to enforce the agreement on public policy grounds[cite: 6]. Because the county fee was purely for revenue, the contract is fully enforceable, and the painter is entitled to the $4,000 contract price[cite: 6]. (A) is incorrect because the contract is not void; the revenue-raising nature of the statute preserves enforceability[cite: 6]. (C) is incorrect because the painter is entitled to recover fully on the contract, not merely recoup costs[cite: 6]. (D) is incorrect because the contract is not void, and the recovery is based on the contract price, not quasi-contract[cite: 6]."
    },
    {
        id: 9,
        ...
        ans: 3,
        exp: "(D) is the correct response. The supplier is an intended creditor beneficiary of the contract between the farmer and the buyer because the performance of the promise will satisfy an obligation of the promisee (farmer) to pay money to the beneficiary[cite: 6]. The buyer's promise is interpreted as a commitment to pay the $5,000 regardless of whether the underlying debt was legally enforceable against the farmer[cite: 6]. Therefore, the supplier can enforce the buyer's promise directly[cite: 6]. (A) is incorrect because the promisor (buyer) cannot raise the promisee's (farmer's) personal statute of limitations defense against the beneficiary unless the contract expressly provides for it[cite: 6]. (B) is incorrect because there is no overriding public policy against enforcing a new third-party promise to pay a stale claim[cite: 6]. (C) is incorrect because the buyer's promise does not revive the original debt against the farmer; it simply creates a new enforceable right against the buyer[cite: 6]."
    },
    {
        id: 10,
        ...
        ans: 2,
        exp: "(C) is the correct response. Under the doctrine of supervening impracticability, a party's duty to perform is discharged if performance is made impracticable without his fault by the occurrence of an event the non-occurrence of which was a basic assumption of the contract[cite: 6]. Performance becomes impracticable when it involves a risk of injury to person or health that is disproportionate to the ends to be attained by performance[cite: 6]. The chemist's severe allergic reaction made his continued performance impracticable, discharging his contractual duties and preventing the lab from recovering damages[cite: 6]. (A) is incorrect because a three-year contract is not at-will employment[cite: 6]. (B) is incorrect because the idiosyncrasy of the risk does not negate the fact that, for *this specific performer*, performance became dangerously impracticable[cite: 6]. (D) is incorrect because mitigation of damages is irrelevant if the underlying duty to perform was discharged by impracticability[cite: 6]."
    },
    {
        id: 11,
        ...
        ans: 0,
        exp: "(A) is the correct response. A contract is voidable if a party's assent is induced by a material misrepresentation on which the recipient is justified in relying. While a mere failure to disclose a fact is generally not a misrepresentation, intentional acts of concealment (such as painting over damage to hide it) are legally equivalent to affirmative misrepresentations that the fact does not exist[cite: 6]. By painting over the termite damage, the seller committed a misrepresentation, entitling the buyer to avoid the contract[cite: 6]. (B) is incorrect because there is no evidence the buyer failed to understand the essential terms; the issue is fraud[cite: 6]. (C) is incorrect because a victim of intentional misrepresentation does not lose the right to avoid the contract merely by failing to conduct an independent investigation[cite: 6]. (D) is incorrect because active physical concealment is treated as an affirmative misstatement under contract law[cite: 6]."
    },
    {
        id: 12,
        ...
        ans: 3,
        exp: "(D) is the correct response. Under the rule of Hadley v. Baxendale, damages are recoverable if they follow from the breach as a result of special circumstances that the breaching party had reason to know at the time the contract was made[cite: 6]. Because the agricultural service was experienced in the industry and early frosts were common in that region, the service had 'reason to know' of the special circumstances (the danger of crop destruction due to delay) even without an explicit warning from the owner[cite: 6]. Therefore, the loss was foreseeable and the service is liable[cite: 6]. (A) is incorrect because liability is limited by foreseeability; a breaching party is not strictly liable for *all* consequences[cite: 6]. (B) is incorrect because express warnings are not required if the breaching party otherwise has reason to know of the risk from industry experience or regional common knowledge[cite: 6]. (C) is incorrect because the term 'when the crop is ripe' provided a sufficiently definite time for performance[cite: 6]."
    },
    {
        id: 13,
        ...
        ans: 3,
        exp: "(D) is the correct response. If parties reach a binding agreement, the fact that they further agree to embody the contract in a formal written memorial does not prevent the original agreement from being binding immediately, provided there is no intent to delay formation[cite: 6]. The detailed offer and acceptance created a binding contract[cite: 6]. The franchisor's approval was a condition precedent to performance, which was satisfied[cite: 6]. The drafting of the document was merely administrative[cite: 6]. (A) is incorrect because courts do not inquire into the adequacy of consideration[cite: 6]. (B) is incorrect because the condition being beyond the parties' control does not make it invalid; the crucial fact is that the condition *was satisfied*, triggering the duty to perform[cite: 6]. (C) is incorrect because a transaction can be a valid mixture of bargain and gift; family affection does not negate the $200,000 consideration[cite: 6]."
    },
    {
        id: 14,
        ...
        ans: 3,
        exp: "(D) is the correct response. Under contract interpretation rules (Restatement § 203(b)), express terms are given greater weight than course of performance, course of dealing, and usage of trade[cite: 6]. Because the parties photocopied the prior agreement containing the 20% figure, that figure became an express term of the new contract[cite: 6]. This express term overrides any conflicting trade usage (10%)[cite: 6]. (A) is incorrect because a single prior contract does not establish a 'course of dealing', and even if it did, the express term still governs the outcome[cite: 6]. (B) is incorrect because trade usage has the lowest priority and yields to express terms[cite: 6]. (C) is incorrect because the contract specifies duration, services, and a clear fee formula, making it sufficiently definite[cite: 6]."
    },
    {
        id: 15,
        ...
        ans: 1,
        exp: "(B) is the correct response. Under the Hadley v. Baxendale doctrine, damages are not recoverable for loss that the breaching party did not have reason to foresee as a probable result of the breach when the contract was made[cite: 6]. In a contract to lend money, the lender is entitled to presume the borrower can find alternative funding, and special lost profits are unrecoverable unless the borrower informed the lender of the specific intended use and inability to borrow elsewhere[cite: 6]. Because the merchant kept his gem resale plans secret, the $10,000 lost profit was unforeseeable and unrecoverable[cite: 6]. However, it is naturally foreseeable that a substitute loan would carry a higher interest rate, so the difference in interest costs is recoverable[cite: 6]. (A) is incorrect because the lost profits were not foreseeable[cite: 6]. (C) is incorrect because modern courts reject the 'tacit agreement' test for consequential damages[cite: 6]. (D) is incorrect because the merchant is entitled to the interest rate differential, even though the lost opportunity is barred[cite: 6]."
    },
    {
        id: 16,
        ...
        ans: 0,
        exp: "(A) is the correct response. A third party may enforce a contract only if they are an intended beneficiary. An intended beneficiary exists if the circumstances indicate the promisee intended to give the beneficiary the benefit of the promised performance[cite: 6]. If not, the party is merely an incidental beneficiary with no right to enforce the contract[cite: 6]. Here, the mall contracted for security to protect its property and secure its doors, not to confer a direct right of action upon individual shoppers[cite: 6]. Therefore, the shopper is an incidental beneficiary and cannot sue for breach[cite: 6]. (B) is incorrect because a tort or public policy claim is distinct from a breach of contract action, which requires third-party standing[cite: 6]. (C) is incorrect because the evidence does not support an intent to confer enforceable rights on individual shoppers[cite: 6]. (D) is incorrect because an unnamed person *can* be an intended beneficiary if the contract identifies a specific class, but that is not the case here[cite: 6]."
    },
    {
        id: 17,
        ...
        ans: 2,
        exp: "(C) is the correct response. If a party's manifestation of assent is induced by a fraudulent misrepresentation upon which the recipient is justified in relying, the contract is voidable by the recipient (Restatement § 164)[cite: 6]. The developer knowingly made false statements about essential attributes of the property, inducing the buyer's purchase[cite: 6]. The buyer is entitled to avoid the contract for fraud[cite: 6]. (A) is incorrect because fraud in the inducement makes a contract voidable at the victim's option, not void ab initio[cite: 6]. (B) is incorrect because economic harm is not required to avoid a contract for fraud; the victim need only show they were fraudulently induced[cite: 6]. (D) is incorrect because the power to avoid is lost by unreasonable delay only *after* the victim discovers the fraud; here, the buyer sued immediately upon discovery[cite: 6]."
    },
    {
        id: 18,
        ...
        ans: 0,
        exp: "(A) is the correct response. Every contract imposes a duty of good faith and fair dealing in its performance[cite: 6]. Where a duty is subject to a condition, and that party's cooperation is necessary for the condition to occur, the duty of good faith includes an implied obligation to make reasonable efforts to satisfy the condition[cite: 6]. Because the buyer failed to make any effort to apply for the mortgage, he breached this implied duty[cite: 6]. Under the prevention doctrine, his breach excuses the non-occurrence of the condition, making his duty to close absolute[cite: 6]. Therefore, the seller will prevail[cite: 6]. (B) and (D) are incorrect because they ignore the implied duty of good faith to seek the financing[cite: 6]. (C) is incorrect because the condition is excused due to the buyer's bad faith prevention, not to avoid a disproportionate forfeiture by the seller[cite: 6]."
    },
    {
        id: 19,
        ...
        ans: 0,
        exp: "(A) is the correct response. An assignment of 'the contract' automatically includes a delegation of duties (Restatement § 328)[cite: 6]. However, a delegation of duties does not release the delegator (the landscaping company) from liability unless the obligee (the office park) expressly agrees to a novation[cite: 6]. Because there was no novation, the original landscaping company remains liable[cite: 6]. Additionally, when an assignee (the conglomerate) accepts an assignment of the contract, it is deemed to have promised to perform the delegator's duties, making the obligee an intended third-party beneficiary of that promise[cite: 6]. Therefore, the office park can sue either the original company or the conglomerate[cite: 6]. (B) is incorrect because the assignor is not released[cite: 6]. (C) is incorrect because mutuality of remedy is not the applicable doctrine; third-party beneficiary law creates the liability[cite: 6]. (D) is incorrect because the conglomerate is liable via its assumption of duties[cite: 6]."
    },
    {
        id: 20,
        ...
        ans: 0,
        exp: "(A) is the correct response. Undue influence exists where one party is subjected to unfair persuasion arising from the domination of the victim by the persuader, or a relationship where the victim is justified in assuming the persuader will not act contrary to their welfare (Restatement § 177)[cite: 6]. The father's terminal illness and the son's threat of abandonment allowed the son to dominate the vulnerable father, resulting in unfair persuasion. This makes the contract voidable for undue influence[cite: 6]. (B) is incorrect because courts do not void contracts merely for inadequate consideration if a bargain existed[cite: 6]. (C) is incorrect because duress requires an 'improper threat' (e.g., threat of a crime or tort); threatening to withhold visits is cruel but likely not legally 'improper' enough for duress[cite: 6]. (D) is incorrect because there was no mistake of fact[cite: 6]."
    },
    {
        id: 21,
        ...
        ans: 2,
        exp: "(C) is the correct response. The lender offered to accept a lesser sum in exchange for earlier payment. Because earlier payment is a legal detriment, the offer was supported by consideration. However, the offer requested a return *promise* to pay by January 15 (a bilateral contract)[cite: 6]. The borrower's response, 'I will attempt to get the money,' was equivocal and did not constitute a firm promise or acceptance[cite: 6]. Because the offer was unaccepted, the lender was completely free to revoke it on January 11. The subsequent tender was ineffective[cite: 6]. (A) is incorrect because the agreement did not fall within the Statute of Frauds[cite: 6]. (B) is incorrect because early payment provides valid consideration[cite: 6]. (D) is incorrect because no executory accord was ever formed due to the lack of acceptance[cite: 6]."
    },
    {
        id: 22,
        ...
        ans: 3,
        exp: "(D) is the correct response. While contractual duties are generally delegable, duties that involve personal services, relying on the obligor's special skills, reputation, or artistic taste, are strictly non-delegable[cite: 6]. The museum bargained specifically for the famous artist's unique skills. Therefore, the artist could not delegate performance to the apprentice, regardless of the apprentice's talent, without the museum's consent[cite: 6]. (A) is incorrect because the skill of the delegatee does not override the non-delegable nature of personal artistic services[cite: 6]. (B) is incorrect because personal services are non-delegable by default; no explicit prohibition is needed[cite: 6]. (C) is incorrect because a novation requires the obligee's consent, which the museum refused[cite: 6]."
    },
    {
        id: 23,
        ...
        ans: 1,
        exp: "(B) is the correct response. An accord is an agreement to accept substituted performance to discharge an existing duty. When the client paid the $10,000, 'satisfaction' occurred, completely discharging the original debt[cite: 6]. The compromise of a claim disputed in good faith provides valid consideration for the accord, even if the claim of defect is ultimately factually incorrect[cite: 6]. Therefore, the engineer is bound by the accord and satisfaction and cannot recover the balance[cite: 6]. (A) is incorrect because the pre-existing duty rule does not apply to unliquidated or good-faith disputed debts[cite: 6]. (C) is incorrect because the accord was fully executed upon payment, satisfying any Statute of Frauds concerns[cite: 6]. (D) is incorrect because an accord between original parties is not a novation[cite: 6]."
    },
    {
        id: 24,
        ...
        ans: 0,
        exp: "(A) is the correct response. Expectation damages aim to put the non-breaching party in the position they would have been in had the contract been performed. For a partially completed construction contract breached by the owner, the formula is: Costs incurred ($15,000) + Expected profit ($5,000) - Costs avoided/salvaged ($5,000 for reused tiles) = $15,000[cite: 6]. (B) is incorrect because it ignores the expected profit and the initial tile cost[cite: 6]. (C) is incorrect because it fails to deduct the $5,000 saved by reusing the tiles on another job[cite: 6]. (D) is incorrect because it represents a quantum meruit/restitution measure, which the builder would not choose because expectation damages ($15,000) yield a higher recovery than restitution ($8,000)[cite: 6]."
    },
    {
        id: 25,
        ...
        ans: 3,
        exp: "(D) is the correct response. Under the common law Statute of Frauds, a contract for the sale of an interest in land requires a written memorandum that specifies all essential terms with reasonable certainty[cite: 6]. Price is an essential term in a real estate contract[cite: 6]. Because the memorandum completely omitted the price, it fails to satisfy the Statute of Frauds, rendering the contract unenforceable[cite: 6]. (A) is incorrect because while UCC § 2-305 allows a court to imply a reasonable price for the sale of goods, the UCC does not apply to real estate; common law requires the price in writing[cite: 6]. (B) is incorrect because estoppel requires detrimental reliance, which is not present here[cite: 6]. (C) is incorrect because the issue is the absence of the term in writing, not whether the oral price matches market value[cite: 6]."
    }
];