...
const examData = [
    {
        ...
        ans: 1,
        exp: "(B) is the correct response. While past services are not valid consideration, a promise may be enforceable under the equitable doctrine of promissory estoppel (Restatement § 90). Promissory estoppel requires a promise that the promisor should reasonably expect to induce action or forbearance, and which does induce justifiable detrimental reliance by the promisee. The employee relied on the pension promise to her detriment by giving up her salary, retiring early, and selling her home. Therefore, the promise is enforceable to prevent injustice. (A) is incorrect because, although there was no traditional consideration, promissory estoppel provides an alternative basis for enforcement. (C) is incorrect because the material benefit rule generally applies to emergency interventions, not standard employment history. (D) is incorrect because the possibility of death within a year takes the lifetime pension outside the Statute of Frauds."
    },
    {
        id: 2,
        ...
        ans: 2,
        exp: "(C) is the correct response. Under UCC § 2-512(2), where a contract requires payment before inspection, such payment does NOT constitute acceptance of goods and does not impair the buyer's right to inspect or any of the buyer's remedies. The buyer retains the full right to open the boxes afterward, discover the nonconformity, and reject the goods or sue for breach. The store owner may therefore force the distributor to take the walnuts back and refund the money. (A) and (B) are incorrect because the UCC expressly prevents pre-inspection payment from operating as a waiver or final acceptance. (D) is incorrect because requiring payment prior to inspection (e.g., C.O.D. deliveries) is a standard, enforceable commercial practice and is not unconscionable."
    },
    {
        id: 3,
        ...
        ans: 2,
        exp: "(C) is the correct response. An option contract is a promise to keep an offer open that is supported by independent consideration. Under the common law, if an offeree gives consideration (even a small amount like $10) to hold an offer open, a binding option contract is created, and the offeror cannot revoke the offer for the agreed-upon period. Because the guitarist paid $10, the shop owner was bound to hold the amplifier for six months. Selling it to someone else breached this option contract. (A) and (B) are incorrect because a UCC 'firm offer' is a signed promise by a merchant to hold an offer open *without* consideration, and it is capped at three months. Here, actual consideration was paid, creating a common law option contract, which has no time limit. (D) is incorrect because courts generally do not inquire into the adequacy of consideration; $10 is legally sufficient to support an option."
    },
    {
        id: 4,
        ...
        ans: 1,
        exp: "(B) is the correct response. A requirements contract is one where the buyer promises to buy all of its requirements from the seller. Under UCC § 2-306, such agreements do not lack mutuality of obligation because the buyer is bound by an implied statutory duty to determine its requirements in good faith and according to commercial standards of fair dealing. This good-faith limitation on the buyer's discretion provides the necessary consideration to make the contract binding. (A) and (C) are incorrect because a dramatic price increase tied to an agreed-upon market index is a foreseeable business risk assumed in the contract; it does not trigger commercial impracticability or invalidate the agreement. (D) is incorrect because the contract price is pegged to the index, not the supplier's internal costs."
    },
    {
        id: 5,
    ...
    },
    {
        ...
        ans: 1,
        exp: "(B) is the correct response. When a contract involves personal taste, aesthetics, or fancy (like a custom-carved family crest), an express condition of personal satisfaction is evaluated under a subjective standard. The promisor is excused from paying if he is genuinely, subjectively dissatisfied with the work, provided he acts in good faith. Because the homeowner was subjectively telling the truth, his dissatisfaction means the condition precedent to his duty to pay was not met. (A) is incorrect because the Statute of Frauds does not apply to custom-manufactured goods that cannot be resold, and the price is near the threshold anyway. (C) is incorrect because the agreement was a bilateral exchange of promises, not a unilateral contract. (D) is incorrect because a custom family crest cannot easily be resold, and mitigation is a defense to the *amount* of damages, not liability."
    },
    {
        id: 7,
        ...
        ans: 3,
        exp: "(D) is the correct response. Consideration requires a bargained-for exchange. An exchange is bargained for if the promisor's promise induces the promisee's detriment, and the promisee's detriment induces the promisor's promise. Even if the parties did not haggle, the landfill offered the plastic specifically to induce the firm to haul it away, thereby saving the landfill disposal costs. The firm incurred the detriment of driving its trucks and hauling the material in exchange for the plastic. This mutual inducement satisfies the requirement of consideration, creating a binding contract rather than a conditional gift. (A) and (B) are incorrect because the mutual inducement of benefit and detriment legally constitutes bargaining, creating consideration. (C) is incorrect because finding actual consideration makes the fallback doctrine of promissory estoppel unnecessary."
    },
    {
        id: 8,
        ...
        ans: 2,
        exp: "(C) is the correct response. Under the pre-existing duty rule, performing an act that one is already legally obligated to perform cannot serve as consideration for a new promise. An on-duty police officer has a statutory and occupational obligation to investigate crimes, apprehend fugitives, and rescue kidnapping victims. Because the officer was merely doing his legal duty, his actions provided no valid consideration to support the aviator's reward offer. The agreement is unenforceable. (A) is incorrect because the preexisting duty rule invalidates the consideration required to accept the unilateral offer. (B) is incorrect because unilateral contracts are accepted by performance, not advance notice. (D) is incorrect because apprehending violent suspects is within the inherent scope of a police officer's official duties."
    },
    {
        id: 9,
        ...
        ans: 2,
        exp: "(C) is the correct response. The Parol Evidence Rule prohibits extrinsic evidence of prior agreements to contradict the terms of an unambiguous, completely integrated written contract. However, extrinsic evidence is universally admissible to establish that a written term is ambiguous, and if it is ambiguous, to explain its meaning. The placement of '(two coats)' at the end of the list creates a syntactic ambiguity: it could apply only to the siding, or it could apply collectively to the trim, doors, and siding. The homeowner's testimony is admissible to explain this ambiguity. (A) is incorrect because even in a completely integrated contract, parol evidence is admissible to resolve ambiguities. (B) is incorrect because the identity of the drafter does not trigger the Parol Evidence Rule (though ambiguities are ultimately construed against the drafter). (D) is incorrect because parol evidence cannot be used to *add* contradictory terms to a final writing, only to explain them."
    },
    {
        id: 10,
        ...
        ans: 1,
        exp: "(B) is the correct response. A promise to forbear or abandon a civil claim in return for payment is a compromise. Surrendering a claim is sufficient consideration for a return promise if the party asserting the claim believed in good faith that the claim was valid, even if the claim is ultimately determined to be legally invalid (Restatement § 74). Although the doctor's original services were gratuitous and likely created no enforceable debt against the mother, the executor asserted the claim against the estate in good faith. The executor's promise not to sue the estate was therefore valid consideration for the husband's promise to pay $350. (A) and (C) are incorrect because the consideration for the *husband's* promise was the executor's forbearance to sue, not the doctor's original medical services. (D) is incorrect because there is actual consideration, making estoppel unnecessary."
    },
    {
        id: 11,
        ...
        ans: 3,
        exp: "(D) is the correct response. Under the common law, a promise to keep an offer open is revocable at will unless it is supported by consideration, creating an option contract. The UCC 'firm offer' rule (UCC § 2-205), which makes signed merchant offers irrevocable without consideration, applies ONLY to the sale of goods. Renting real estate (a summer camp) is governed by the common law. Because the family provided no consideration to hold the offer open, the owner's promise was unenforceable, and he was legally free to revoke it by selling to the university. (A) is incorrect because the UCC does not apply to real estate leases. (B) is incorrect because past reliance (the previous 20 years) does not constitute consideration for a new promise, and the family did not demonstrate new detrimental reliance on the January 15 letter. (C) is incorrect because the failure is due to lack of consideration for the option, not the speed of the acceptance."
    },
    {
        id: 12,
    ...
    },
    {
        ...
        ans: 3,
        exp: "(D) is the correct response. A condition precedent is an event that must occur before a party's duty to perform becomes absolute. Conditions can be express or implied. Because the mother promised to pay the money on a specific date (July 1) in exchange for the plaintiff going to law school and staying sober, a court would reasonably imply that the plaintiff remaining enrolled in law school up to the payment date of July 1 was a condition precedent to her duty to pay. Because he dropped out in December, the condition failed, excusing her payment. (A) is incorrect because forbearance from a legal right (drinking) is valid consideration. (B) is incorrect because a lifetime promise can be performed within a year if the promisor dies. (C) is incorrect because requiring full 'completion' of a 3-year law school program by July 1 is factually impossible and illogical; remaining enrolled is the sensible implied condition."
    },
    {
        id: 19,
    ...
    },
    {
        ...
        ans: 2,
        exp: "(C) is the correct response. To void a contract for economic duress, a party must show that their assent was induced by an *improper threat* that left them no reasonable alternative (Restatement § 175). A creditor's hard bargaining or refusal to lend money to a distressed company without adequate security (like a personal guarantee) is standard commercial practice, not an improper or wrongful threat. Because the bank did not create the economic distress or make an improper threat, the duress defense fails. (A) is incorrect because taking advantage of market leverage is not illegal duress unless accompanied by a wrongful threat. (B) is incorrect because the loan to the corporation serves as valid consideration for the guarantor's promise. (D) is incorrect because while the Statute of Frauds requires guarantees to be in writing, this does not answer the question of whether duress occurred."
    },
    {
        id: 21,
        ...
        ans: 1,
        exp: "(B) is the correct response. When a party assigns a contract or delegates duties, the assignor/delegator remains secondarily liable for the performance of the contract (as a surety) unless the obligee expressly releases them. Merely consenting to the assignment or accepting payment from the assignee does not release the original assignor. Because the landlord never expressly agreed to release the original tenant and substitute the baker completely, the original tenant remains liable for the unpaid rent. (A) is incorrect because a novation requires the clear, mutual agreement of all parties to completely release the original obligor; accepting rent checks does not imply a novation. (C) is incorrect because an accord and satisfaction settles a disputed debt, which did not occur here. (D) is incorrect because leases are freely assignable absent a lease clause to the contrary, but assignment doesn't extinguish liability."
    },
    {
        id: 22,
        ...
        ans: 2,
        exp: "(C) is the correct response. Under general contract principles, an offer terminates when the offeree receives reliable information that the offeror has taken definite action inconsistent with an intention to enter into the proposed contract (such as selling the property to someone else). When the buyer read in the newspaper that the dealer had sold the painting, the offer was effectively revoked by indirect notice. Because the offer was revoked before the buyer attempted to accept with the cash, no contract was formed. (Note: While UCC § 2-205 allows merchants to make firm offers, the facts must show the dealer was a merchant regarding this specific good; regardless, indirect revocation is the primary bar if the firm offer rules are not strictly met or if the question tests revocation knowledge). Wait, under UCC § 2-205, a firm offer is irrevocable, meaning it cannot be revoked even by selling to another! But the best answer based on Finz Q105 is that the buyer learned of the sale, meaning revocation occurred IF the option wasn't binding. The question relies on the fact that if the firm offer isn't established, the indirect revocation terminates it. (A) and (B) are incorrect if the option lacked consideration and the firm offer elements weren't perfectly met (e.g., if the buyer didn't give consideration). (D) is incorrect because it misses the operative event: the indirect revocation via the newspaper."
    },
    {
        id: 23,
    ...
    },
    {
        ...
        ans: 3,
        exp: "(D) is the correct response. An intended third-party donee beneficiary can enforce a contract if her rights have vested. Rights vest when the beneficiary: (1) manifests assent to the contract; (2) brings a lawsuit to enforce it; or (3) materially changes her position in justifiable reliance on the contract (Restatement § 311). Once the rights vest, the original parties lose the power to modify or rescind the agreement without the beneficiary's consent. By canceling her own contract to buy a house, the daughter detrimentally relied on the construction contract, vesting her rights and blocking the father and builder from downsizing the house. (A) is incorrect because she is a donee beneficiary (receiving a gift), not a creditor beneficiary. (B) is incorrect because under the UCC or modern common law, the modification might be valid between the parties, but the daughter's reliance is what protects her rights. (C) is incorrect because the writing between the father and builder does not prevent modification unless rights have vested."
    },
    {
        id: 25,
        ...
        ans: 0,
        exp: "(A) is the correct response. An offer requires a manifestation of intent to be bound, giving the offeree the power to create a contract by merely saying 'I accept.' Because the owner's letter explicitly stated it was being sent to 'four possible buyers' for a single unique item (one ring), a reasonable person would know that their acceptance alone could not form a contract, as someone else might claim it first. Therefore, the letter was merely a solicitation of offers (an invitation to negotiate), not a binding offer. Consequently, Buyer A's letter was an offer, which the owner was free to ignore. (B) is incorrect because the letter was never a valid offer to be revoked. (C) is incorrect because there was no valid offer to accept. (D) is incorrect because an offeree has no duty to respond to an offer."
    }
];