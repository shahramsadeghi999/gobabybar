const examData = [
    ...
    },
    {
        ...
        ans: 3,
        exp: "Under UCC §2-209(1), an agreement to modify a contract is enforceable even though unsupported by consideration. Since, as modified, the agreement does not fall within the provisions of the Statute of Frauds, it need not be in writing. Thus, if the committee agreed to accept 475 bobbleheads instead of 500, the company's delivery of 475 bobbleheads would not be a breach.\n\nThe company's inability to obtain the necessary materials would not excuse performance unless that inability resulted from circumstances that were not within the reasonable contemplation of the parties at the time the contract was formed. Since there is no indication that this is so, A is incorrect. A buyer who accepts a nonconforming tender may recover damages only if it notifies the seller of the breach within a reasonable time. B is incorrect because the buyer is not required to give notice of an intention to sue. The purpose of damages is to put the nonbreaching party in the position it would have occupied had the breach not occurred. Since the committee would have had 500 bobbleheads to distribute to conventioneers or use as it saw fit, C is incorrect."
    },
    {
        id: 3,
        ...
        ans: 2,
        exp: "A condition precedent is an event that must occur before performance under a contract becomes due. The brokerage agreement provided that the commission was to be paid 'upon transfer of title'. Since title was never transferred, the condition precedent to the homeowner's obligation to pay the commission never occurred. Since the non-occurrence of the condition was not due to the fault of the homeowner, the homeowner's duty to pay the commission was discharged.\n\nA is incorrect because an owner who accepts an offer procured by an exclusive broker at a price below the listing price remains liable for the commission based on the accepted price. B is incorrect because the buyer's offer was made during the three-month exclusive period. D is incorrect because an exclusive right to sell entitles the broker to a commission regardless of whether the broker participated in the ultimate contract formation, provided the condition precedent occurs."
    },
    {
        id: 4,
        ...
        ans: 3,
        exp: "To be enforceable, a promise must be supported by consideration, which requires a bargained-for exchange. The mother's promise was a promise to make a conditional gift motivated by maternal affection and pride rather than a bargained-for exchange. The mother was not bargaining for the plaintiff's completion of the first year as the price of her promise. Because the promise was gratuitous and unsupported by consideration, it is unenforceable.\n\nA is incorrect because divisibility does not supply consideration to an unenforceable gift promise. B is incorrect because the promise could have been performed within one year if the plaintiff had died within that period, taking it out of the Statute of Frauds. C is incorrect because describing the promise as an offer for a cash bonus does not make it enforceable without consideration."
    },
    {
        id: 5,
        ...
        ans: 1,
        exp: "When an assignor assigns a right to receive performance, the obligor remains entitled to pay or settle with the original assignor until the obligor receives notice of the assignment. If the obligor in good faith pays or enters into an agreement with the assignor before receiving notice that an assignment has occurred, the obligor's contractual duty is discharged. Because the company had received no notice of the assignment to the plaintiff when it paid the $50,000 settlement to the man in mutual rescission, the company was completely discharged of any liability.\n\nA is incorrect because the timing of the subsequent assignment to the software company is irrelevant to the obligor's discharge by settlement without notice. C and D are incorrect because giving value and identifying the right at the time of assignment do not deprive the obligor of the defense of payment or settlement prior to notification."
    },
    {
        id: 6,
        ...
        ans: 3,
        exp: "Under UCC §2-206(1)(b), an order or other offer to buy goods for prompt or current shipment invites acceptance either by a prompt promise to ship or by the prompt or current shipment of conforming or non-conforming goods. A shipment of non-conforming goods operates simultaneously as an acceptance and as a breach, unless the seller seasonably notifies the buyer that the shipment is offered only as an accommodation. Since the manufacturer did not send an accommodation notice, its prompt shipment of the non-conforming router accepted the contract and breached it simultaneously. Under the perfect tender rule (UCC §2-601), the company does not have to accept the router and is entitled to recover damages caused by the breach.\n\nA is incorrect because a shipment of non-conforming goods without an accommodation notice is an acceptance and a breach, not a counteroffer. B and C are incorrect because the company is entitled to reject the non-conforming tender and sue for damages."
    },
    {
        id: 7,
        ...
        ans: 3,
        exp: "Contract rights are generally freely assignable unless the assignment would materially change the duty of the obligor, materially increase the burden or risk imposed on the obligor, or materially impair the obligor's chance of obtaining return performance. Maintaining the lawn of the same property does not materially change the duties or burden of the defendant. An assignee stands in the shoes of the assignor and acquires all of the assignor's rights to enforce the agreement. Therefore, the plaintiff is entitled to enforce the agreement as assignee.\n\nA is incorrect because a novation is not required to enforce an assignment of contract rights. B is incorrect because lack of direct privity between the original promisor and the assignee does not prevent the assignee from enforcing the contract. C is incorrect because property ownership alone does not confer contractual standing absent an assignment."
    },
    {
        id: 8,
        ...
        ans: 0,
        exp: "The insurance company's contractual obligation is independent of the contractor's contract with the homeowner. The policy explicitly agreed to pay $50 per day for living expenses necessitated by the loss until the house was rebuilt, up to a maximum of 90 days. Since the reconstruction took 70 days, which is within the 90-day maximum, the homeowner was entitled to the full 70 days of coverage ($3,500 total, leaving $500 unpaid). The fact that the homeowner also received liquidated damages from the breaching contractor does not relieve the insurer of its separate contractual duty.\n\nB is incorrect because the policy fixed the daily rate at $50, making proof of actual expenses unnecessary. C is incorrect because agreed daily expense provisions in insurance policies are valid liquidated rates. D is incorrect because the liquidated damages clause in the repair contract creates no estoppel in favor of the unrelated insurance company."
    },
    {
        id: 9,
        ...
        ans: 0,
        exp: "A contract is divisible if (1) the performance of each party is divided into two or more parts, (2) the number of parts due from each party is the same, and (3) the performance of each part by one party is the agreed exchange for a corresponding part by the other party. Because the contract apportioned the performance and compensation at an exact rate of $10,000 per building, the contract is divisible. When a contract is divisible, a party that performs one or more parts is entitled to recover the agreed price for the completed parts, subject to any counterclaim for damages resulting from its failure to complete the remainder of the contract.\n\nB is incorrect because subjective financial inability does not create a right to payment unless the contract is divisible. C is incorrect because in a divisible contract, total completion of all units is not a condition precedent to recovery for the completed divisible units. D is incorrect because divisibility governs the recovery, not foreseeability of cash flow issues."
    },
    {
        id: 10,
        ...
        ans: 2,
        exp: "Under UCC §2-512(2), payment prior to inspection does not constitute an acceptance of goods or impair the buyer's right to inspect or any of his remedies. Upon discovering that the tender did not conform to the contract, the buyer rightfully rejected the goods (or revoked acceptance) and returned them. Under UCC §2-711(1), a buyer who rightfully rejects or revokes acceptance is entitled to cancel and recover so much of the purchase price as has been paid, and in addition may recover damages under §2-713 for non-delivery (the difference between the market price and the contract price).\n\nA is incorrect because specific performance is an equitable remedy available only when goods are unique or in other proper circumstances, which does not apply to fungible commodities like pickled eggs. B is incorrect because the difference between the value of accepted goods and the value they would have had as warranted applies under UCC §2-714 only when the buyer has accepted and retained the goods. D is incorrect because merely returning the purchase price does not award expectation damages."
    },
    {
        id: 11,
        ...
        ans: 1,
        exp: "The seller's initial letter was an invitation to negotiate. The buyer's reply was an offer to buy the books if delivered on September 1. Under the mailbox rule, an acceptance of an offer for a bilateral contract is effective upon dispatch if it is sent by a reasonable medium of communication. Because the buyer used the mail to send the offer, the mail was an authorized and reasonable medium. When the seller mailed the properly addressed acceptance letter on July 9, an enforceable bilateral contract was immediately formed, regardless of the fact that it was subsequently lost and never received.\n\nA is incorrect because the contract was bilateral, involving an exchange of mutual promises. C is incorrect because under the mailbox rule, receipt is not required for an acceptance to take effect upon dispatch. D is incorrect because contract formation upon dispatch terminates the offeror's power to revoke."
    },
    {
        id: 12,
    ...
    },
    {
        ...
        ans: 1,
        exp: "Consideration requires a bargained-for exchange. Under the traditional common law rule, past consideration is no consideration. Services rendered in the past voluntarily, without a prior request by the promisor and without expectation of compensation, cannot serve as consideration for a subsequent promise. Because the doctor's emergency services were rendered in the past without any request from the husband, they were not given in exchange for the husband's subsequent promise and cannot constitute consideration for it.\n\nA is incorrect because moral obligation alone is not valid consideration under the traditional common law rule. C is incorrect because the material benefit rule applies only where a promise is made by the person who received the benefit, and the adult son, not the husband, was the recipient of the medical services. D is incorrect because the value of past services does not cure the lack of a bargained-for exchange."
    },
    {
        id: 14,
        ...
        ans: 1,
        exp: "Under Restatement (Second) of Contracts §46, an offer made by general notification to the public (such as a notice posted on a bulletin board) may be revoked by giving publicity to the revocation equivalent to that given to the offer. If an offer made by general advertisement is revoked by a subsequent notice given equal publicity, the revocation is effective against all persons, even those who never saw the revocation notice. Therefore, whether the revocation notice was given equivalent publicity and was as conspicuously posted as the original offer is the dispositive factor.\n\nA is incorrect because if the revocation is given equal publicity, it is effective against an offeree even if that offeree did not see it. C is incorrect because an offer for a unilateral contract that calls for performance cannot be accepted by a mere promise. D is incorrect because studying for classes that a student is already enrolled in is not performance that creates an option contract under Restatement §45."
    },
    {
        id: 15,
        ...
        ans: 1,
        exp: "A promisor's duty to perform does not arise if a condition precedent to that duty fails to occur. The January 1 agreement between the landowner and the contractor provided that the conveyance of the lot would take place 'after completion of the house'. Furthermore, the contractor's son had undertaken the obligation to paint the house. Because the contractor's son wrongfully refused to paint the house, the house was not completed. The completion of the house was an express condition precedent to the landowner's duty to convey title. A party cannot sue on a contract where his own wrongful breach prevented the occurrence of the condition precedent to the defendant's performance.\n\nA is incorrect because an intended beneficiary does not need to formally assent or rely if the contract has not been modified prior to suit. C is incorrect because the son was an express donee beneficiary of the conveyance. D is incorrect because the parties were not in a fiduciary relationship."
    },
    {
        id: 16,
        ...
        ans: 0,
        exp: "Specific performance is an equitable remedy available in contracts for the sale of goods under UCC §2-716 where the goods are unique or in other proper circumstances. Because the subject matter of the contract is a rare guitar, money damages would be inadequate to purchase an identical substitute. An order of specific performance requiring the seller to deliver the unique guitar upon payment of the $500 contract price is the appropriate remedy.\n\nB is incorrect because money damages are inadequate for unique chattels. C is incorrect because specific performance gives the buyer the goods; granting specific performance and compensatory expectation damages would result in a double recovery. D is incorrect because $500 is the purchase price to be paid by the buyer, not the measure of damages for breach."
    },
    {
        id: 17,
        ...
        ans: 0,
        exp: "Under UCC §2-102, Article 2 applies to transactions in goods. Under UCC §2-105(1), 'goods' means all things (including specially manufactured goods) which are movable at the time of identification to the contract for sale. Live animals, including domestic pets, are movable personal property and fall within the statutory definition of goods. Therefore, the contract for the sale of the dog is governed by UCC Article 2.\n\nB is incorrect because missing terms do not determine whether the UCC applies to a transaction. C is incorrect because live animals are classified as goods under the UCC. D is incorrect because Article 2 applies to sales of goods regardless of whether the buyer intends to keep or resell the item."
    },
    {
        id: 18,
        ...
        ans: 0,
        exp: "Specific performance is an equitable remedy that is available only when the plaintiff has not breached and is ready, willing, and able to perform, and legal remedies are inadequate. While the defendant's sale of the painting on November 15 was an anticipatory repudiation, the defendant effectively retracted that repudiation on November 30 by reacquiring the painting and tendering conforming delivery on December 28, the date set for performance. Because the attorney refused to accept delivery and pay the purchase price when properly tendered, the attorney herself was in breach and is not entitled to specific performance.\n\nB is incorrect because purchasing an unrelated painting did not constitute cover for a unique work of art. C is incorrect because uniqueness alone does not entitle a party who refuses tender to specific performance. D is incorrect because an anticipatory repudiation can be retracted before performance is due if the aggrieved party has not canceled, sued, or materially changed position in reliance on the repudiation."
    },
    {
        id: 19,
        ...
        ans: 1,
        exp: "A condition subsequent is an event whose occurrence discharges an existing duty of performance. The contract explicitly provided that the buyer's obligation to pay the remaining $2,000 would be voided if the downstairs apartment had not been vacated within three months after closing (November 1). Because the apartment was still occupied on November 15, the condition subsequent occurred, automatically discharging the buyer's duty to pay the $2,000.\n\nA is incorrect because the parties specifically agreed to the remedy of voiding the $2,000 payment. C is incorrect because the failure of the tenant to vacate within three months does not justify total rescission after title has closed. D is incorrect because the buyer's duty to pay $2,000 was completely discharged by the terms of the agreement."
    },
    {
        id: 20,
        ...
        ans: 0,
        exp: "Under UCC §2-206(1)(a), unless otherwise unambiguously indicated by the language or circumstances, an offer to make a contract shall be construed as inviting acceptance in any manner and by any medium reasonable in the circumstances. Because the seller did not specify a medium of acceptance, and electronic communication via email is a commercially reasonable method of acceptance, the buyer's email was an effective mode of acceptance. Furthermore, an uncommunicated change of mind does not revoke an offer; a revocation is effective only when received by the offeree before acceptance. Because the seller never communicated a revocation, the buyer's acceptance formed a binding contract.\n\nB is incorrect because the obligation of good faith does not create a contract in the absence of valid offer and acceptance. C is incorrect because common law and UCC rules permit acceptance by any reasonable medium unless restricted by the offer. D is incorrect because an uncommunicated subjective change of mind does not revoke an offer."
    },
    {
        id: 21,
        ...
        ans: 3,
        exp: "An obligor is bound to pay the assignee only after the obligor receives notice that the contract right has been assigned. If an obligor pays the assignor in full before receiving notice of the assignment, the obligor's contractual duty is discharged. If the firm paid the $15,000 to the specialist before being notified of the assignment to the programmer, the payment discharged the firm's liability, providing a complete defense to the programmer's claim.\n\nA is incorrect because an assignee of a right to payment does not need the professional qualifications of the assignor. B is incorrect because contract rights to receive payment are freely assignable without an express clause permitting assignment. C is incorrect because an assignment of the right to receive payment is not a modification of the contract."
    },
    {
        id: 22,
        ...
        ans: 3,
        exp: "Under UCC §2-105, animals are classified as goods, and Article 2 applies to all contracts for the sale of goods. Under UCC §2-209(1), an agreement modifying a contract within Article 2 needs no consideration to be binding, provided it is made in good faith. Unlike the common law pre-existing duty rule, the modification to add the pig at no extra charge was enforceable simply because it was a modification of a contract for the sale of goods.\n\nA, B, and C are incorrect because UCC §2-209(1) applies to all contracts for the sale of goods, not merely contracts between merchants."
    },
    {
        id: 23,
        ...
        ans: 1,
        exp: "Under UCC §2-713, the measure of damages for non-delivery or repudiation by the seller is the difference between the market price at the time when the buyer learned of the breach and the contract price, together with any incidental and consequential damages, but less expenses saved in consequence of the seller's breach. The retailer learned of the breach on January 15, when the nonconforming boards were delivered. Therefore, damages are measured by the difference between the contract price and the fair market value of conforming 8-foot boards on January 15, not the doubled price of January 17.\n\nA is incorrect because damages are based on the market price of the conforming goods contracted for (8-foot boards). C is incorrect because under §2-713, market price is determined at the time the buyer learned of the breach (January 15), not the date of rejection. D is incorrect because the buyer rejected within a reasonable time."
    },
    {
        id: 24,
        ...
        ans: 2,
        exp: "Under general contract law (Restatement (Second) of Contracts §333), an assignor for value warrants to the assignee that the right assigned is genuine and not subject to any defenses or claims of the obligor, other than those stated or apparent at the time of assignment. An assignor does not warrant that the obligor is solvent or will perform, but does warrant that the claim is legally enforceable and that no defense (such as fraud or breach of warranty) exists against it. Because the pawnbroker's misrepresentation gave the buyer a complete defense that existed at the time the assignment was made, the pawnbroker breached the implied warranty of assignment and is liable to the retailer.\n\nA is incorrect because while an assignor does not warrant that the obligor will perform, the assignor does warrant that the obligor has no valid defenses. B is incorrect because the assignee's vulnerability to the obligor's defense triggers the assignor's liability for breach of the warranty of assignment. D is incorrect because an assignor does not warrant performance."
    },
    {
        id: 25,
        ...
        ans: 3,
        exp: "A promise is illusory and lacks consideration if the promisor reserves an unrestricted right to perform or not perform at will. A valid requirements contract under UCC §2-306 requires the buyer to promise to purchase all of its requirements exclusively from the seller. Here, the agreement did not require the restaurant to purchase all of its steak requirements from the butcher; it merely stated that the butcher would provide as many steaks 'as the restaurant decides to order'. The restaurant made no commitment to purchase any steaks at all. Because the restaurant's promise was completely illusory, the contract lacked mutuality of obligation and was unenforceable.\n\nA is incorrect because promissory estoppel cannot enforce an illusory agreement where no actual commitment was made. B is incorrect because the contract lacked exclusivity and did not measure quantity by good-faith requirements. C is incorrect because a rise in cattle feed prices constitutes mere cost increase, not commercial impossibility."
    }
];