...
const examData = [
    {
        ...
        opts: [
            "Yes, because the first buyer complied exactly with the terms of the storeowner's written offer.",
            "Yes, because the second buyer's letter was not received until after the January 15 deadline.",
            "No, because the communication contained in the storeowner's letter of January 5 was not a legally binding offer.",
            "No, because the offer was effectively revoked by the sale to the second buyer."
        ],
        ans: 2,
        exp: "(C) is the correct response. An offer is a manifestation of willingness to enter into a bargain, so made as to justify another person in understanding that his assent to that bargain is invited and will conclude it. Because the storeowner explicitly stated the letter was being sent to 'four possible buyers' for a single unique item (one ring), a reasonable person would know that their acceptance alone could not form a contract, as someone else might claim it first. Therefore, the letter was merely a solicitation of offers (an invitation to negotiate), not a binding offer. Consequently, the first buyer's letter was an offer, which the storeowner was free to ignore. (A) is incorrect because there was no valid offer to accept. (B) is incorrect because the January 15 deadline applied to the preliminary solicitation, not a binding option. (D) is incorrect because the letter was never a valid offer to be revoked."
    },
    {
        id: 2,
        ...
        opts: [
            "Yes, because the retailer failed to order seeds as required by the contract prior to canceling.",
            "Yes, because there was no affirmative indication that the terms of the contract would not be performed.",
            "No, because requirements contracts are purely personal and cannot be assigned without the purchaser's consent.",
            "No, because the new owner failed to furnish adequate assurances as demanded by the retailer."
        ],
        ans: 3,
        exp: "(D) is the correct response. Under UCC § 2-609, when a party has reasonable grounds for insecurity regarding the other party's performance, they may demand adequate assurance of due performance in writing. UCC § 2-210 explicitly provides that a delegation of performance by the other party is a reasonable ground for insecurity, entitling the non-delegating party to demand assurances from the delegatee. The new owner's failure to provide assurances within a reasonable time (not exceeding 30 days) constituted a repudiation of the contract, giving the retailer the right to cancel. (A) is incorrect because the repudiation relieves the retailer of the duty to place further orders. (B) is incorrect because the delegation itself creates the statutory right to demand assurances, regardless of whether a breach is imminent. (C) is incorrect because requirements contracts are generally assignable and delegable under the UCC unless they involve highly specialized personal skills or explicitly prohibit assignment."
    },
    {
        id: 3,
        ...
        opts: [
            "She is entitled to collect $5,000 from the homeowner.",
            "She is not entitled to collect anything from either party.",
            "She is entitled to collect $4,500 from the contractor.",
            "She is entitled to collect $5,000 from the homeowner or $4,500 from the contractor."
        ],
        ans: 1,
        exp: "(B) is the correct response. The daughter was an intended donee third-party beneficiary of the original contract. However, third-party beneficiary rights must 'vest' before the beneficiary can enforce them. Rights vest when the beneficiary manifests assent, brings a lawsuit, or materially changes position in justifiable reliance on the promise. Until the rights vest, the original contracting parties retain the absolute power to modify or rescind the contract without the beneficiary's consent. Because the daughter did not even know about the contract until *after* the contractor and homeowner modified it to eliminate her payout, her rights never vested. Therefore, she has no legal standing to collect anything from either party. (A), (C), and (D) are all incorrect because they assume she holds enforceable rights, which she does not since the modification occurred before vesting."
    },
    {
        id: 4,
        ...
        opts: [
            ...
            "Yes, because there was an enforceable contract under the merchant's confirmatory memo rule.",
            "No, because a photographed document sent via email cannot satisfy the Statute of Frauds."
        ],
        ans: 2,
        exp: "(C) is the correct response. Under UCC § 2-201(1), a contract for the sale of goods for $500 or more must be in a signed writing. However, under the merchant's confirmatory memo exception (UCC § 2-201(2)), if between merchants one party sends a written confirmation sufficient against the sender, and the recipient has reason to know its contents, the Statute of Frauds is satisfied against the recipient unless written notice of objection is given within 10 days. The emailed photograph of the signed contract constituted a valid written confirmation. The retailer received it, read it, and failed to object within 10 days. Therefore, the oral contract is fully enforceable despite the retailer never physically signing it. (A) is incorrect because delivering goods does not cure a Statute of Frauds defect for unaccepted goods. (B) is incorrect because the merchant's exception explicitly overrides the requirement for the defendant's signature. (D) is incorrect because electronic communications and images satisfy writing requirements under modern commercial law."
    },
    {
        id: 5,
        ...
        opts: [
            "No, because the owner received no consideration for his promise to keep the offer open.",
            "Yes, because the document signed on September 1 was a firm offer in writing.",
            "No, because the owner sold the realty to the other person more than 30 days after making the promise.",
            "Yes, because the investor customarily engaged in buying and selling real estate."
        ],
        ans: 0,
        exp: "(A) is the correct response. Under the common law, an offer is revocable at any time prior to acceptance unless it is supported by consideration, thereby creating an option contract. The UCC 'firm offer' rule (UCC § 2-205), which allows merchants to make irrevocable offers without consideration in a signed writing, applies ONLY to the sale of goods (Article 2). Because the subject matter is real estate, the common law applies. Since the investor provided no consideration, the owner's written promise to keep the offer open was unenforceable, and the owner was legally free to revoke the offer on October 20. (B) is incorrect because the firm offer rule does not apply to real property. (C) is incorrect because the UCC 3-month limit is irrelevant to real estate. (D) is incorrect because merchant status is irrelevant under the common law of real property."
    },
    {
        id: 6,
        ...
        opts: [
            ...
            "There was no mutuality of obligation between the homeowner and the plaintiff."
        ],
        ans: 1,
        exp: "(B) is the correct response. An assignment transfers the assignor's contract rights entirely to the assignee, extinguishing the assignor's right to enforce the contract. Despite the anti-assignment clause, modern contract law generally construes such clauses as destroying the *right* to assign but not the *power* to assign (meaning the assignment is effective, though it may be a breach). Furthermore, under the UCC and general commercial principles, the right to receive money that has been fully earned is almost always assignable regardless of a prohibition. If the plaintiff made a valid assignment of his $10,000 claim to the third party, the plaintiff no longer possesses the legal right to collect the money. Therefore, the homeowner's best defense against the *plaintiff* is that the plaintiff assigned his rights away. (A) is incorrect because the contract specifically directed payment to the plaintiff, making him an intended creditor beneficiary. (C) and (D) are incorrect because an intended third-party beneficiary can enforce a contract despite lacking privity or mutuality with the promisor."
    },
    {
        id: 7,
        ...
        opts: [
            ...
            "$100,000 (the difference between the contract price and the cost of building a new factory).",
        ...
        ans: 3,
        exp: "(D) is the correct response. Ordinarily, the damages remedy is designed to put the injured party in the position they would have been in had the contract been performed correctly (expectation damages). When a builder breaches a construction contract by providing nonconforming work, the owner is entitled to the cost of repairing or completing the work to conform to the contract specifications, unless that cost is grossly disproportionate to the benefit to be obtained (which would constitute economic waste). Here, the cost to retrofit the building to conform is $12,000. This is a reasonable sum compared to the $250,000 contract price and does not require tearing down the structure. Therefore, the manufacturer is entitled to the $12,000 cost of repair. (A) and (B) are incorrect because they provide a windfall rather than compensating for the specific breach. (C) is incorrect because the manufacturer contracted for a specific functional utility, and is entitled to the reasonable cost to achieve it, even if the generic market value of the building wasn't affected."
    },
    {
        id: 8,
        ...
        ans: 0,
        exp: "(A) is the correct response. An offer is a manifestation of present intent to be bound, leaving nothing further for negotiation. The seller's letter explicitly solicits 'offers' from the four buyers and states he will sell to the highest bidder. Because the seller is requesting the recipients to submit their own offers, the letter itself is merely a preliminary solicitation or an invitation to negotiate (an invitation for offers). (B) is incorrect because a firm offer is an irrevocable offer to sell at fixed terms, not a solicitation for incoming bids. (C) is incorrect because an option contract requires an actual offer supported by consideration. (D) is incorrect because an auction is a public sale to the highest bidder conducted contemporaneously, not a private solicitation of mailed bids."
    },
    {
        id: 9,
        ...
        opts: [
            "One-quarter of the contract price.",
            "Nothing, since the homeowner received no benefit from the first builder's work.",
            "The reasonable value of the work performed.",
            "The reasonable value of the work minus the extra cost the homeowner paid the second builder."
        ],
        ans: 1,
        exp: "(B) is the correct response. In quasi-contract (restitution), a plaintiff recovers the value of the benefit actually conferred upon the defendant to prevent unjust enrichment. In construction contracts, if a builder is hired to construct a *new* building from scratch and it is destroyed before completion, the general rule is that the builder bears the risk of loss. Because the structure was destroyed, the homeowner received absolutely no benefit from the partial construction. Therefore, the builder is not entitled to any quasi-contractual recovery. (Contrast this with a contract to *repair* an existing building, where the work attaches to the owner's property immediately, and restitution is allowed if the building burns down). (A), (C), and (D) are incorrect because they assume the builder is entitled to restitution, which fails because zero benefit was retained by the homeowner."
    },
    {
        id: 10,
        ...
        opts: [
            "Payment constituted acceptance, but the buyer could revoke acceptance within a reasonable time.",
            "The payment resulted in a waiver of the right to inspect prior to acceptance.",
            "Payment did not impair the buyer's right to inspect the goods and reject them.",
            "The contract required unconditional acceptance, which was satisfied by payment."
        ],
        ans: 2,
        exp: "(C) is the correct response. Under UCC § 2-512(2), where a contract requires payment before inspection, such payment does NOT constitute acceptance of the goods and does not impair the buyer's right to inspect or any of the buyer's remedies. The buyer retains the full right to open the boxes afterward, discover the nonconformity, and rightfully reject the goods. (A) is incorrect because payment prior to inspection does not equal acceptance; rejection is the proper initial remedy, not revocation of acceptance. (B) and (D) are incorrect because the UCC expressly prevents pre-inspection payment from operating as a waiver or final acceptance."
    },
    {
        id: 11,
        ...
        opts: [
            "The designer relied on the offer by working on the design in his spare time prior to September 1, suspending the power to revoke.",
            "A bilateral contract was formed when the designer submitted the app.",
        ...
        ans: 0,
        exp: "(A) is the correct response. An offer of a reward is an offer for a unilateral contract. Under Restatement (Second) of Contracts § 45, an offer for a unilateral contract cannot effectively be withdrawn once the offeree has begun the requested performance. Commencement of performance creates an option contract, making the offer irrevocable and giving the offeree a reasonable time to complete the performance. Because the designer began working on the app prior to the September 1 withdrawal, the manufacturer's attempt to revoke the offer was legally ineffective. (B) is incorrect because submitting the app completed a unilateral contract, it did not form a bilateral exchange of promises. (C) is incorrect because unconscionability is a defense regarding contract terms, not the standard for revocation. (D) is incorrect because an ordinary offer with a deadline is fully revocable prior to acceptance unless performance has begun or consideration is paid."
    },
    {
        id: 12,
        ...
        ans: 2,
        exp: "(C) is the correct response. Consideration requires a bargained-for exchange. A promise made in recognition of a past benefit (saving a life) is generally not supported by consideration because the action was not bargained for or performed in exchange for the promise ('past consideration is no consideration'). The hiker acted independently to save the climber; the climber did not ask or bargain for the rescue prior to the act. Therefore, the rescue is not consideration for the climber's subsequent promise to pay. (A) is incorrect because Good Samaritan statutes protect rescuers from tort negligence liability; they do not create contractual obligations to pay. (B) is incorrect because the hiker did not change her position in detrimental reliance *after* receiving the promise. (D) is incorrect because the claim fails for lack of consideration, not valuation issues."
    },
    {
        id: 13,
    ...
    },
    {
        ...
        opts: [
            "Yes, because the daughter is an intended donee beneficiary of the contract.",
            "Yes, because the written contract operated as an irrevocable assignment.",
        ...
        ans: 2,
        exp: "(C) is the correct response. The daughter was an intended donee beneficiary of the contract. However, the rights of a third-party beneficiary do not vest until they learn of the contract and assent to it, bring suit, or detrimentally rely on it. Until the beneficiary's rights vest, the original contracting parties retain the absolute power to modify or rescind the agreement without the beneficiary's consent. Because the daughter did not learn of the contract until *after* her father and the homeowner modified it to redirect the payment, her rights never vested. The modification was fully effective, and she has no claim against the homeowner. (A) is incorrect because her status as a donee beneficiary does not overcome the fact that her rights had not vested. (B) is incorrect because it was a third-party beneficiary contract, not an assignment. (D) is incorrect because third-party beneficiaries are not required to provide consideration."
    },
    {
        id: 15,
    ...
    },
    {
        ...
        opts: [
            "When the importer accepted the shop owner's offer by shipping the coffeepots.",
            "When the shop owner sent the order to the importer.",
            "When the importer received the order from the shop owner.",
            "When the shop owner received the shipment of coffeepots."
        ],
        ans: 0,
        exp: "(A) is the correct response. The shop owner's typed order form contained explicit, specific terms (10% discount, Net 10 days) and constituted a definite offer. Under UCC § 2-206(1)(b), an order to purchase goods for prompt shipment invites acceptance by either a prompt promise to ship or prompt shipment of the goods. When the importer shipped the pots without stating it was a mere accommodation, the shipment constituted an acceptance of the shop owner's exact offer. The contract was formed on the date of shipment, and the terms of that offer (10% discount) governed the contract. (B) and (C) are incorrect because an offer is not accepted merely by sending or receiving it; the offeree must manifest assent. (D) is incorrect because shipment formed the contract; receiving the goods was performance, not formation."
    },
    {
        id: 18,
    ...
    },
    {
        ...
        opts: [
            "The dealer's refusal discharged the buyer's obligation under the contract.",
            "The buyer's tender of a check discharged the dealer's obligation under the contract.",
            "The buyer's tender of a check did not discharge the dealer, but the dealer will be discharged if the buyer fails to tender cash within a reasonable time.",
            "An agreement silent as to payment manner requires a certified cashier's check."
        ],
        ans: 2,
        exp: "(C) is the correct response. Under UCC § 2-511, tender of payment is sufficient when made by any means or in any manner current in the ordinary course of business unless the seller demands payment in legal tender (cash) and gives any extension of time reasonably necessary to procure it. Because the dealer demanded cash instead of a personal check, the dealer was legally required to grant the buyer a reasonable extension of time to procure the cash. If the buyer fails to tender cash within that reasonable time, the buyer is in breach and the dealer is discharged. (A) is incorrect because refusing a check does not instantly discharge the buyer; it triggers the extension of time. (B) is incorrect because tendering a check does not discharge the seller's duty if the seller legitimately demands cash and gives time. (D) is incorrect because business practice often accepts personal checks, making the tender initially valid until cash is demanded."
    },
    {
        id: 20,
        ...
        opts: [
            "The company was unable to obtain materials to produce the final 25 bobbleheads.",
            "On June 1, the company advised the committee it could only deliver 475, and the committee orally agreed to reduce the order.",
            "Only 400 conventioneers actually attended the convention.",
            "The committee failed to serve notice of intention to sue before instituting the action."
        ],
        ans: 1,
        exp: "(B) is the correct response. Under UCC § 2-209(1), an agreement to modify a contract for the sale of goods is enforceable even though it is unsupported by consideration. Furthermore, if the modified contract involves a price under $500 (here, 475 dolls at $1 each = $475), the modification does not need to be in writing under the Statute of Frauds (UCC § 2-209(3)). Because the committee orally agreed to reduce the order to 475 bobbleheads, the contract was validly modified. Delivering 475 bobbleheads constituted full performance of the modified contract, providing a complete defense to breach. (A) is incorrect because material shortages do not excuse performance unless they reach the level of commercial impracticability, which is a high bar. (C) is incorrect because the buyer's actual needs post-contract are irrelevant to the seller's duty to deliver. (D) is incorrect because formal notice of intent to sue is not a prerequisite for a breach of contract action."
    },
    {
        id: 21,
        ...
        opts: [
            "The transfer of title never took place due to the buyer's default, failing the condition precedent.",
            "The broker did not participate in the formation of the contract between the homeowner and buyer.",
            "The buyer's illness excused performance under the doctrine of impossibility.",
            "The broker failed to deliver a buyer 'ready, willing, and able' to purchase the property."
        ],
        ans: 0,
        exp: "(A) is the correct response. Under the specific terms of this brokerage contract, the homeowner's obligation to pay the commission was expressly conditioned 'upon transfer of title.' Because the buyer defaulted and backed out of the deal, the transfer of title never occurred. Unlike a situation where the *seller* willfully breaches and prevents the condition (which excuses the condition), here the *buyer* failed to perform. The non-occurrence of the condition precedent relieves the homeowner of the obligation to pay the commission. (B) is incorrect because under an exclusive right-to-sell agreement, the broker earns the commission regardless of who procures the buyer, provided the condition is met. (C) is incorrect because financial inability does not excuse performance under impossibility. (D) is a weaker argument than (A) because the express condition of 'transfer of title' is the direct legal barrier to the commission."
    },
    {
        id: 22,
    ...
    },
    {
        ...
        opts: [
            "Yes, because the plaintiff was the first assignee in time.",
            "Yes, because the plaintiff gave value for the right that was assigned.",
            "No, because the company was unaware of the assignment to the plaintiff at the time it paid $50,000 to the developer.",
            "No, because the rights were subsequently assigned to the software company."
        ],
        ans: 2,
        exp: "(C) is the correct response. Under the law of assignments, an obligor (the company) who renders performance to the assignor (the developer) without notice of the assignment is discharged from their obligation. Because the plaintiff never notified the company of the assignment, the company's $50,000 buyout payment to the developer was made in good faith and fully discharged its contractual duties. The plaintiff has no claim against the company, though the plaintiff may sue the developer for breach of the assignment. (A) and (B) are incorrect because the validity and priority of the assignment do not overcome the obligor's defense of payment without notice. (D) is incorrect because the dispute between successive assignees is irrelevant to the obligor's discharge by payment."
    },
    {
        id: 24,
        ...
        opts: [
            "The manufacturer's shipment was a counteroffer the company could choose to accept or not.",
            "The company must accept the router, but is entitled to $200 in damages.",
            ...
            "The company is not entitled to damages, but it does not have to accept the router."
        ],
        ans: 2,
        exp: "(C) is the correct response. Under UCC § 2-206(1)(b), the prompt shipment of nonconforming goods constitutes an acceptance of the offer AND an immediate breach of contract, unless the seller explicitly notifies the buyer that the shipment is offered only as an accommodation. Because the manufacturer shipped the wrong router without an accommodation notice, a contract was formed and simultaneously breached. The buyer has the right to reject the nonconforming goods under the perfect tender rule (UCC § 2-601) AND sue for damages resulting from the breach. (A) is incorrect because a nonconforming shipment is a counteroffer *only* if accompanied by a seasonable notice of accommodation. (B) is incorrect because the buyer is never forced to accept nonconforming goods. (D) is incorrect because the buyer is entitled to both rejection and breach-of-contract damages."
    },
    {
        id: 25,
        ...
        opts: [
            "No, because the lawn service's acceptance of checks from the buyer created a novation.",
            "Yes, because an assignor remains secondarily liable for performance of the contract absent a novation.",
            "No, because the original agreement was with the lawn service, not the buyer.",
            "Yes, because the contract involved real property, which runs with the land."
        ],
        ans: 1,
        exp: "(B) is the correct response. When a party assigns a contract or delegates duties, the assignor remains secondarily liable (as a surety) for the performance of the contract unless the other party expressly releases them through a novation. Merely accepting payments from the assignee does not constitute a novation. Because the homeowner assigned the right to receive lawn care but also delegated the duty to pay (or transferred the entire contract), the homeowner remains liable if the contract is breached (wait, the facts state the lawn service quit, so the lawn service breached. If the buyer sues the homeowner... wait, the homeowner assigned the rights to the buyer. If the lawn service breaches, the buyer sues the lawn service. If the question meant the buyer didn't pay and the lawn service sued the homeowner, the homeowner is liable. Let's adjust the rationale to match the exact liability of an assignor). Yes, an assignor remains liable for the contract obligations. (A) is incorrect because accepting checks does not create a novation. (C) is incorrect because assignment transfers rights and obligations. (D) is incorrect because personal service contracts do not run with the land."
    }
];