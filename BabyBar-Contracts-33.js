const examData = [
    {
        ...
        ans: 3,
        exp: "Under the pre-existing duty rule, doing or promising to do what one is already legally obligated to do does not constitute sufficient legal detriment to act as consideration for a new promise[cite: 32]. Because the workmen were already contractually bound to work on the return voyage to San Francisco at the original fixed rate, their refusal to work without higher pay was a breach of their existing duty[cite: 32]. Consequently, the captain's promise to pay the extra salary lacked valid consideration and is entirely unenforceable[cite: 32]."
    },
    {
        id: 2,
        ...
        ans: 3,
        exp: "A condition subsequent is an event that extinguishes an existing absolute duty to perform[cite: 32]. The contract clearly structures the sequence so that the seller's promise to have the downstairs apartment vacated must be performed prior to the buyer's payment of the final $2,000[cite: 32]. Because the vacancy must occur first to trigger the buyer's duty to pay, the vacancy operates as a condition precedent to the payment, not a condition subsequent to the seller's obligation to vacate[cite: 32]. Therefore, the statement classifying it as a condition subsequent is legally inaccurate[cite: 32]."
    },
    {
        id: 3,
        ...
        ans: 0,
        exp: "The woman's text was an offer for a unilateral contract, seeking performance rather than a return promise[cite: 32]. When an offeree actively begins the actual performance requested in an offer for a unilateral contract (and not mere preparation), they simultaneously accept the offer and create an implied enforceable promise to complete the performance[cite: 32]. Because the friend actively began cutting down the tree with the woman's knowledge, he accepted the contract by part performance and subsequently breached it by failing to finish the job[cite: 32]."
    },
    {
        id: 4,
        ...
        ans: 2,
        exp: "Promissory estoppel allows the enforcement of a promise that lacks consideration if the promisee justifiably and detrimentally relied upon it[cite: 32]. However, the foundational requirement for promissory estoppel is that a clear and definite promise must actually exist[cite: 32]. The wife's desperate exclamation was an emotional cry for help in a sudden emergency, not an objective manifestation of an intent to pay a financial reward[cite: 32]. Because no reasonable person could infer a genuine promise of payment from her scream, promissory estoppel is entirely inapplicable[cite: 32]."
    },
    {
        id: 5,
        ...
        ans: 2,
        exp: "An offer must unequivocally manifest the offeror's present intent to be bound to specific terms, granting the offeree the immediate power of acceptance[cite: 32]. The language used by the seller ('Are you still interested?' and 'let me know if the price is acceptable') explicitly requests further communication and negotiation[cite: 32]. This tentative phrasing leaves substantial doubt as to whether the seller intended to be immediately bound without further confirmation, making it a mere preliminary inquiry rather than a binding legal offer[cite: 32]."
    },
    {
        id: 6,
        ...
        ans: 0,
        exp: "A novation occurs when all original parties to a contract explicitly agree to substitute a new third party for one of the original obligors, simultaneously releasing the original obligor from all future liability[cite: 32]. Because the man, the painter, and the contractor all mutually agreed to substitute the contractor in place of the painter, a valid novation was executed[cite: 32]. This completely discharged the painter's duties, shielding him from any liability for the subsequent defective performance by the new contractor[cite: 32]."
    },
    {
        id: 7,
        ...
        ans: 3,
        exp: "A contract is illusory and legally unenforceable when one of the parties retains the absolute discretion to decide whether or not to perform at all[cite: 32]. Here, the bakery only agreed to sell the restaurant 'all of the cakes it wanted to sell.'[cite: 32] Because the bakery was never actually bound to sell a single cake if it subjectively decided it didn't want to, its promise lacked mutuality of obligation[cite: 32]. This rendered the entire agreement illusory and unenforceable from its inception[cite: 32]."
    },
    {
        id: 8,
        ...
        ans: 3,
        exp: "When a new structure under construction is completely destroyed by an unforeseeable event without fault, the builder's performance may be temporarily excused under impossibility, but their refusal to rebuild entirely leaves their only potential remedy in quasi-contract (restitution)[cite: 32]. Restitution strictly requires that the defendant received and retained a measurable, tangible benefit to prevent unjust enrichment[cite: 32]. Because the partially built warehouse was totally destroyed before completion or use, the landowner derived absolutely no benefit from the builder's work, meaning the builder recovers nothing[cite: 32]."
    },
    {
        id: 9,
        ...
        ans: 3,
        exp: "A condition precedent is an event that must explicitly occur before a contractual duty becomes absolute and actionable[cite: 32]. The contract between the homeowner and the broker expressly stipulated that the 6 percent commission would be paid strictly 'upon the closing of title.'[cite: 32] Because the buyer unjustifiably breached and the closing of title never actually took place, the condition precedent failed[cite: 32]. Without the condition being met through no fault of the homeowner, the obligation to pay the commission never arose, leaving the plaintiff entitled to nothing[cite: 32]."
    },
    {
        id: 10,
        ...
        ans: 1,
        exp: "While common law generally requires new consideration to modify a contract under the preexisting duty rule, the Restatement (Second) of Contracts § 89(a) provides a crucial exception[cite: 32]. A modification is binding without fresh consideration if it is 'fair and equitable in view of circumstances not anticipated by the parties when the contract was made'[cite: 32]. The unanticipated 'explosion' of new development created drastically higher operating costs, justifying the voluntary, fair, and equitable modification agreed upon by the city[cite: 32]."
    },
    {
        id: 11,
        ...
        ans: 0,
        exp: "The plaintiff son is an intended third-party donee beneficiary of the written contract between his parents[cite: 32]. An intended third-party beneficiary acquires the irrevocable right to enforce a contract once their rights have 'vested.'[cite: 32] Vesting occurs when the beneficiary justifiably and detrimentally relies on the contract, assents to it at the parties' request, or brings suit[cite: 32]. Because the son materially relied on the agreement by canceling his separate contract to purchase a residence, his rights fully vested, rendering the parents' contract enforceable by him against the defendant's estate[cite: 32]."
    },
    {
        id: 12,
        ...
        ans: 1,
        exp: "A promise to waive or forbear from asserting a legal claim constitutes sufficient consideration for a settlement agreement, even if the underlying claim ultimately proves to be invalid[cite: 32]. The standard requires only that the surrendering party possessed an honest, good-faith subjective belief in the claim's validity at the time of settlement, and that this belief was not entirely unreasonable[cite: 32]. Because the plaintiff honestly and reasonably believed the defendant was the father when they settled, her forbearance was valid consideration[cite: 32]."
    },
    {
        id: 13,
        ...
        ans: 1,
        exp: "An effective assignment fully transfers the assignor's contract rights to the assignee[cite: 32]. By successfully assigning her right to receive payment for the installed hardware to another programmer (in satisfaction of an antecedent debt), the specialist legally alienated and extinguished her own direct legal standing to collect that specific $5,000 payment[cite: 32]. Thus, the firm's most effective defense against her personal lawsuit is simply that she no longer owns the rights she is attempting to enforce[cite: 32]."
    },
    {
        id: 14,
        ...
        ans: 3,
        exp: "Under UCC § 2-206(1)(b), while shipping goods usually accepts an order, a shipment of nonconforming goods (or a partial shipment varying the terms) does not constitute an acceptance if the seller seasonably notifies the buyer that the shipment is offered only as an accommodation[cite: 32]. When a seller explicitly makes such an accommodation shipment, it is treated as a counteroffer rather than an acceptance[cite: 32]. Consequently, there was never a binding contract formed for the 1,000 vials at the old price, precluding specific performance[cite: 32]."
    },
    {
        id: 15,
        topic: "Consideration / Pre-existing Duty Rule",
        ...
        ans: 2,
        exp: "Ordinarily, under the common law, a promise is unenforceable unless supported by fresh consideration representing a bargained-for exchange[cite: 32]. Because the plaintiff gave absolutely nothing in return for the defendant's new promise to deliver the tiger (aside from the $250 per month he was already legally obligated to pay under their existing services contract), the new promise lacked consideration[cite: 32]. Thus, the defendant's gratuitous promise to add the tiger was totally unsupported by consideration and unenforceable[cite: 32]."
    },
    {
        id: 16,
        ...
        ans: 0,
        exp: "Under UCC § 2-606, legal acceptance of goods occurs when a buyer fails to make an effective rejection after having a reasonable opportunity to inspect them[cite: 32]. Furthermore, UCC § 2-602 dictates that a rejection must occur within a reasonable time after delivery and is legally ineffective unless the buyer seasonably notifies the seller[cite: 32]. Since the retailer was explicitly aware of the short boards upon delivery but failed to notify the wholesaler for four months, he effectively accepted the goods and failed to preserve his remedies, entitling the seller to the full contract price[cite: 32]."
    },
    {
        id: 17,
        ...
        ans: 3,
        exp: "Consideration requires a bargained-for exchange involving a legal detriment suffered by the promisee[cite: 32]. Because the tractor manufacturer gave absolutely nothing (no money, action, or return promise) in exchange for the engine maker's assurance to keep the offer open, the promise strictly lacked consideration[cite: 32]. While it may have functioned as an irrevocable 'firm offer' under UCC § 2-205 making it binding without consideration, the specific question asks if the promise was *supported by consideration*, which it was not[cite: 32]."
    },
    {
        id: 18,
        ...
        ans: 2,
        exp: "Ordinarily, a promise is unenforceable if based on past consideration, because the act was already rendered without expectation of the subsequent promise[cite: 32]. However, under a modern minority trend recognized by the Restatement (Second) of Contracts § 86, a promise made in recognition of a material benefit previously received by the promisor from the promisee (such as saving a life) is binding to the extent necessary to prevent injustice[cite: 32]. This 'moral obligation' or 'material benefit' rule provides the assistant's only viable legal theory for enforcement[cite: 32]."
    },
    {
        id: 19,
        ...
        ans: 1,
        exp: "If, at the exact time a contract is formed, both parties are operating under a mutual mistake regarding a basic assumption of fact that materially affects the agreed exchange, the resulting lack of true mutual agreement excuses non-performance[cite: 32]. Because both the buyer and the dealer mistakenly believed the painting was a genuine work by the famous artist (a fundamental assumption regarding identity, not mere value), this mutual mistake voids the contract and completely excuses the buyer's non-payment[cite: 32]."
    },
    {
        id: 20,
        ...
        ans: 1,
        exp: "The parol evidence rule generally bars extrinsic evidence of prior or contemporaneous oral agreements that contradict a fully integrated writing[cite: 32]. However, a prominent exception permits parol evidence to demonstrate that a written contract was subject to an oral condition precedent to its legal formation or effectiveness[cite: 32]. Because winning the election was an agreed-upon oral condition precedent to the contract coming into existence, the failure to win the election prevented the contract from ever taking effect, completely excusing the businessman from payment[cite: 32]."
    },
    {
        id: 21,
        ...
        ans: 2,
        exp: "Under UCC § 2-713, a buyer's standard measure of expectation damages for a seller's non-delivery is the difference between the contract price and the market price on the day the buyer learns of the breach, plus incidental and consequential damages[cite: 32]. Because the market price of beans on the day of delivery ($2) perfectly equaled the contract price ($2), the restaurant suffered no actual financial loss regarding the 1,000 undelivered bushels[cite: 32]. This zero-damage calculation provides the farmer with a robust defense against significant monetary liability[cite: 32]."
    },
    {
        id: 22,
        ...
        ans: 1,
        exp: "A unilateral contract is formed when an offeror clearly requires that acceptance occur solely through the complete physical performance of a requested act, not by a return promise[cite: 32]. Because the homeowner specifically offered $1,000 to anyone who actually 'finds the thief,' the offer can only be accepted by successfully catching the thief[cite: 32]. The bar owner's verbal promise did not constitute acceptance, leaving the offer open to be accepted only by performance, provided it is not effectively revoked prior to that performance[cite: 32]."
    },
    {
        id: 23,
        ...
        ans: 2,
        exp: "If a liquidated damages clause acts as an unreasonable, punitive penalty, it is void, and the aggrieved party may simply collect their actual provable damages[cite: 32]. However, even if a liquidated damages clause is entirely valid and enforceable as a reasonable forecast, it merely establishes the baseline for monetary damages; it does not automatically preclude the equitable remedy of specific performance[cite: 32]. Because the contract involves the conveyance of unique real estate, the builder retains the right to demand specific performance regardless of the validity of the liquidated damages clause[cite: 32]."
    },
    {
        id: 24,
        ...
        ans: 1,
        exp: "Under UCC § 2-708(2), if the standard expectation measure of damages (contract price minus market price) is inadequate to put the seller in as good a position as full performance would have done, the seller may recover their expected lost profit[cite: 32]. The auto dealer is a 'lost volume seller,' holding an essentially unlimited supply of standard goods[cite: 32]. Had the first buyer not breached, the dealer would have successfully sold two cars and reaped two distinct profits[cite: 32]. Therefore, the dealer is entitled to the lost profit from the breached first sale, represented by the difference between the wholesale price and the retail price[cite: 32]."
    },
    {
        id: 25,
        topic: "Performance / Condition Precedent",
        ...
        ans: 1,
        exp: "A contract may make the happening of a particular event a condition precedent to the performance of a contractual duty, ensuring an obligation does not become absolute until the condition is fulfilled[cite: 32]. A condition can be explicitly stated or reasonably implied by language and context[cite: 32]. Since the mother's promise to pay was explicitly set for July 1, 2013, it is highly reasonable to infer that the plaintiff remaining in law school up to that payout date was an implied condition precedent to her obligation[cite: 32]. By withdrawing early in December, the plaintiff definitively failed the condition, entirely discharging the mother's duty to pay[cite: 32]."
    }
];