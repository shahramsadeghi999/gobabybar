...
const examData48 = [
    {
        ...
        opts: [
            "Yes, because under the common law, an offeror may revoke an offer at any time prior to tender of cash[cite: 5].",
            "Yes, because a firm offer under UCC § 2-205 is irrevocable only if it is made by a merchant seller, not a buyer[cite: 5].",
            "No, because the bakery's signed writing explicitly promised that the offer would remain open until April 15[cite: 5].",
            "No, because under UCC § 2-205, the period of irrevocability for a firm offer cannot exceed three months[cite: 5]."
        ],
        ans: 2,
    ...
    },
    {
        ...
        opts: [
            "No, because the niece did not suffer any actual economic detriment by refraining from buying a motorcycle[cite: 5].",
            "Yes, because forbearing from a legal right at the promisor's request constitutes valid consideration[cite: 5].",
            "No, because family promises are presumed to be gratuitous and require a signed writing to be enforceable[cite: 5].",
            "Yes, under the doctrine of promissory estoppel, because the niece relied on the promise to her financial detriment[cite: 5]."
        ],
        ans: 1,
    ...
    },
    {
        ...
        opts: [
            "Yes, because a rejection of an option contract does not terminate the power of acceptance unless the offeror materially relies on it[cite: 5].",
            "No, because the developer's rejection of the option contract operated as an immediate mutual rescission[cite: 5].",
            "Yes, because under the mailbox rule, an option exercise is effective upon dispatch, overriding a prior rejection[cite: 5].",
            "No, because an explicit rejection permanently terminates an offeree's power of acceptance under the common law[cite: 5]."
        ],
        ans: 0,
    ...
    },
    {
        ...
        opts: [
            "Yes, because the contract was unconscionable due to the gross disparity between the purchase price and actual value[cite: 5].",
            "No, because a unilateral mistake by a merchant cannot void a commercial sale of consumer goods[cite: 5].",
            "Yes, because both parties were mutually mistaken about a basic assumption of fact that materially affected the agreed exchange[cite: 5].",
            "No, because the homeowner consciously bore the risk of ignorance by selling the violin without an expert appraisal[cite: 5]."
        ],
        ans: 3,
    ...
    },
    {
        ...
        opts: [
            "Yes, because the general contractor knew or had reason to know of the palpable clerical error, making enforcement unconscionable[cite: 5].",
            "No, because unilateral errors caused by a contractor's own clerical negligence cannot excuse contractual obligations[cite: 5].",
            "No, because the general contractor incorporated the subcontractor's bid into a binding prime bid[cite: 5].",
            "Yes, under the doctrine of supervening commercial impracticability due to extreme financial hardship[cite: 5]."
        ],
        ans: 0,
    ...
    },
    {
        ...
        opts: [
            "Yes, because commercial parties possess unrestricted freedom of contract to modify shipping rates[cite: 5].",
            "No, because the modification was induced by an improper threat that left the distributor with no reasonable alternative[cite: 5].",
            "No, because modifications of commercial shipping contracts require independent consideration in cash[cite: 5].",
            "Yes, because the distributor signed the writing voluntarily after evaluating its business interests[cite: 5]."
        ],
        ans: 1,
    ...
    },
    {
        ...
        opts: [
            "Yes, because the agreement was embodied in a signed writing with a fixed price term[cite: 5].",
            "Yes, because the agreement constituted a valid requirements contract under UCC § 2-306[cite: 5].",
            "No, because commercial agreements for the sale of goods over $500 require consideration in cash[cite: 5].",
            "No, because the retailer's promise to buy only what it 'may desire to order' was illusory, rendering the agreement void for lack of mutuality[cite: 5]."
        ],
        ans: 3,
    ...
    },
    {
        ...
        opts: [
            "No, because a collateral promise to answer for the debt of another must be in a signed writing[cite: 5].",
            "Yes, under the main purpose rule, because the homeowner's primary objective was to secure completion of his garage[cite: 5].",
            "Yes, but only to the extent of the new deliveries, excluding the pre-existing $5,000 balance[cite: 5].",
            "No, because oral suretyship agreements are void per se under UCC § 2-201[cite: 5]."
        ],
        ans: 1,
    ...
    },
    {
        ...
        opts: [
            "Yes, because under the part performance exception, taking possession, paying part of the price, and making substantial permanent improvements removes the bar[cite: 5].",
            "No, because contracts for the sale of real estate must be in a signed writing without exception[cite: 5].",
            "Yes, because the seller's endorsement of the $10,000 check satisfied the Statute of Frauds memorandum requirement[cite: 5].",
            "No, because the part performance exception requires payment of 100% of the purchase price[cite: 5]."
        ],
        ans: 0,
    ...
    },
    {
        ...
        opts: [
            "No, because the written contract set forth all the essential obligations of the parties[cite: 5].",
            "Yes, because extrinsic evidence is always admissible to add duties to a written real estate lease[cite: 5].",
            "Yes, because the writing is a partial integration and the oral term is a consistent additional term[cite: 5].",
            "No, because the oral condition directly contradicts the express payment covenants in the writing[cite: 5]."
        ],
        ans: 2,
    ...
    },
    {
        ...
        opts: [
            "Yes, because between merchants, additional terms automatically become part of the contract unless objected to[cite: 5].",
            "No, because a mandatory arbitration clause is a material alteration that does not become part of the contract without express assent[cite: 5].",
            "Yes, because accepting and paying for the shipment operated as an express assent to all terms on the supplier's form[cite: 5].",
            "No, because the supplier's acknowledgment operated as an invalid counteroffer that prevented contract formation[cite: 5]."
        ],
        ans: 1,
    ...
    },
    {
        ...
        opts: [
            "Yes, because the artist substantially performed in full conformity with technical artistic standards[cite: 5].",
            "Yes, because where a condition calls for satisfaction, the law applies an objective reasonable-person standard[cite: 5].",
            "No, because contracts conditioning payment on personal satisfaction are illusory and void for lack of mutuality[cite: 5].",
            "No, because contracts involving personal aesthetics enforce an express condition of subjective personal satisfaction, provided dissatisfaction is in good faith[cite: 5]."
        ],
        ans: 3,
    ...
    },
    {
        ...
        opts: [
            "Yes, because the retraction was received before the buyer canceled the contract, filed suit, or materially changed position in reliance[cite: 5].",
            "No, because the buyer materially changed its position by soliciting formal price quotations from competing builders[cite: 5].",
            "No, because an anticipatory repudiation operates as an immediate total breach that terminates all rights of retraction[cite: 5].",
            "Yes, because under the UCC, an anticipatory repudiation can be retracted at any time up until the date scheduled for delivery[cite: 5]."
        ],
        ans: 0,
    ...
    },
    {
        ...
        opts: [
            "$200, representing the difference between the market price at repudiation and the contract price[cite: 5].",
            "$1,000, representing the difference between the market price on the delivery date and the contract price[cite: 5].",
            "$800, representing the seller's unjust profits realized from the repudiation[cite: 5].",
            "$500, representing the difference between the actual cover price ($3,500) and the contract price ($3,000)[cite: 5]."
        ],
        ans: 3,
    ...
    },
    {
        ...
        opts: [
            "Nothing, because the dealer resold the boat for the contract price[cite: 5].",
            "$10,000, because under UCC § 2-708(2), a lost volume seller recovers profit including reasonable overhead without deduction for fixed expenses[cite: 5].",
            "$7,000, representing net operating profit after deducting allocated overhead[cite: 5].",
            "$50,000, representing the entire contract price of the boat[cite: 5]."
        ],
        ans: 1,
    ...
    },
    {
        ...
        opts: [
            "Yes, because real property is presumed unique as a matter of law, rendering legal damages inadequate[cite: 5].",
            "No, because modern commercial office buildings were available nearby, providing an adequate substitute[cite: 5].",
            "No, because specific performance is an extraordinary equitable remedy restricted to residential dwellings[cite: 5].",
            "Yes, but only if the investor proves that the owner acted with intentional malice in breaching the agreement[cite: 5]."
        ],
        ans: 0,
    ...
    },
    {
        ...
        opts: [
            "$1,500, because a buyer who willfully repudiates a contract of sale forfeits all rights to a down payment[cite: 5].",
            "Zero, because the dealer resold the goods at the full contract price and suffered zero actual damages[cite: 5].",
            "$500, because in the absence of a liquidated damages clause, the seller's statutory retention is limited to 20% of the contract price or $500, whichever is smaller[cite: 5].",
            "$1,000, representing 20% of the total contract price of the furniture[cite: 5]."
        ],
        ans: 2,
    ...
    },
    {
        ...
        opts: [
            "No, because liquidated damages clauses in construction contracts are disfavored as against public policy[cite: 5].",
            "Yes, because the stipulated amount was a reasonable forecast of anticipated harm that was difficult to estimate at the time of contracting[cite: 5].",
            "No, because the developer's actual damages ($5,200) exceeded the liquidated amount ($5,000)[cite: 5].",
            "Yes, but only if the developer proves that the paving company acted with intentional disregard of the completion deadline[cite: 5]."
        ],
        ans: 1,
    ...
    },
    {
        ...
        opts: [
            "No, because the original contracting parties retain the absolute power to modify or rescind their agreement at any time prior to completion[cite: 5].",
            "No, because the daughter gave no consideration to either the uncle or the builder[cite: 5].",
            "Yes, because the daughter's rights as an intended third-party beneficiary vested when she manifested assent to the contract[cite: 5].",
            "Yes, but only if the daughter detrimentally changed her position in reliance on the gift[cite: 5]."
        ],
        ans: 2,
    ...
    },
    {
        ...
        opts: [
            "Yes, because a delegating obligor remains secondarily liable as a surety unless supported by fresh consideration[cite: 5].",
            "Yes, because contracts involving personal artistic skills cannot be delegated under common law[cite: 5].",
            "No, because an assignee takes subject to all defenses existing against the assignor[cite: 5].",
            "No, because the three-party agreement constituted a novation that completely discharged the tailor from all liability[cite: 5]."
        ],
        ans: 3,
    ...
    },
    {
        ...
        opts: [
            "No, because the dairy farm had no right to suspend performance until the supplier actually missed a scheduled monthly delivery[cite: 5].",
            "Yes, because the supplier's failure to provide adequate assurance of performance within a reasonable time not exceeding 30 days operated as an anticipatory repudiation[cite: 5].",
            "No, because demands for adequate assurance under the UCC require an affidavit certified by an independent commodities broker[cite: 5].",
            "Yes, because requirements and output feed agreements are terminable at will by either party upon 30 days' notice[cite: 5]."
        ],
        ans: 1,
    ...
    },
    {
        ...
        opts: [
            "No, because contracts for the sale of goods for $500 or more require an extrinsic signed writing executed prior to litigation[cite: 5].",
            "No, because a party may plead the Statute of Frauds as an affirmative defense without forfeiting its protections through factual admissions[cite: 5].",
            "Yes, because oral contracts between restaurant merchants are exempt from the Statute of Frauds[cite: 5].",
            "Yes, because under UCC § 2-201(3)(b), an oral contract is enforceable if the party against whom enforcement is sought admits in his pleading or testimony that a contract was made[cite: 5]."
        ],
        ans: 3,
    ...
    },
    {
        ...
        opts: [
            "Yes, under the doctrine of supervening illegality and objective impossibility under Restatement (Second) of Contracts § 264[cite: 5].",
            "No, because commercial manufacturers assume the risk of administrative regulatory changes[cite: 5].",
            "No, because the amusement park did not consent to a modification or discharge of the contract[cite: 5].",
            "Yes, but only under UCC § 2-615 if the manufacturer pays reliance damages to the amusement park[cite: 5]."
        ],
        ans: 0,
    ...
    },
    {
        ...
        opts: [
            "No, because specific performance is an equitable remedy restricted to contracts for unique real property[cite: 5].",
            "No, because output contracts lack a definite quantity term and cannot be enforced by injunction[cite: 5].",
            "Yes, because under UCC § 2-716(1), specific performance may be decreed where the goods are unique or in other proper circumstances, such as an inability to effect cover[cite: 5].",
            "Yes, but only if the utility deposits the full ten-year purchase price in escrow[cite: 5]."
        ],
        ans: 2,
    ...
    },
    {
        ...
        opts: [
            "The seller, because the buyer had not yet taken physical possession of the goods[cite: 5].",
            "The buyer, because risk of loss passes to the buyer upon receipt of a negotiable document of title covering the goods[cite: 5].",
            "The seller, because risk of loss in bailee cases passes only after a reasonable time for pickup has elapsed[cite: 5].",
            "The warehouse, because bailees are strictly liable for all losses occurring on their premises[cite: 5]."
        ],
        ans: 1,
