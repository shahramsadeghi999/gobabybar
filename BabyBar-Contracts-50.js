...
const examData = [
    {
        ...
        ans: 2,
        exp: "(C) is the correct response. While minors generally lack the capacity to enter a binding contract, a contract will be enforced if the minor affirms (ratifies) the contract after reaching the age of majority. A minor can affirm a contract either expressly or by conduct, such as continuing to honor the contract or making payments after reaching majority. Because the state age of majority was 18 and the student continued to make payments after her 18th birthday, she affirmed the contract, making it fully enforceable. (A) is incorrect because an item used merely for commuting is generally not classified as a necessary of life, and regardless, ratification makes the entire contract enforceable. (B) is incorrect because her offer to return the scooter came after she had already ratified the contract. (D) is incorrect because the initial incapacity was cured by her subsequent post-majority ratification."
    },
    {
        id: 2,
        ...
        ans: 0,
        exp: "(A) is the correct response. Ordinarily, a lost volume seller who resells goods at the same price can recover lost profits because they would have made two sales instead of one. However, where there is a strict limit to the availability of the items sold (e.g., they are discontinued and the seller possesses only a finite, exact number), the seller is not a lost volume seller because they could not have made a second sale regardless of the breach. Since there were no more monitors to sell, the liquidator lost nothing when it resold the exact same monitors to the school district at the identical price. (B) is incorrect because an action for the price is unavailable when goods are successfully resold. (C) is incorrect because that formula represents the buyer's remedy for breach, not the seller's. (D) is incorrect because the liquidator lacked the inventory to make both sales, defeating the lost volume seller doctrine."
    },
    {
        id: 3,
        ...
        ans: 1,
        exp: "(B) is the correct response. When a contractor agrees to construct a *new* building, the destruction of the partially completed structure by fire or storm does not discharge the contractor's duty under the doctrine of impossibility. It remains objectively possible for the contractor to rebuild the structure from scratch and fulfill the contract, even though it will be substantially more expensive and time-consuming. Therefore, the contractor's refusal to rebuild constituted an actionable breach. (A) is incorrect because the timing of progress payments does not excuse a failure to perform. (C) is incorrect because destruction of a building under construction (unlike a repair contract on an existing building) is not deemed destruction of the subject matter that excuses performance. (D) is incorrect because the percentage of completion is irrelevant to the doctrine of impossibility in new construction contracts."
    },
    {
        id: 4,
        ...
        ans: 2,
        exp: "(C) is the correct response. Under the UCC, while a buyer generally has the right to inspect goods before payment, the parties may explicitly agree that payment is required prior to inspection. If the contract contains such a clause, the buyer's failure to make payment upon delivery of the goods constitutes a breach of contract. The manufacturer's refusal to pay without inspecting directly violated the express terms of the agreement. (A) is incorrect because the express contract term superseded the default statutory right of pre-payment inspection. (B) is incorrect because the refusal to pay occurred at the exact time payment was required, constituting an actual present breach rather than an anticipatory repudiation. (D) is incorrect because UCC § 2-512 explicitly permits agreements requiring payment prior to inspection; such clauses are not unconscionable."
    },
    {
        id: 5,
        ...
        ans: 2,
        exp: "(C) is the correct response. A unilateral contract is an offer that requests acceptance by full performance of a specified act rather than by a return promise. The firm's notice promised to pay a bonus only to an employee who actually developed and submitted the winning algorithm. Because the firm requested performance (submitting the code) rather than a promise to perform, it was an offer for a unilateral contract. (A) is incorrect because the notice was a definitive promise to pay a specific reward for a specific act, making it a binding offer rather than a mere invitation to negotiate. (B) is incorrect because the offer could not be accepted by a return promise; the engineer's email was therefore legally ineffective to form a contract. (D) is incorrect because an offer for a unilateral contract becomes irrevocable only when the offeree commences the requested performance, not merely by reading the notice."
    },
    {
        id: 6,
        ...
        ans: 1,
        exp: "(B) is the correct response. Under general contract law, a promise not to assign a contract operates as a covenant rather than a condition. An assignment made in violation of a general anti-assignment clause is usually regarded as valid and effective to transfer the rights to the assignee, although the assignor may be liable for damages for breaching the covenant not to assign. Because the assignment was effective, the buyer (assignee) can enforce the contract against the pool service. (A) is incorrect because standard pool cleaning is a routine commercial service, not a unique 'personal service' that prevents assignment. (C) is incorrect because a general prohibition against assignment does not render the assignment void, it merely creates a breach of covenant. (D) is incorrect because a party is not required to act reasonably in withholding consent unless the contract explicitly requires it."
    },
    {
        id: 7,
        ...
        ans: 1,
        exp: "(B) is the correct response. Consideration requires a bargained-for exchange involving a legal detriment. Under the preexisting duty rule, performing an act that one is already legally or officially obligated to do cannot serve as consideration for a new promise. A police officer's official duties include investigating crimes and apprehending criminals. Because the detective was already obligated by his employment to catch the robber, his performance provided no new consideration to support the city's promise to pay the reward. (A) is incorrect because a reward poster is an offer for a unilateral contract, not a gratuitous promise. (C) is incorrect because the reward specifically offered payment for 'information leading to' the arrest, which the detective provided. (D) is incorrect because the preexisting duty rule is the direct, established contract law defense to this specific claim."
    },
    {
        id: 8,
        ...
        ans: 0,
        exp: "(A) is the correct response. The Parol Evidence Rule prohibits the introduction of extrinsic evidence of prior or contemporaneous agreements offered to contradict, vary, or modify an unambiguous writing that the parties intended to be a full and final expression of their agreement (a complete integration). The written contract explicitly identified the 1965 convertible. The enthusiast's assertion that the agreement was actually for a 1967 hardtop directly contradicts the express terms of the integrated written contract. Therefore, the testimony is strictly inadmissible. (B) is incorrect because admissibility under the Parol Evidence Rule turns on the integration of the writing and contradiction, not the presence of corroborating witnesses. (C) is incorrect because the enthusiast is alleging a contradictory term regarding the subject matter, not fraud in the inducement (e.g., a lie about the car's condition). (D) is incorrect because there is no ambiguity in the contract to resolve."
    },
    {
        id: 9,
        ...
        ans: 2,
        exp: "(C) is the correct response. Quantum meruit (implied-in-law contract) is available to prevent unjust enrichment only where services are rendered under circumstances indicating that the party from whom payment is sought was aware of the other party's expectation of payment. Because the woman was unconscious during the rescue and the jogger dove in without any prior negotiation, there was no mutual expectation of compensation. Furthermore, her subsequent promise was for $1,000 as a token of gratitude, not an express promise to reimburse the $500 sunglasses. The executor is not bound to pay for the lost gear. (A) is incorrect because 'danger invites rescue' is a tort doctrine used to establish duty and proximate cause, not a basis for contract recovery. (B) and (D) are incorrect because absent an express promise to pay for the property loss or an initial expectation of compensation, quasi-contract does not force an accident victim to replace a rescuer's lost property."
    },
    {
        id: 10,
        ...
        ans: 0,
        exp: "(A) is the correct response. Performance of one of a series of mutual promises is a condition precedent to others if the circumstances indicate it should obviously precede the others. Because the writing explicitly called for payment of $1,000 'in advance,' it is obvious the parties intended that payment to precede the commencement of work. Thus, the $1,000 payment was a condition precedent to the contractor's duty to build. Similarly, because the contract called for the remaining $3,000 'upon completion,' the contractor's finishing the patio cover was a condition precedent to the homeowner's duty to pay the balance. (B) is incorrect because concurrent conditions require simultaneous performance, which contradicts 'in advance'. (C) is incorrect because the obligations are clearly conditioned sequentially. (D) is incorrect because a condition subsequent discharges an existing duty; completion here triggers the final payment duty rather than discharging the initial one."
    },
    {
        id: 11,
        ...
        ans: 1,
        exp: "(B) is the correct response. In an action for breach of an employment contract, a wrongfully discharged employee is entitled to receive the full contract price for the balance of the term plus consequential damages, LESS the income earned (or damages avoided) by mitigating through substitute employment. Because the director mitigated his damages by taking a comparable job at the exact same salary, his ongoing future damages were reduced to zero from that point forward. However, he is still entitled to the four months of lost wages he suffered before the new job began, plus any incidental expenses incurred in finding the new job. (A) is incorrect because it fails to deduct the wages earned from the substitute employment. (C) is incorrect because severance pay is a contractual term, not a default legal remedy. (D) is incorrect because mitigation stops the accrual of future damages, but does not erase the actual damages already suffered during the four months of unemployment."
    },
    {
        id: 12,
        ...
        ans: 3,
        exp: "(D) is the correct response. Under UCC § 2-206(1)(b), an order for prompt shipment invites acceptance by either a promise to ship or the actual shipment of conforming or nonconforming goods. However, the statute contains a specific exception: 'such a shipment of non-conforming goods does not constitute an acceptance if the seller seasonably notifies the buyer that the shipment is offered only as an accommodation to the buyer'. Because the supplier shipped a nonconforming quantity (2,500 instead of 5,000) and explicitly included a notice of accommodation, the shipment acted as a counteroffer, not an acceptance. Therefore, no contract for the 5,000 bolts was formed. (A) is incorrect because the accommodation notice prevents the shipment from operating as an acceptance. (B) is incorrect because shipping a lesser quantity ordinarily *would* be an acceptance and a breach, were it not for the explicit accommodation notice. (C) is incorrect because the emergency nature of the order does not override the statutory accommodation rule."
    },
    {
        id: 13,
        ...
        ans: 1,
        exp: "(B) is the correct response. Consideration requires a bargained-for exchange where one party incurs a legal detriment. Forbearance from asserting a legal claim constitutes valid consideration, even if the claim is ultimately proven to be invalid, provided that the party asserting the claim possessed a good faith, reasonable belief in its validity at the time of the agreement (Restatement § 74). The sedan driver believed he had a valid negligence claim and gave up his legal right to sue in exchange for the employer's promise to pay. This exchange of promises created a binding contract. (A) is incorrect because an employer can validly contract to settle claims against an employee. (C) is incorrect because the subsequent discovery of camera footage invalidating the claim does not destroy the consideration that existed when the good-faith settlement was reached. (D) is incorrect because there is actual consideration (a bilateral contract), making promissory estoppel unnecessary."
    },
    {
        id: 14,
        ...
        ans: 0,
        exp: "(A) is the correct response. Under UCC § 2-205, a merchant's offer to buy or sell goods in a signed writing that by its terms gives assurance that it will be held open is irrevocable for the time stated (up to three months), even without consideration. The manufacturer is a merchant, the offer was in a signed writing, and it explicitly assured the offer would be kept open for 30 days. Consequently, it was a valid firm offer, and the manufacturer possessed no legal power to revoke it prior to the expiration of the 30-day period. The telephoned revocation was void. (B) is incorrect because an ordinary offer can be revoked orally; the invalidity here stems from the firm offer rule, not the medium of revocation. (C) is incorrect because UCC § 2-205 explicitly makes qualifying firm offers irrevocable without consideration. (D) is incorrect because the offeree is not required to communicate acceptance to lock in a firm offer; the signed writing itself creates the irrevocability."
    },
    {
        id: 15,
        ...
        ans: 2,
        exp: "(C) is the correct response. An agreement to accept a lesser sum in satisfaction of a debt (an accord) must be supported by consideration. Under the pre-existing duty rule, if a debt is liquidated and undisputed, promising to pay a lesser amount provides no consideration. However, if the debt is subject to a good-faith dispute, the compromise of that claim furnishes valid consideration. For the compromise to be binding, the parties must possess an honest, good-faith belief in their respective positions. If the client honestly believed the work was defective and the designer honestly believed the full debt was owed, their mutual compromise creates a binding accord. (A) and (B) are incorrect because if a party asserts a defense or claim in bad faith (knowing it is invalid), their surrender of that bad-faith position does not constitute valid consideration. (D) is incorrect because the mere filing of a lawsuit does not cure a lack of good faith in the underlying dispute."
    },
    {
        id: 16,
        ...
        ans: 0,
        exp: "(A) is the correct response. Although the Parol Evidence Rule generally prevents the introduction of extrinsic evidence of prior agreements to modify a written integration, it does not bar evidence offered to prove that the written agreement never came into legal existence. An oral agreement that a written contract will not become binding unless a specific condition occurs (a condition precedent to effectiveness) is universally admissible. The patron's evidence shows the contract was conditioned on obtaining a permit, so it is admissible to prove no contract was formed. (B) is incorrect because the oral agreement was made *prior* to signing, so it is not a subsequent modification. (C) is incorrect because the condition precedent exception bypasses the Parol Evidence Rule entirely. (D) is incorrect because an agreement about a permit condition does not fall within the Statute of Frauds."
    },
    {
        id: 17,
        ...
        ans: 3,
        exp: "(D) is the correct response. The oral agreement for 15 figurines at $100 each totals $1,500, placing it squarely within the UCC Statute of Frauds (goods over $500). Because no goods were delivered or paid for, no writing exists, it is not a custom good, and no merchant's confirmatory memo was sent, this oral agreement is completely unenforceable. (A) is incorrect because under UCC § 2-201(3)(b), admitting the contract in court pleadings removes the Statute of Frauds bar. (B) is incorrect because under UCC § 2-201(2), a merchant who fails to object to a confirmatory memo within 10 days loses the Statute of Frauds defense. (C) is incorrect because specially manufactured goods (custom family crest) on which substantial work has begun are exempt from the Statute of Frauds under UCC § 2-201(3)(a)."
    },
    {
        id: 18,
        ...
        ans: 1,
        exp: "(B) is the correct response. Under the traditional common law rule, a minor who disaffirms is entitled to a full refund without deduction for depreciation or damage. However, the modern minority rule (often tested as a specific variant, such as in Finz Q18) holds that if a minor disaffirms a contract and seeks restitution, the minor's recovery is offset by the reasonable value of the benefit the minor received (use and depreciation). Measuring the benefit by the reasonable rental value is a common judicial approach under this modern view. Because the rental value was $200/month for two months ($400), the $2,000 refund is offset by $400, leaving $1,600. (A) states the traditional majority rule, but the specific question tests the offset for benefit received. (C) is incorrect because the offset is based on the value of the use/benefit (rental value), not the tortious damage to the vehicle. (D) is incorrect because minors generally retain the power to disaffirm even if the property is damaged."
    },
    {
        id: 19,
        ...
        ans: 2,
        exp: "(C) is the correct response. An offer of a reward is an offer for a unilateral contract, accepted only by full performance (finding and returning the watch). Under Restatement (Second) of Contracts § 45, once an offeree begins the requested performance (here, renting equipment and actively searching), the offeror's power to revoke is suspended, creating an option contract that gives the offeree a reasonable time to complete performance. Because the woman had begun performance, the man's revocation was legally ineffective. Upon completing performance by finding the watch, she was entitled to the reward. (A) is incorrect because the offer became irrevocable once performance began. (B) is incorrect because the irrelevance of her seeing the revocation stems from the irrevocability of the offer, not notice rules. (D) is incorrect because unilateral contracts do not require advance notice of acceptance."
    },
    {
        id: 20,
        ...
        ans: 1,
        exp: "(B) is the correct response. Under UCC § 2-305(1), the parties can conclude a contract for the sale of goods even though the price is not settled. In such cases, the price is a 'reasonable price at the time for delivery' if the price is left to be agreed by the parties and they fail to agree, or if nothing is said as to price. Because this is a contract for the sale of goods (tomatoes), the UCC applies, and the omission of the price term does not destroy the contract's validity. (A) is incorrect because the UCC expressly rejects the common law rule that required all essential terms to be stated in the writing. (C) is incorrect because under UCC § 2-201, a writing satisfies the Statute of Frauds even if it omits a price term, so long as it contains a quantity term and is signed. (D) is incorrect because the statute supplies a 'reasonable market price,' not unilateral dictation by the seller."
    },
    {
        id: 21,
        ...
        ans: 2,
        exp: "(C) is the correct response. The Parol Evidence Rule bars extrinsic evidence of prior or contemporaneous oral agreements offered to contradict or supplement a completely integrated written contract. An explicit merger clause establishes complete integration. Therefore, a simultaneous oral agreement adding a new duty (using a specific brand of paint) supplements the integrated writing and is strictly barred. (A) is incorrect because an oral condition precedent to the legal effectiveness of the entire agreement is a recognized exception to the Parol Evidence Rule and is admissible. (B) is incorrect because extrinsic evidence is admissible to explain ambiguous terms ('completion'). (D) is incorrect because the Parol Evidence Rule applies only to prior or contemporaneous agreements, not to subsequent modifications made after the contract was signed."
    },
    {
        id: 22,
        ...
        ans: 0,
        exp: "(A) is the correct response. Under UCC § 2-319 and § 2-509, a contract designated 'F.O.B. Seller's factory' is a shipment contract. In a shipment contract, the risk of loss passes to the buyer when the seller delivers the conforming goods to the carrier. Because the supplier loaded the goods on the truck and notified the buyer on June 1, the risk of loss passed to the university. Therefore, the university bears the financial loss for the June 2 crash and must pay the contract price. Furthermore, under UCC Article 9, a seller who has fully performed may assign the right to payment despite a contractual prohibition. The creditor can thus collect the $25,000. (B) is incorrect because impossibility does not excuse a buyer who already bears the risk of loss. (C) is incorrect because anti-assignment clauses cannot prohibit the assignment of a fully earned account receivable under the UCC. (D) is incorrect because liability is based on the contractual risk of loss passing upon delivery to the carrier, not vicarious tort liability."
    },
    {
        id: 23,
        ...
        ans: 0,
        exp: "(A) is the correct response. Under UCC § 2-209(1), an agreement modifying a contract for the sale of goods needs no consideration to be binding. However, under UCC § 2-209(3), the requirements of the Statute of Frauds must be satisfied if the contract as modified is within its provisions. The modified contract was for the sale of a painting for $3,000, bringing it squarely within the UCC Statute of Frauds (goods over $500). Because the dealer's agreement to the $3,000 price was entirely oral and no exception (like receipt of goods or payment) applied, the modification was unenforceable against the dealer. The gallery owner cannot enforce the $3,000 price. (B) is incorrect because there is no indication the gallery materially changed its position in detrimental reliance on the oral modification before the dealer retracted it. (C) is incorrect because the UCC abolished the pre-existing duty rule for sales of goods; lack of consideration does not invalidate the modification. (D) is incorrect because it ignores the Statute of Frauds requirement imposed by § 2-209(3)."
    },
    {
        id: 24,
        ...
        ans: 2,
        exp: "(C) is the correct response. A valid requirements contract is created when a buyer agrees to fulfill all of its requirements from a specific seller. Under UCC § 2-306, a term which measures quantity by the output of the seller or the requirements of the buyer means such actual output or requirements as may occur in good faith. A specific numeric quantity term is not required for a requirements contract to be valid and enforceable, nor does its absence violate the Statute of Frauds, because the 'all requirements' language provides a sufficient standard to determine the quantity. (A) is incorrect because the 'all requirements' language satisfies the quantity requirement. (B) is incorrect because the restaurant (the party to be charged) signed the agreement, and the brewery accepted by beginning performance. (D) is incorrect because there was an actual valid contract, making the equitable doctrine of promissory estoppel unnecessary."
    },
    {
        id: 25,
        ...
        ans: 3,
        exp: "(D) is the correct response. A contract is formed upon acceptance of an offer. The shop owner's typed order form contained explicit, specific terms (50 pots, 10% discount, Net 10 days) and constituted a definite offer. Under UCC § 2-206(1)(b), an order to purchase goods for prompt shipment invites acceptance by either a prompt promise to ship or prompt shipment of the goods. When the importer shipped the pots without stating it was a mere accommodation, the shipment constituted an acceptance of the shop owner's exact offer. The terms of that offer (10% discount) governed the contract. (A) is incorrect because typing specific terms across a form overrides contradictory pre-printed text. (B) is incorrect because the shop owner made a counteroffer for different terms, which the importer accepted by shipping. (C) is incorrect because past open-account dealing does not dictate the terms of a new, explicit offer."
    }
];