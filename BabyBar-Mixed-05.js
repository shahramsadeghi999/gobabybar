const examData = [
    ...
    },
    {
        ...
        ans: 1,
        exp: "Rule: A valid novation completely discharges an original obligor when all three parties agree to substitute a new obligor. However, like any contract, an agreement of release requires consideration. In a standard novation, consideration is found in the contemporaneous mutual promises where the new obligor assumes the duty directly to the obligee in exchange for the release. Because the assignment and delegation between mother and daughter had already occurred the day before, the plaintiff's subsequent oral promise to release the mother was a gratuitous release unsupported by bargained-for consideration (Option B)[cite: 3]. Option A is incorrect because the parol evidence rule excludes prior or contemporaneous agreements, not subsequent oral modifications or releases[cite: 3]. Option C is incorrect because a release taking immediate effect is not an agreement incapable of performance within one year under the Statute of Frauds[cite: 3]. Option D is incorrect because an accord and satisfaction involves resolving an existing disputed claim or substituting a new performance obligation, which is not present here[cite: 3]."
    },
    {
        id: 5,
        topic: "Mixed",
    ...
    },
    {
        ...
        ans: 0,
        exp: "Rule: To establish defamation, the statement must be 'of and concerning' the plaintiff. Under the group defamation doctrine, if a defamatory statement is directed against a small group, each member of the group can establish that the defamatory statement was made of and concerning them if the group is so small that a reasonable listener/reader would understand that the statement refers to every member of the group. Because only four officers were present at the rally, the group was sufficiently small for readers who knew the officers to understand the defamatory statement as referring to each of them (Option A)[cite: 3]. Option B is incorrect because engaging in official duties does not determine group identification[cite: 3]. Option C is incorrect because printed statements in newspapers are libel, not slander[cite: 3]. Option D is incorrect because specific naming is not required where group size is sufficiently small[cite: 3]."
    },
    {
        id: 7,
        topic: "Mixed",
        ...
        ans: 3,
        exp: "Rule: Under UCC § 2-610, an anticipatory repudiation occurs when a party makes an unequivocal statement or manifestation of intent that they will not render a promised performance when due. The aggrieved party may immediately resort to any remedy for breach. Because the buyer expressly declared in advance that he would not order any boxes for the year 2021 despite a contractual minimum of 2,000 boxes, this constituted an anticipatory repudiation giving the seller an immediate cause of action for damages (Option D)[cite: 3]. Option A is incorrect because anticipatory repudiation creates an immediate cause of action; the non-breaching party is not required to wait until the end of the year[cite: 3]. Option B is incorrect because the contract specified an express floor of 2,000 boxes, allowing damages to be calculated with certainty[cite: 3]. Option C is incorrect because contract damages are compensatory and must be proven, not presumed[cite: 3]."
    },
    {
        id: 8,
        topic: "Mixed",
        ...
        ans: 0,
        exp: "Rule: Under the Pinkerton doctrine and principles of accomplice liability, a co-conspirator/accomplice is vicariously liable for all reasonably foreseeable crimes committed by a partner in furtherance of the unlawful conspiracy. Where co-conspirators plan an armed robbery with a firearm, an intentional lethal shooting of the resisting victim is a natural, probable, and foreseeable consequence of the armed robbery scheme, rendering the accomplice liable for the intentional killing (first-degree murder under the statute) (Option A)[cite: 3]. Option B is incorrect because mere presence without conspiratorial agreement or aiding and abetting does not establish liability[cite: 3]. Option C is incorrect because an armed robber cannot claim self-defense against a storeowner privileged to resist with force[cite: 3]. Option D is incorrect because vicarious liability attaches through the conspiracy and robbery assistance, obviating the need for separate aiding and abetting at the specific moment of the shooting[cite: 3]."
    },
    {
        id: 9,
        topic: "Mixed",
        ...
        ans: 3,
        exp: "Rule: In strict products liability, a commercial distributor is liable for injuries caused by a defective product only if the defect was both the cause-in-fact and proximate (legal) cause of the injury. An intervening act that is extraordinary, unforeseeable, or highly reckless breaks the causal chain and constitutes a superseding cause that relieves the upstream seller of liability. Leaving a known 'inherently dangerous' defective machine plugged in on a counter where others would foreseeable operate it without warning can be argued to be a superseding intervening cause (Option D)[cite: 3]. Option A is incorrect because foreseeable bystanders can recover under strict products liability[cite: 3]. Option B is incorrect because assumption of the risk is an affirmative defense asserted against the plaintiff, not a non-party buyer[cite: 3]. Option C is incorrect because proof that the product was defective when it left the factory supports, rather than defeats, strict products liability[cite: 3]."
    },
    {
        id: 10,
        topic: "Mixed",
        ...
        ans: 2,
        exp: "Rule: Under the prevention doctrine, if a party wrongfully interferes with or prevents the occurrence of an express condition precedent, the condition is excused and the interfering party cannot avoid liability by asserting the failure of that condition. Because the defendant deliberately requested the architect to withhold and delay the inspection and certificate until after the deadline, the defendant's bad-faith interference excused the condition requiring presentation of the certificate by July 30 (Option C)[cite: 3]. Option A is incorrect because the architect was not a party to the construction agreement and could not be personally bound by it[cite: 3]. Option B is incorrect because substantial performance applies to constructive/implied conditions, not express conditions[cite: 3]. Option D is incorrect because the express condition explicitly required the certificate itself by a date certain, not merely general satisfactory completion[cite: 3]."
    },
    {
        id: 11,
        topic: "Mixed",
        ...
        ans: 1,
        exp: "Rule: In criminal statutory interpretation, where a statute incorporates an express mens rea element—such as 'knowingly' or 'whom he knows to be under the age of 18'—the prosecution must prove that the defendant possessed that specific knowledge. A genuine lack of knowledge (or honest mistake of fact) negates the express statutory knowledge requirement, providing a complete defense (Option B)[cite: 3]. Option A is incorrect because the defendant's own minor age is not a defense to statutory rape unless the statute explicitly creates a peer exemption[cite: 3]. Option C is incorrect because voluntary intoxication does not provide an excuse for general intent or statutory rape crimes[cite: 3]. Option D is incorrect because consent is legally ineffective as a defense in statutory rape[cite: 3]."
    },
    {
        id: 12,
        topic: "Mixed",
        ...
        ans: 2,
        exp: "Rule: To recover in negligence, the plaintiff must prove both breach of duty and causation-in-fact ('but-for' causation). Even where negligence per se is established by statutory violation, the defendant is not liable unless the violation was a cause-in-fact of the harm. Because driving at the lawful statutory speed (under 25 mph) would have made the collapse even more likely to happen than speeding, the defendant's violation (excess speed) was not the 'but-for' cause of the bridge collapse (Option C)[cite: 3]. Option A is incorrect because negligence per se establishes breach of duty, not causation[cite: 3]. Option B is incorrect because a statutory breach creates no presumption regarding causation[cite: 3]. Option D is incorrect because traffic safety rules on public bridges are intended to protect other motorists[cite: 3]."
    },
    {
        id: 13,
        topic: "Mixed",
    ...
    },
    {
        ...
        ans: 1,
        exp: "Rule: Embezzlement is the fraudulent conversion of the personal property of another by one who is already in lawful possession of the property. The employee came into initial lawful possession of the lost wallet without trespassory intent (intending to return it). When she later formed the intent to keep it and exercised dominion by spending part of the money, she committed embezzlement (Option B)[cite: 3]. Larceny is not committed because larceny requires a trespassory taking at the time possession is acquired; since she took possession lawfully for safekeeping, no trespassory taking occurred[cite: 3]. Subsequent restoration of the money does not erase a completed embezzlement. Option A is incorrect because the initial taking was non-trespassory[cite: 3]. Option C is incorrect because converting lawful entrusted funds constitutes embezzlement[cite: 3]. Option D is incorrect because larceny and embezzlement are mutually exclusive based on whether possession was obtained lawfully or trespassorily[cite: 3]."
    },
    {
        id: 18,
        topic: "Mixed",
        ...
        ans: 2,
        exp: "Rule: A private nuisance is a substantial, unreasonable interference with the plaintiff's use and enjoyment of real property. Interference is intentional if the defendant creates or continues the condition with knowledge to a substantial certainty that it is interfering with the neighbor's quiet enjoyment. Operating a late-night walk-up window causing loud, disruptive crowds to congregate outside until 2 A.M. constitutes an actionable private nuisance (Option C)[cite: 3]. Option A is incorrect because trespass to land requires a physical, tangible invasion of the plaintiff's property boundaries, whereas noise and odors sound in nuisance[cite: 3]. Option B is incorrect because operating a restaurant does not meet the threshold of extreme and outrageous conduct[cite: 3]. Option D is incorrect because invasion of privacy requires an intrusion into private seclusion or personal affairs[cite: 3]."
    },
    {
        id: 19,
        topic: "Mixed",
    ...
    },
    {
        ...
        ans: 3,
        exp: "Rule: One who carries on an abnormally dangerous (ultra-hazardous) activity is strictly liable for harm resulting from the dangerous propensity of that activity, regardless of whether reasonable care was exercised. Storing and transporting bulk quantities of highly volatile and combustible gasoline through municipal thoroughfares is widely classified as an abnormally dangerous activity imposing strict liability for resulting explosions (Option D)[cite: 3]. Options A, B, and C are incorrect because parking length limits and no-parking zones are designed to manage curb space and traffic congestion, not to guard against explosive hazards, precluding statutory negligence per se[cite: 3]."
    },
    {
        id: 21,
        topic: "Mixed",
    ...
    },
    {
        ...
        ans: 2,
        exp: "Rule: While a principal is generally not vicariously liable for the torts of an independent contractor, an employer is directly liable for its own negligence in hiring, selecting, or retaining an incompetent or unfit contractor. If a minimal background investigation would have revealed extensive citations and complaints of substandard, dangerous work, the hotel owner breached its duty of reasonable care in hiring, rendering the hotel owner liable for injuries directly resulting from the incompetent contractor's error (Option C)[cite: 3]. Option A is incorrect because independent contractor status does not shield an employer from liability for its own negligent hiring[cite: 3]. Option B is incorrect because the absence of post-repair discovery does not negate the initial negligent hiring[cite: 3]. Option D is incorrect because ordinary electrical wiring is not an abnormally dangerous activity[cite: 3]."
    },
    {
        id: 23,
        topic: "Mixed",
    ...
    },
    {
        ...
        ans: 0,
        exp: "Rule: While slight delays in performance are typically considered non-material breaches in real estate contracts allowing a reasonable time to cure, an express 'time is of the essence' clause coupled with surrounding circumstances known to both parties demonstrating that punctual performance was essential makes timely performance a strict condition precedent. Failure to close on the agreed date constitutes a total material breach discharging the buyer from the duty to perform (Option A)[cite: 3]. Option B is incorrect because the phrase alone is evidence, but the substantive legal basis is the mutual understanding that punctual performance was essential under the circumstances[cite: 3]. Option C is incorrect because damages are irrelevant when an essential express condition fails[cite: 3]. Option D is incorrect because contract duties are strict and good-faith effort does not cure failure of an express condition[cite: 3]."
    },
    {
        id: 25,
        topic: "Mixed",
