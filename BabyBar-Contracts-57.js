...
const examData = [
    {
        ...
        ans: 0,
        exp: "(A) is the correct response. Where the performance of one party takes a period of time (restoring cars) and the other party's does not (paying money), the performance taking time must be completed before the payment is due, unless the contract indicates otherwise. Because the contract explicitly stated payment of $20,000 was due 'upon completion of all four cars,' the contract was not divisible, and the mechanic had to finish all four before any payment was owed. (B) is incorrect because there was no right to per-car payment to waive. (C) is incorrect because the parties expressly agreed to a single lump-sum payment at the end, defeating divisibility. (D) is incorrect because finishing three of four cars (75%) is generally insufficient for substantial performance, and regardless, the mechanic willfully abandoned the job."
    },
    {
        id: 2,
        ...
        ans: 3,
        exp: "(D) is the correct response. An offer that requires acceptance by performance is an offer for a unilateral contract. Under Restatement § 45, an offer for a unilateral contract becomes irrevocable once the offeree begins the requested performance, creating an option contract that gives the offeree time to finish. Because the customer had already started the test drive, the dealership lost the power to revoke the offer. The 'may be withdrawn' clause applies only to customers who had not yet started. (A) is incorrect because the offer became irrevocable upon commencement. (B) is incorrect because unilateral contracts do not require notice of acceptance, only performance. (C) is incorrect because the dealership bargained for the test drive, providing consideration."
    },
    {
        id: 3,
        ...
        ans: 1,
        exp: "(B) is the correct response. The student will be successful. The uncle offered a unilateral/bilateral contract: allowance and rent in exchange for delaying marriage. The student's detriment (delaying marriage) provided valid consideration. Delaying marriage is not illegal (unlike contracts demanding absolute restraint of marriage or divorce). The uncle's death did not terminate the contract because it was already accepted and formed. Finally, while the promise to pay the *rent* to the landlord was a suretyship requiring a writing, the promise to pay the $300 *allowance* to the student was NOT a promise to pay the debt of another. Therefore, the allowance promise did not fall within the Statute of Frauds and was enforceable orally. (A) is incorrect because the contract was already formed. (C) is incorrect because delaying a marriage is not against public policy. (D) is incorrect because the allowance promise is outside the Statute of Frauds."
    },
    {
        id: 4,
        ...
        ans: 1,
        exp: "(B) is the correct response. Surrender of a claim that proves to be invalid constitutes valid consideration if the surrendering party believed in good faith that the claim might be valid (Restatement § 74). The sister knew her claim was 'doubtful,' but did not know it was definitively invalid. Therefore, her surrender of the claim via the quitclaim deed constituted valid consideration for the chef's promise to pay. (A) is incorrect because surrendering a doubtful claim is a legal detriment. (C) is incorrect because estoppel is unnecessary where actual consideration exists. (D) is incorrect because knowing a claim is merely 'doubtful' does not equate to bad faith assertion of a known invalid claim."
    },
    {
        id: 5,
        ...
        ans: 2,
        exp: "(C) is the correct response. Under the doctrine of promissory estoppel (Restatement § 90), a promise without consideration is binding if the promisor should reasonably expect it to induce action or forbearance, it does induce such action, and injustice can only be avoided by enforcement. The company did not bargain for his retirement (the resolution said 'when and if'), so there was no traditional consideration. However, the executive foreseeably relied on the promise by retiring, buying a yacht, and becoming unemployable. This detrimental reliance makes the promise enforceable. (A) is incorrect because promissory estoppel cures the lack of consideration. (B) is incorrect because the retirement was a condition of a gift, not bargained for as the price of the promise. (D) is incorrect because at-will status does not defeat subsequent promissory estoppel."
    },
    {
        id: 6,
        ...
        ans: 3,
        exp: "(D) is the correct response. Consideration requires a bargained-for exchange involving a legal detriment. A legal detriment is performing any act one is not legally obligated to perform. Because the weightlifter had no legal obligation to bench press the weight on that specific Saturday, doing so at the owner's request constituted a legal detriment. Her personal motives—and the fact that she would have done it anyway—are legally irrelevant. (A) is incorrect because the owner bargained for the act on that specific day and got it. (B) is incorrect because the difficulty of the act is irrelevant to consideration. (C) is incorrect because 'detriment' in contract law means a legal detriment, not physical or economic harm; doing something healthy still qualifies."
    },
    {
        id: 7,
        ...
        ans: 2,
        exp: "(C) is the correct response. The bank is an intended creditor beneficiary of the contract. However, a third-party beneficiary stands in the shoes of the promisee (the plumber) and is subject to any defenses or offsets the promisor (the homeowner) has against the promisee. Because the homeowner could offset the $1,000 in damages against the plumber's $10,000 fee, the homeowner can assert the exact same offset against the bank, reducing the obligation to $9,000. (A) is incorrect because the bank was specifically named to receive payment to satisfy a debt, making it an intended beneficiary. (B) is incorrect because minor deficiencies constitute substantial performance, not a material breach that discharges the entire contract. (D) is incorrect because the homeowner can assert the offset directly against the bank."
    },
    {
        id: 8,
        ...
        ans: 0,
        exp: "(A) is the correct response. The aunt made an offer for a unilateral contract, which the nephew accepted by moving in and caring for the cabin until her death. Courts generally do not inquire into the adequacy of consideration. The fact that the aunt died after only three weeks does not invalidate the consideration, as the nephew assumed the risk she might live for decades, and she assumed the risk she might die immediately. The contract is fully enforceable, and he is entitled to the cabin. (B) is incorrect because courts do not require equivalence in value. (C) is incorrect because a contractual promise to leave property in a will is enforceable. (D) is incorrect because death is a foreseeable event, not an excuse for impossibility here."
    },
    {
        id: 9,
        ...
        ans: 3,
        exp: "(D) is the correct response. A contract entered into by a minor is voidable. However, a promise to perform all or part of an antecedent contractual obligation that was voidable due to infancy is binding WITHOUT new consideration if made after reaching the age of majority. Because the buyer partially reaffirmed the debt by explicitly promising to pay $150 after turning 18, that new promise is enforceable. (A) is incorrect because reaffirming a voidable duty does not require fresh consideration. (B) is incorrect because he only reaffirmed $150 of the debt, not the full $200. (C) is incorrect because post-majority ratification cures the original incapacity."
    },
    {
        id: 10,
        ...
        ans: 3,
        exp: "(D) is the correct response. Because the option was expressly conditioned on actual payment of the $100, no option contract was formed until day 21. Before that, the landowner's proposal was merely a revocable offer. An offer is revoked if the offeror sells the property to someone else AND the offeree receives reliable information of that sale (indirect revocation). Because the developer was UNAWARE of the sale when he accepted the offer and paid the $100 on day 21, the offer had not been effectively revoked, and his acceptance formed a binding contract. (A) is incorrect because preparing for performance (getting a loan) does not make an offer irrevocable. (B) is incorrect because the UCC firm offer rule does not apply to real estate. (C) is incorrect because the express condition requiring actual payment overrides the oral statement."
    },
    {
        id: 11,
        ...
        ans: 1,
        exp: "(B) is the correct response. Under the common law pre-existing duty rule, a modification requires fresh consideration to be valid. The contractor provided no new consideration for the owner's promise to release him from the duty to build the deck (in fact, he promised to do less than he was originally bound to do). Therefore, the modification releasing him from the deck duty was unenforceable for lack of consideration. The original contract remained in force, and the contractor breached. (A) is incorrect because the Parol Evidence Rule applies to prior agreements, not subsequent modifications. (C) is incorrect because the 'good faith' exception applies to UCC sales of goods, not common law service contracts. (D) is incorrect because even if oral, it fails for lack of consideration."
    },
    {
        id: 12,
        ...
        ans: 3,
        exp: "(D) is the correct response. The aunt's first letter ('I would consider') was a solicitation of offers. The nephew's reply ('I will buy it') was an offer. The aunt's May 6 letter ('It's a deal') was an acceptance. Under the mailbox rule, an acceptance is effective upon proper dispatch. Therefore, a binding contract was formed on May 6 when the aunt mailed the letter. The nephew's attempt to revoke his offer on May 7 was too late. (A) is incorrect because the nephew made an offer, not an acceptance. (B) is incorrect because receiving an offer does not form a contract. (C) is incorrect because a contract was formed."
    },
    {
        id: 13,
        ...
        ans: 3,
        exp: "(D) is the correct response. When parties attach different meanings to a term, and one party knows (or has reason to know) the meaning attached by the other, while the other does not know the first party's meaning, a contract is formed on the terms understood by the innocent (unaware) party (Restatement § 201). The owner didn't know the trade usage, but the company knew the owner expected Sunday cleaning. Therefore, the owner's meaning controls, and 'daily' includes Sunday. (A) is incorrect because actual knowledge of the other party's innocent misunderstanding overrides trade usage. (B) is incorrect because a contract IS formed on the innocent party's terms. (C) is incorrect because parol evidence is admissible to explain ambiguous terms."
    },
    {
        id: 14,
        ...
        ans: 3,
        exp: "(D) is the correct response. An anticipatory repudiation can be retracted until the aggrieved party: (1) cancels, (2) materially changes position in reliance, or (3) states the repudiation is final. The buyer materially changed position by buying substitute land on June 5. This terminated the seller's power to retract. The June 10 retraction was ineffective. The buyer's duty to tender payment on July 1 was excused by the unretracted repudiation. (A) is incorrect because the repudiation excused the condition of tender. (B) is incorrect because the right to retract ended on June 5. (C) is incorrect because a repudiation is retractable until reliance or cancellation occurs."
    },
    {
        id: 15,
        ...
        ans: 2,
        exp: "(C) is the correct response. The painter is entitled to expectation damages: the contract price of $10,000. Consequential damages are only recoverable if they were reasonably foreseeable to the breaching party at the time of contracting (Hadley v. Baxendale). A physical ulcer is not a foreseeable result of a breached commercial contract. The lost $2,000 discount on the truck is also unforeseeable because the owner did not know the painter needed the funds specifically on June 1 to secure a discount. Therefore, neither consequential damage is recoverable. (A) and (D) are incorrect because the damages were unforeseeable. (B) is incorrect because a fully performing plaintiff seeking a liquidated debt is limited to the contract price, not restitution."
    },
    {
        id: 16,
        ...
        ans: 2,
        exp: "(C) is the correct response. A contract is voidable if a party's assent is induced by a fraudulent misrepresentation. While mere non-disclosure is often not fraud, active concealment (repairing/hiding damage) is legally equivalent to an affirmative misrepresentation that the defect does not exist (Restatement § 160). The dealer's active concealment was fraud, entitling the buyer to rescind. (A) is incorrect because active concealment equates to a misstatement. (B) is incorrect because a victim of fraud does not lose the right to avoid the contract merely by failing to conduct an independent investigation. (D) is incorrect because unconscionability is a high bar relating to contract terms; fraud is the direct and correct defense here."
    },
    {
        id: 17,
        ...
        ans: 2,
        exp: "(C) is the correct response. Under the one-year provision of the Statute of Frauds, a contract is unenforceable if it cannot be performed within one year from the *time the contract is made*. Because this was an offer for a unilateral contract (accepted by showing up), the contract was 'made' on January 2. A one-year term starting January 2 concludes exactly one year later, meaning it *can* be performed within a year from the day it was made. Thus, it is outside the Statute of Frauds. (A) is incorrect because the clock starts at formation, not when the offer is communicated. (B) is incorrect because partial performance of a service contract does not cure a Statute of Frauds defect. (D) is incorrect because the dollar amount is irrelevant for service contracts."
    },
    {
        id: 18,
        ...
        ans: 1,
        exp: "(B) is the correct response. When an express condition in a contract is intended solely for the benefit of one party, that party may waive the condition and enforce the contract. The financing contingency was clearly designed solely to protect the buyer from being forced to buy without an 8% loan. By tendering the purchase price, the buyer waived the protection of that condition. The seller cannot use the failure of the buyer's protective condition to escape the contract. (A) is incorrect because waiver is another valid way to excuse a condition. (C) is incorrect because this is a waiver of a condition, not a modification of the seller's duties. (D) is incorrect because reliance is not the operative doctrine here; waiver is."
    },
    {
        id: 19,
        ...
        ans: 0,
        exp: "(A) is the correct response. The written notice by Jan 2 was an express condition precedent to the contract's effectiveness. However, a party may waive an express condition that is for their benefit. When the seller said 'That's okay' to the oral notice, the seller explicitly waived the requirement that the notice be in writing. Because the buyer relied on this waiver, it became binding. (B) is incorrect because strict compliance, not substantial performance, is required for express conditions, unless waived. (C) is incorrect because novation involves substituting a new party. (D) is incorrect because the notice was a condition precedent to effectiveness, not a condition subsequent."
    },
    {
        id: 20,
        ...
        ans: 3,
        exp: "(D) is the correct response. Under UCC § 2-206, an offer invites acceptance in any reasonable manner *unless otherwise unambiguously indicated*. The master agreement unambiguously stated that orders (offers) were binding *only* upon express acceptance. Because the distributor did not expressly accept the new order, no contract for that specific order was formed. (A) is incorrect because the refusal is justified by the lack of acceptance, not the pricing dispute. (B) is incorrect because there was no obligation to fill the order. (C) is incorrect because under UCC § 1-303, express terms trump course of dealing; the express term requiring 'express acceptance' overrides the prior history of filling orders."
    },
    {
        id: 21,
        ...
        ans: 2,
        exp: "(C) is the correct response. Under the Parol Evidence Rule (UCC § 2-202), a written agreement intended as a final expression of the parties' agreement regarding specific terms cannot be contradicted by evidence of any prior agreement. Even if a writing is only a *partial* integration (lacking a merger clause), it still cannot be *contradicted* by prior oral agreements (though it could be supplemented by consistent additional terms). The $100,000 oral price directly contradicts the $110,000 written price. Therefore, the evidence is barred. (A) is incorrect because there is no evidence of a clerical scrivener's error justifying reformation. (B) is incorrect because the issue is the Parol Evidence Rule, not assumption of risk. (D) is incorrect because even without a merger clause, contradictory terms are barred."
    },
    {
        id: 22,
        ...
        ans: 3,
        exp: "(D) is the correct response. Under UCC § 2-715, a buyer can recover consequential damages (e.g., lost profits) and incidental damages (expenses reasonably incurred in effecting cover, such as broker fees and transportation). However, under the American Rule, attorney's fees are not recoverable as damages for breach of contract unless specified in the contract or by a specific statute. Therefore, the mill recovers $200,000 (lost profits) + $5,000 (broker) + $25,000 (transport) = $230,000. The $2,000 attorney fee is excluded. (A) excludes the transport. (B) excludes the broker and transport. (C) improperly includes the attorney's fees."
    },
    {
        id: 23,
        ...
        ans: 1,
        exp: "(B) is the correct response. Under UCC § 2-207(1), a definite and seasonable expression of acceptance operates as an acceptance even if it states additional terms. Thus, a contract was formed when the acknowledgment was mailed. Under § 2-207(2), between merchants, additional terms become part of the contract UNLESS they materially alter it. Therefore, the court must perform a factual analysis to decide if an arbitration clause materially alters this specific contract (many courts hold that it does). (A) is incorrect because a contract was formed by the writings under § 2-207(1), not merely by conduct under § 2-207(3). (C) is incorrect because the UCC abolished the mirror image rule; the acknowledgment was an acceptance. (D) is incorrect because material alterations do not automatically enter the contract."
    },
    {
        id: 24,
        ...
        ans: 1,
        exp: "(B) is the correct response. A person incurs only voidable contractual duties if, by reason of mental illness or defect (including severe medication/intoxication), they are unable to act in a reasonable manner in relation to the transaction and the other party has reason to know of their condition (Restatement § 15). The woman was severely impaired, offered the boat at an 85% discount, and the neighbor explicitly recognized she was 'out of it.' Therefore, the contract is voidable by the woman. (A) is incorrect because although offer and acceptance occurred, the resulting contract was voidable. (C) is incorrect because the sale of goods under $500 ($450) does not require a writing under the Statute of Frauds. (D) is incorrect because reliance does not cure a lack of contractual capacity."
    },
    {
        id: 25,
        ...
        ans: 3,
        exp: "(D) is the correct response. Under UCC § 2-612(2), a buyer may reject a non-conforming installment if the non-conformity substantially impairs the value of *that installment* and cannot be cured. Because the bakery baked on Tuesdays, a delivery on Wednesday could not cure the 7,000-pound shortfall for that week's baking. Therefore, the 70% shortfall substantially impaired the value of the Week 2 installment and was incurable, justifying rejection. (A) is incorrect because rejection of a *single installment* only requires substantial impairment of that installment, not the whole contract. (B) is incorrect because the perfect tender rule (UCC § 2-601) does not apply to installment contracts. (C) is incorrect because accepting a conforming Week 1 delivery does not waive the right to reject a non-conforming Week 2 delivery."
    }
];