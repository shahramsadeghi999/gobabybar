...
const examData = [
    {
        ...
        opts: [
            "Yes, because a reasonable person would have found the sculptor's work to be satisfactory.",
            "Yes, because the mayor was fearful that the statue would embarrass the town.",
            "No, because the contract gave the mayor the absolute right to reject the sculptor's finished work.",
            "No, because the mayor actually believed that the statue was too small."
        ],
        ans: 3,
        exp: "(D) is the correct response. In a contract conditioning payment on personal satisfaction involving aesthetics or art, the condition is evaluated under a subjective standard. The promisor is excused from paying if they are genuinely, subjectively dissatisfied with the work, provided the dissatisfaction is in good faith (not a fraudulent pretense to escape the contract). Because the facts stipulate that the Mayor 'truly believed the statue was too small,' his subjective dissatisfaction was genuine and in good faith, fulfilling the failure of the condition precedent. The fact that he was also worried about the scandal does not invalidate his genuine aesthetic objection. (A) is incorrect because artistic contracts use a subjective standard, not the objective reasonable-person standard. (B) is incorrect because his genuine aesthetic belief satisfies the good-faith requirement, despite parallel motives. (C) is incorrect because the right to reject is not 'absolute'; it is constrained by the implied covenant of good faith."
    },
    {
        id: 2,
        ...
        ans: 0,
        exp: "(A) is the correct response. While past services are not valid consideration, a promise may be enforceable under the equitable doctrine of promissory estoppel (Restatement § 90). Promissory estoppel requires a promise that the promisor should reasonably expect to induce action or forbearance, and which does induce justifiable detrimental reliance by the promisee. The plaintiff relied on the pension promise to her detriment by giving up her salary, retiring, and selling her home. Therefore, the promise is enforceable to prevent injustice. (B) is incorrect because the 40 years of service are 'past consideration,' which is legally insufficient to enforce a contract. (C) is incorrect because delaying retirement does not defeat her eventual detrimental reliance on the promise. (D) is incorrect because, although there was no traditional consideration, promissory estoppel provides an alternative basis for enforcement."
    },
    {
        id: 3,
        ...
        opts: [
            ...
            "It was waived because the plaintiff paid before inspecting the goods."
        ],
        ans: 2,
        exp: "(C) is the correct response. Under UCC § 2-512(2), where a contract requires payment before inspection, such payment does NOT constitute acceptance of goods and does not impair the buyer's right to inspect or any of the buyer's remedies. The buyer retains the full right to open the boxes afterward, discover the nonconformity, and reject the goods or sue for breach. The store owner may therefore force the distributor to take the small nuts back and refund the money. (A) is incorrect because requiring payment prior to inspection (e.g., C.O.D. deliveries) is a standard, enforceable commercial practice and is not unconscionable. (B) and (D) are incorrect because the UCC expressly prevents pre-inspection payment from operating as a waiver or final acceptance."
    },
    {
        id: 4,
        ...
        ans: 1,
        exp: "(B) is the correct response. An option contract is a promise to keep an offer open that is supported by independent consideration. Under the common law, if an offeree gives consideration (even a small amount like $10) to hold an offer open, a binding option contract is created, and the offeror cannot revoke the offer for the agreed-upon period. Because the musician paid $10, the store owner was bound to hold the guitar for six months. Selling it to someone else breached this option contract. (A) and (C) are incorrect because a UCC 'firm offer' is a signed promise by a merchant to hold an offer open *without* consideration, and it is capped at three months. Here, actual consideration was paid, creating a true option contract, which has no time limit. (D) is incorrect because an option contract is irrevocable; the store owner lacked the power to revoke."
    },
    {
        id: 5,
        ...
        ans: 2,
        exp: "(C) is the correct response. A requirements contract is one where the buyer promises to buy all of its requirements from the seller. Under UCC § 2-306, such agreements do not lack mutuality of obligation because the buyer is bound by an implied statutory duty to determine its requirements in good faith and according to commercial standards of fair dealing. This good-faith limitation on the buyer's discretion provides the necessary consideration to make the contract binding. (A) and (D) focus on commercial impracticability, but the core issue the supplier raised is mutuality. Furthermore, a dramatic price increase tied to an agreed-upon market index is a foreseeable business risk assumed in the contract; it does not trigger commercial impracticability. (B) is incorrect because the good faith obligation binds the buyer."
    },
    {
        id: 6,
        ...
        opts: [
            "The singer was an infant at the time of all the transactions.",
            "The singer made at least one effective assignment of the right to collect the $2,000.",
            "The singer's performance was so bad that the record can never be commercially released.",
            "A statute prohibited the assignment of future wages by employees."
        ],
        ans: 1,
        exp: "(B) is the correct response. An effective assignment transfers the assignor's contract rights entirely to the assignee, extinguishing the assignor's right to enforce the contract. If the singer made a valid assignment of his $2,000 claim to the piano seller (or the landlord), he no longer possesses the legal right to collect the money from the defendant. Therefore, the defendant's best defense against a lawsuit by the *singer* is that the singer gave up his rights via the assignment. (A) is incorrect because infancy makes a contract voidable by the minor, not the defendant, and would require the defendant to pay the minor upon disaffirmance. (C) is incorrect assuming the contract paid for the recording session regardless of release. (D) is incorrect because the singer is likely an independent contractor, and if the assignment is invalid, the defendant would just owe the singer directly."
    },
    {
        id: 7,
        ...
        opts: [
            ...
            "The agreement was an offer for a unilateral contract that the defendant rejected.",
            "The defendant's subjective satisfaction was a condition precedent to his obligation to accept the door.",
            "Since the coat of arms was not yet associated with the defendant, the plaintiff could find another buyer."
        ],
        ans: 2,
        exp: "(C) is the correct response. When a contract involves personal taste, aesthetics, or fancy (like a custom-carved coat of arms), an express condition of personal satisfaction is evaluated under a subjective standard. The promisor is excused from paying if he is genuinely, subjectively dissatisfied with the work, provided he acts in good faith. Because the defendant was subjectively telling the truth, his dissatisfaction means the condition precedent to his duty to pay was not met. (A) is incorrect because the Statute of Frauds does not apply to custom-manufactured goods that cannot be resold, and the price is near the threshold anyway. (B) is incorrect because the agreement was a bilateral exchange of promises, not a unilateral contract. (D) is incorrect because a custom family crest cannot easily be resold, and mitigation is a defense to the *amount* of damages, not liability."
    },
    {
        id: 8,
        ...
        ans: 1,
        exp: "(B) is the correct response. Consideration requires a bargained-for exchange. An exchange is bargained for if the promisor's promise induces the promisee's detriment, and the promisee's detriment induces the promisor's promise. Even if the parties did not expressly negotiate, the landfill offered the plastic specifically to induce the firm to haul it away, thereby saving the landfill disposal costs. The firm incurred the detriment of driving its trucks and hauling the material in exchange for the plastic. This mutual inducement satisfies the requirement of consideration, creating a binding contract rather than a conditional gift. (A) is incorrect because finding actual consideration makes the fallback doctrine of promissory estoppel unnecessary. (C) and (D) are incorrect because the mutual inducement of benefit and detriment legally constitutes bargaining, creating consideration."
    },
    {
        id: 9,
        ...
        ans: 0,
        exp: "(A) is the correct response. Under the pre-existing duty rule, performing an act that one is already legally obligated to perform cannot serve as consideration for a new promise. An on-duty police officer has a statutory and occupational obligation to investigate crimes, apprehend fugitives, and rescue kidnapping victims. Because the officer was merely doing his legal duty, his actions provided no valid consideration to support the reward offer. The agreement is unenforceable. (B) is incorrect because unilateral contracts are accepted by performance, not advance notice. (C) and (D) are incorrect because the preexisting duty rule invalidates the consideration required to accept the unilateral offer, regardless of his knowledge or performance."
    },
    {
        id: 10,
        ...
        opts: [
            ...
            "Yes, for the purpose of establishing that the phrase '(two coats)' is ambiguous and explaining the ambiguity.",
        ...
        ans: 1,
        exp: "(B) is the correct response. The Parol Evidence Rule prohibits extrinsic evidence of prior agreements to contradict the terms of an unambiguous, completely integrated written contract. However, extrinsic evidence is universally admissible to establish that a written term is ambiguous, and if it is ambiguous, to explain its meaning. The placement of '(two coats)' at the end of the list creates a syntactic ambiguity: it could apply only to the siding, or it could apply collectively to the trim, doors, and siding. The homeowner's testimony is admissible to explain this ambiguity. (A) is incorrect because the testimony is admissible not only to establish ambiguity but also to explain it. (C) is incorrect because the identity of the drafter does not trigger the Parol Evidence Rule. (D) is incorrect because even in a completely integrated contract, parol evidence is admissible to resolve ambiguities."
    },
    {
        id: 11,
    ...
    },
    {
        ...
        ans: 3,
        exp: "(D) is the correct response. Under the common law, a promise to keep an offer open is revocable at will unless it is supported by consideration, creating an option contract. The UCC 'firm offer' rule (UCC § 2-205), which makes signed merchant offers irrevocable without consideration, applies ONLY to the sale of goods. Renting real estate (a summer camp) is governed by the common law. Because the family provided no consideration to hold the offer open, the owner's promise was unenforceable, and he was legally free to revoke it by selling to the university. (A) and (B) are incorrect because past reliance (the previous 20 years) does not constitute consideration for a new promise, and the family did not demonstrate new detrimental reliance on the recent letter. (C) is incorrect because the failure is due to lack of consideration for the option, making the revocation lawful."
    },
    {
        id: 13,
        ...
        ans: 0,
        exp: "(A) is the correct response. A promise must be supported by consideration (a bargained-for exchange) to be enforceable. A promise made in recognition of a benefit previously received by the promisor is generally not binding because it is based on 'past consideration,' which is legally no consideration. The employee had already devised and implemented the efficiency method before the boss promised the bonus. Because the employee did not perform the work in exchange for the promise, the promise is an unenforceable gratuitous gift. (B) is incorrect because a $5,000 bonus payable on June 1 can be performed within a year, so the Statute of Frauds does not apply. (C) is incorrect because the material benefit rule usually applies to life-or-death emergencies, not ordinary employment performance. (D) is incorrect because notice does not cure a lack of consideration."
    },
    {
        id: 14,
        ...
        ans: 0,
        exp: "(A) is the correct response. A third party can enforce a contract only if they are an intended beneficiary. An intended beneficiary exists if the promisee intended to give the beneficiary the benefit of the promised performance. Here, the landowner's primary intent in making the contract with the contractor was to benefit the *daughter* (by giving her a house), not to benefit the contractor's son (who was marrying the daughter). Because the contractor's son was not the primary intended beneficiary of the landowner's promise, he is classified as an incidental beneficiary and possesses no standing to sue the landowner for breach. (B) is incorrect because reliance and assent are relevant only for vesting the rights of *intended* beneficiaries. (C) is incorrect because the painting agreement was a separate subsequent subcontract, not a condition precedent to the landowner's original promise. (D) is incorrect because assignments of commercial painting duties do not generally breach fiduciary obligations."
    },
    {
        id: 15,
        ...
        ans: 1,
        exp: "(B) is the correct response. Parol evidence is admissible to show that a written agreement was subject to an oral condition precedent to its legal effectiveness. If the parties orally agree that a written contract will not become binding unless a specific event occurs, the non-occurrence of that event means the contract never comes into existence. The businessman can argue that winning the election was an agreed-upon condition precedent; because he lost, the contract never became effective, and he is not obligated to pay. (A) is incorrect because frustration of purpose requires an unforeseeable supervening event that completely destroys the value of the contract. Losing an election is highly foreseeable, and the golf course can still be used. (C) is incorrect because there is no ambiguous term in the written contract to explain. (D) is incorrect because an erroneous prediction about a future event (an election) is not a mutual mistake of present fact."
    },
    {
        id: 16,
        ...
        ans: 2,
        exp: "(C) is the correct response. Under UCC § 2-713, a buyer's damages for a seller's non-delivery are measured by the difference between the market price at the time the buyer learned of the breach and the contract price, plus incidental and consequential damages. Because the market price on the date of delivery ($2) was identical to the contract price ($2), the buyer suffered zero direct expectation damages. While the restaurant could theoretically recover nominal damages or incidental damages (e.g., the cost of finding a new supplier), it sustained no substantial compensatory damage. (A) is incorrect because crop destruction does not excuse a seller of generic commodities (unless the contract specifies they must be grown on a specific plot of land). (B) is incorrect because the restaurant expressly reserved its rights ('holding you to the contract'), preventing a modification or waiver. (D) is incorrect because a seller cannot prioritize other contracts to excuse a breach."
    },
    {
        id: 17,
        ...
        opts: [
            "The homeowner has made an offer for a unilateral contract that became irrevocable when the owner of the bar promised to catch the thief.",
            ...
            "The homeowner has made an offer for a unilateral contract that the owner of the bar can accept only by catching the thief."
        ],
        ans: 3,
        exp: "(D) is the correct response. An offer of a reward to the public ('I'll pay $1,000 to anyone who finds the thief') is an offer for a unilateral contract. A unilateral contract requests acceptance by full performance of the specified act, not by a return promise. Because the homeowner requested the act of catching the thief, the bartender's verbal promise ('I'll catch that thief') was legally ineffective as an acceptance. The bartender can accept the offer only by actually catching the thief. (A) is incorrect because promising to perform does not make a unilateral offer irrevocable; only the commencement of actual performance does. (B) is incorrect because the offer did not invite a promissory acceptance, so no bilateral contract was formed. (C) is incorrect because, despite the anger, the statement contained specific, definite terms promising a specific reward for a specific act, which a reasonable person would interpret as a valid offer."
    },
    {
        id: 18,
    ...
    },
    {
        ...
        opts: [
            ...
            "The mother's promise was not in writing.",
            "The plaintiff's remaining in law school until July 1 was an implied condition precedent to his mother's duty to pay."
        ],
        ans: 3,
        exp: "(D) is the correct response. A condition precedent is an event that must occur before a party's duty to perform becomes absolute. Conditions can be express or implied. Because the mother promised to pay the money on a specific date (July 1) in exchange for the plaintiff going to law school and staying sober, a court would reasonably imply that the plaintiff remaining enrolled in law school up to the payment date of July 1 was a condition precedent to her duty to pay. Because he dropped out in December, the condition failed, excusing her payment. (A) is incorrect because requiring full 'completion' of a 3-year law school program by July 1 is factually impossible and illogical; remaining enrolled is the sensible implied condition. (B) is incorrect because forbearance from a legal right (drinking) is valid consideration. (C) is incorrect because a lifetime promise can be performed within a year if the promisor dies, escaping the Statute of Frauds."
    },
    {
        id: 20,
        ...
        opts: [
            ...
            "The assignment did not impose an additional burden on the plaintiff since there was no change in price."
        ],
        ans: 2,
        exp: "(C) is the correct response. Duties that involve personal services (depending on the obligor's special skills or reputation) are generally non-delegable because the obligee bargained for that specific person's abilities. However, the fact that the original owner *never personally participated* in the spraying for the first two years indicates that the farmer did not actually bargain for the owner's personal, unique flying skills. Therefore, the duty is a routine commercial service, which is freely delegable. (A) is a true statement under the UCC, but does not address the core issue of whether the duty was a non-delegable personal service. (B) is incorrect because if a duty genuinely requires personal services, it cannot be delegated even to someone more highly skilled without consent. (D) is incorrect because financial burden relates to the assignment of *rights*, whereas the objection here is to the delegation of *duties*."
    },
    {
        id: 21,
        ...
        opts: [
            "The shareholder's promise to pay the corporation's debt was induced by the fear that the corporation could not continue to exist without the loan.",
            "The shareholder's promise to pay the corporation's debt was not in writing.",
            "The shareholder received nothing of value in return for her promise to pay the corporation's debt.",
            "The assets that the corporation offered to turn over to the bank later were sufficient to repay the loan."
        ],
        ans: 1,
        exp: "(B) is the correct response. Under the Statute of Frauds, a promise to answer for the debt or default of another (a suretyship or guarantee) must be in writing and signed by the party to be charged. If the shareholder's promise was not in writing, it is completely unenforceable. (A) is incorrect because economic duress requires that the assent be induced by an *improper threat*. A creditor's hard bargaining or refusal to lend money without adequate security is standard commercial practice, not an improper threat, so the shareholder's fear does not void the contract. (C) is incorrect because the loan to the corporation serves as valid consideration for the guarantor's promise; the shareholder doesn't need to receive separate direct value. (D) is incorrect because a guarantor is liable immediately upon default, regardless of the corporation's subsequent offers of assets."
    },
    {
        id: 22,
        ...
        ans: 3,
        exp: "(D) is the correct response. When a party assigns a contract or delegates duties, the assignor/delegator remains secondarily liable for the performance of the contract (as a surety) unless the obligee expressly releases them through a novation. A novation is the substitution by mutual consent of a new party, completely discharging the original party. While simply accepting rent does not usually constitute a novation, arguing that the landlord's conduct *did* amount to a novation is the ONLY argument listed that would completely relieve the tenant of liability. (A) is incorrect because an accord and satisfaction settles a disputed debt, which did not occur here. (B) is incorrect because even if the landlord consented to the assignment, the original tenant remains secondarily liable. (C) is incorrect because restraints on alienation are enforceable in leases, and regardless, an invalid assignment would leave the tenant primarily liable."
    },
    {
        id: 23,
        ...
        ans: 3,
        exp: "(D) is the correct response. Under general contract principles, an offer terminates when the offeree receives reliable information that the offeror has taken definite action inconsistent with an intention to enter into the proposed contract (such as selling the property to someone else). When the buyer read in the newspaper that the seller had sold the painting, the offer was effectively revoked by indirect notice. Because the offer was revoked before the buyer attempted to accept with the cash, no contract was formed. (Note: If this were a firm offer under the UCC, it would be irrevocable, but the facts do not indicate the seller is a merchant, so it is a common law offer lacking consideration). (A) is incorrect because she did not accept before it was withdrawn via the newspaper. (B) is incorrect because the promise to hold the offer open lacked consideration. (C) is incorrect because damages are always available for breach; specific performance is an *additional* remedy for unique chattels."
    },
    {
        id: 24,
        ...
        opts: [
            "No, because it modifies the terms of a written contract that the parties intended to be a complete record.",
            "No, because the price agreed to is higher than the market price of scmods.",
        ...
        ans: 2,
        exp: "(C) is the correct response. Under UCC § 2-202, even a completely integrated written contract may be explained or supplemented by course of dealing, course of performance, or usage of trade. Trade usage is admissible to show that a seemingly clear term has a specialized commercial meaning that the parties are presumed to have intended. Showing that the industry refers to 'scmods' as 'rock lurgid' explains the contract's terminology without contradicting the writing. (A) is incorrect because trade usage is admissible even for complete integrations. (B) is incorrect because the price term does not bar evidence explaining the subject matter. (D) is incorrect because trade usage is admissible objectively to explain the contract's meaning; it does not strictly depend on proving the buyer's subjective awareness to be admitted."
    },
    {
        id: 25,
        ...
        opts: [
            "The daughter did not rely to her detriment on her father's promise to give her a house built according to any particular plans.",
            "The daughter was a donee beneficiary because the house was being built as a wedding present.",
            "The daughter was a creditor beneficiary because the contract was made after her father promised her the house.",
            "The daughter was not an intended third-party beneficiary of the contract."
        ],
        ans: 0,
        exp: "(A) is the correct response. An intended third-party donee beneficiary can enforce a contract if her rights have vested. Rights vest when the beneficiary: (1) manifests assent to the contract; (2) brings a lawsuit to enforce it; or (3) materially changes her position in justifiable reliance on the contract (Restatement § 311). Once the rights vest, the original parties lose the power to modify or rescind the agreement without the beneficiary's consent. The builder's best defense is to attack the vesting by arguing that canceling her other house contract was reliance on getting *a* house, not detrimental reliance on the *specific architectural plans* that were later modified. (B) is incorrect because being a donee beneficiary does not prevent her from enforcing the contract once vested. (C) is incorrect because she is receiving a gift, not satisfying a debt, making her a donee beneficiary. (D) is incorrect because the contract explicitly stated it was for her, clearly making her an intended beneficiary."
    }
];