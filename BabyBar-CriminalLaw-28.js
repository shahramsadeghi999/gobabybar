const examData = [
    ...
    // SOURCE: FINZ-CriminalLaw.pdf, Question 110
    {
        ...
        ans: 0,
        exp: "The felony-murder rule provides that the intent to commit a felony is malice aforethought, and that a death that results from the perpetration of a felony is therefore murder. For this purpose, the perpetration of a felony continues during the defendant's attempt to escape to a place of seeming safety. The pedestrian's death thus occurred during the perpetration of a robbery, and the defendant could be convicted of murder even if he was driving carefully at the time it occurred.\n\nB, C, and D are therefore incorrect."
    },
    // SOURCE: FINZ-CriminalLaw.pdf, Question 111
    {
        ...
        ans: 3,
        exp: "In the absence of special circumstances, no person is under a legal duty to render aid to another. Since a failure to act can lead to criminal responsibility only in the face of a duty to act, the adult's failure to rescue the girl was not a crime.\n\nThis is true even though she could have saved the girl without risk to herself, even though she knew that there was no one else who could rescue the child, and even if she was related to the girl. A, B, and C are therefore incorrect."
    },
    ...
    // SOURCE: FINZ-CriminalLaw.pdf, Question 114
    {
        ...
        ans: 1,
        exp: "Robbery is larceny accomplished by physical force or threat. The defendant clearly committed a larceny. Although he acquired possession and carried off the briefcase without the use of force, the issue is whether his subsequent use of force to retain possession was sufficient to make him guilty of robbery. B is the only case in which this issue arose.\n\nIn A, no force was used after acquisition of the purse. In C and D, although force was used to acquire the stolen property, none was used thereafter."
    },
    ...
    // SOURCE: FINZ-CriminalLaw.pdf, Question 125
    {
        ...
        ans: 2,
        exp: "Felony murder is a foreseeable killing that occurs during the course of a felony. In the majority of states, a person cannot be found guilty of felony murder for the death of a co-felon if that co-felon is killed by the police. Here, since the defendant's friend was shot by a police officer, it is unlikely he would be found guilty of felony murder. Therefore, A and B are incorrect.\n\nD is incorrect because a death that occurs while fleeing the scene still meets the requirements of felony murder, whether or not the felony itself is technically completed."
    },
    ...
    // SOURCE: FINZ-CriminalLaw.pdf, Question 130
    {
        ...
        ans: 2,
        exp: "Larceny is a trespassory taking and carrying off of personal property known to be another's with the intent to permanently deprive the owner. Since the defendant did not physically move the couch, she may successfully argue that because there was no asportation (i.e., carrying off), there was no larceny.\n\nIt is sometimes argued that one who enters through an unlocked door committed no breaking and, therefore, is not guilty of burglary. A is incorrect, however, because breaking is not an element of larceny. If a defendant carried off personal property that actually was his or her own, he or she could not be guilty of larceny because he or she did not take the property of another. If he or she mistakenly believed that it was his or her own, he or she still would not be guilty of larceny because he or she did not carry off property known to be another's. The couch was not the defendant's, however, and she knew that it was not hers. The fact that it was equal in value to her stereo would not, therefore, justify her taking or carrying it off. B is therefore incorrect. A person who takes and carries off personal property known to be another's with the intent to permanently deprive is guilty of larceny without regard to whether or not he or she intended to benefit by doing so. D is therefore incorrect."
    },
    // SOURCE: FINZ-CriminalLaw.pdf, Question 131
    {
        ...
        ans: 3,
        exp: "The woman did not commit any crime because she did not have a legal duty to warn anyone about the man walking into the mall, despite the fact she suspected he was about to commit a crime he did in fact commit.\n\nConsequently, A, B, and C are incorrect."
    },
    ...
    // SOURCE: FINZ-CriminalLaw.pdf, Question 134
    {
        ...
        ans: 0,
        exp: "Under the common law felony-murder rule, a person who kills another during the commission of a dangerous felony is guilty of murder. Here, arson is a dangerous felony, and the friend died during its commission, so the man is guilty of murder.\n\nB is incorrect because insurance fraud is not a dangerous felony. C and D are incorrect because they do not change the fact that the friend was killed during the man's commission of a dangerous felony."
    },
    ...
    // SOURCE: FINZ-CriminalLaw.pdf, Question 138
    {
        ...
        ans: 0,
        exp: "A conviction for murder can be supported by extremely negligent conduct that a reasonable person would realize created an unjustifiable and high risk of death or serious bodily injury. Here, the woman let tigers run around her suburban backyard. This is probably enough to meet the standard.\n\nB is incorrect because there needs to be some adequate provocation. Here, there wasn't any provocation at all. C is incorrect because the woman's conduct rose to the level of extremely negligent conduct required for depraved heart murder. As such, C is not the strongest answer even if the woman did not intend to kill anyone. D is incorrect because the woman could be convicted of murder."
    },
    // SOURCE: FINZ-CriminalLaw.pdf, Question 140
    {
        ...
        ans: 0,
        exp: "Here, the best friend was the aggressor and pulled the gun on the man when the man didn't do anything but break a lamp and order the best friend to leave. The man did not react with deadly force until the best friend pulled a gun on him. Consequently, the man's actions were justified and he should be acquitted of murder.\n\nB and C are incorrect because the murder was the result of self-defense, not the heat of passion. D is incorrect because the fact that the murder was the result of the man's plan to catch his best friend and wife does not change the analysis."
    }
];
