const examData = [
    // SOURCE: FINZ-CriminalLaw.pdf, Question 71
    {
        ...
        ans: 0,
        exp: "'Specific intent' crimes are those that require a state of mind amounting to a desire or knowledge by the defendant that his or her conduct will result in a consequence that is criminally proscribed[cite: 29]. 'General intent' crimes are those for which conviction may be based on recklessness or criminal negligence[cite: 29]. Voluntary intoxication may provide a defense to crimes requiring specific intent since it may prevent its formation[cite: 29]. Awareness of the effect that alcohol is likely to have on the capacity to assess risks, however, prevents voluntary intoxication from serving as a defense to crimes involving general intent[cite: 29]. Since rape may consist of recklessly having intercourse without the victim's consent, it is a general intent crime, and voluntary intoxication is not a defense to it[cite: 29].\n\nInvoluntary intoxication, on the other hand, may be a defense to crimes involving recklessness, as well as to specific intent crimes[cite: 29]. The defendant's assertion in B might therefore provide her with an effective defense[cite: 29]. Since attempted robbery requires the specific intent to commit a larceny by force or threat of force, the defendant's intoxication in C may have prevented her from having the intent required and may thus provide her with an effective defense[cite: 29]. In D, the defendant's assertion is that he lacked the intent to deprive the rightful owner of possession of the automobile[cite: 29]. Since this specific intent is an essential element of larceny, his intoxication may provide him with an effective defense[cite: 29]."
    },
    // SOURCE: FINZ-CriminalLaw.pdf, Question 72
    {
        ...
        ans: 1,
        exp: "Receiving stolen property consists of the acquisition of stolen property with the knowledge that it has been stolen and with the intent to permanently deprive its owner of it[cite: 29]. Acquisition occurs when the defendant takes possession of the property himself or herself, or when he or she directs that possession be delivered to another[cite: 29]. Thus, although the defendant did not personally take possession of the car that the man stole, he received it when he directed that it be delivered to his brother[cite: 29].\n\nIn A, the car that the defendant received had already been recovered by the police and was therefore not stolen at the time of the sale[cite: 29]. In C and D, there is no indication that the cars sold to the defendant ever had been stolen[cite: 29]. A, C, and D are therefore incorrect[cite: 29]."
    },
    // SOURCE: FINZ-CriminalLaw.pdf, Question 74
    {
        ...
        ans: 0,
        exp: "Murder requires malice[cite: 29]. While there is no indication that the neighbor intended to kill the man, he did throw a big glass shard at him in anger[cite: 29]. As such, the neighbor's actions could be construed as an attempt to kill or inflict serious bodily injury[cite: 29]. Because of this, the neighbor could be convicted for murder[cite: 29].\n\nB and C are incorrect because voluntary manslaughter occurs when an intentional killing is done in the heat of passion or anger[cite: 29]. Here, the killing occurred by accident and the neighbor was only annoyed[cite: 29]. This would take the killing out of the definition of voluntary manslaughter[cite: 29]. D is incorrect because the neighbor acted with malice by throwing a big shard of glass at the man[cite: 29]. As such, murder is the appropriate charge[cite: 29]."
    },
    // SOURCE: FINZ-CriminalLaw.pdf, Question 75
    {
        ...
        ans: 2,
        exp: "In the majority of states, if a defendant made an unreasonable mistake as to the need for force in self-defense, the defendant's crime can be reduced from murder to voluntary manslaughter even though such a claim does not completely excuse a defendant's actions[cite: 29]. This is referred to as a claim of 'imperfect' self-defense[cite: 29]. Here, the question states that the defendant honestly but unreasonably believed that he needed to use deadly force to protect himself from the victim's laser gun[cite: 29]. Given the circumstances of the victim's job, the defendant's intoxication, and the particulars of the cellphone, such a belief could be honest yet unreasonable[cite: 29]. Importantly, the question tells you to assume that the court believes the defendant's version of events, whether or not you believe the defendant's belief to be ridiculous[cite: 29].\n\nA is incorrect because self-defense requires a reasonable belief as to the need for force[cite: 29]. Here, the question states that the defendant's belief was unreasonable[cite: 29]. B is incorrect because the defendant's unreasonable belief will have an effect on his case[cite: 29]. D is incorrect because depraved heart murder has to do with situations where a defendant acted with such great recklessness that he or she can be said to have extreme indifference to the value of human life[cite: 29]. In these situations, the defendant is not necessarily intending to kill anyone, but is acting in such a way as to make someone's death likely[cite: 29]."
    },
    // SOURCE: FINZ-CriminalLaw.pdf, Question 76
    {
        ...
        ans: 1,
        exp: "When the words deliberate and premeditated appear in a murder statute, deliberate means that the defendant was possessed of a cool mind capable of reflection, and premeditated means that the defendant actually did reflect on his or her act before committing it[cite: 29]. Since the psychiatrist's testimony indicates that the defendant may have been incapable of cool reflection at the time of his act, it may be admitted for the purpose of showing that the killing was not deliberate and premeditated[cite: 29].\n\nA is incorrect because under the M'Naghten test, a defendant is insane only if mental disease made him or her incapable of knowing the nature and quality of his or her act, or that it was wrong[cite: 29]. C is incorrect because the testimony may be admitted to establish lack of deliberation and premeditation, even though it does not establish that the defendant was insane[cite: 29]. An intentional killing may be reduced from murder to voluntary manslaughter if the defendant was acting in the heat of passion caused by sufficient provocation[cite: 29]. For this purpose, the provocation and defendant's response to it are usually judged by an objective standard[cite: 29]. D is incorrect, however, because, as explained above, psychiatric evidence of the defendant's state of mind may be relevant to the elements of deliberation and premeditation[cite: 29]."
    },
    // SOURCE: FINZ-CriminalLaw.pdf, Question 78
    {
        ...
        ans: 3,
        exp: "A conspiracy is an agreement to commit a crime[cite: 29]. Conspirators are vicariously liable for crimes committed in furtherance of the conspiratorial goal by other members of the conspiracy[cite: 29]. This is so even if those crimes were unforeseeable, not included in the original plan, or unnecessary to the success of the conspiracy, so long as they were committed in furtherance of the conspiratorial goal[cite: 29]. Since the roommate transported the car across a state line for the purpose of aiding their escape, it was in furtherance of the conspiratorial goal[cite: 29]. A, B, and C are therefore incorrect[cite: 29]."
    },
    // SOURCE: FINZ-CriminalLaw.pdf, Question 80
    {
        ...
        ans: 1,
        exp: "The crime of receiving stolen property is committed when the defendant receives stolen property with the knowledge that it is stolen and with the intent to permanently deprive the owner of it[cite: 29]. Since the car that the defendant purchased was in the lawful custody of the police, it could be argued that it was no longer stolen[cite: 29]. Although it is not certain that this argument would succeed, it is the only one listed that could possibly be effective in the defendant's defense[cite: 29]. B is therefore correct[cite: 29].\n\nSince the police are supposed to prevent crime rather than instigate it, many jurisdictions hold that a defendant who was induced by the police or an agent of the police to commit a crime that he or she was not otherwise disposed to commit is entrapped and has a valid affirmative defense to the crime charged[cite: 29]. A is incorrect, however, because the defendant came looking for a stolen car and was therefore already disposed to commit the crime with which he was charged[cite: 29]. Ordinarily, a defense may not be based on the assertion of another's rights[cite: 29]. If the man's cooperation was coerced, the man's rights may have been violated[cite: 29]. C is incorrect, however, because the defendant may not base his defense on the invasion of the man's rights[cite: 29]. D is incorrect because no right of the defendant's was bargained away[cite: 29]."
    },
    // SOURCE: FINZ-CriminalLaw.pdf, Question 83
    {
        ...
        ans: 3,
        exp: "Murder is the unjustified killing of a human being with malice aforethought[cite: 29]. Malice aforethought means a wanton disregard for human life, or an intent to kill, inflict great bodily harm, commit a felony, or resist a lawful arrest[cite: 29]. Since it is clear that the defendant did not intend to commit a felony, to resist a lawful arrest, or to strike anyone with the bullet, she can be found guilty of murder only if her conduct showed a wanton disregard for human life[cite: 29]. Thus, if she is acquitted, it can only be because the court found that her conduct did not show a wanton disregard[cite: 29].\n\nA is incorrect because malice aforethought may exist without an intent to kill[cite: 29]. Since any result may have many proximate causes, the fact that the ambulance driver's conduct was a proximate cause of the victim's death does not establish that the defendant's conduct was not also a proximate cause of that death[cite: 29]. B is therefore incorrect[cite: 29]. The privilege to abate a nuisance permits the use of reasonable force only[cite: 29]. Although the conduct of the defendant's neighbors may have constituted a nuisance, it is obvious that the use of a deadly weapon was not a reasonable response to it[cite: 29]. C is therefore incorrect[cite: 29]."
    },
    // SOURCE: FINZ-CriminalLaw.pdf, Question 84
    {
        ...
        ans: 2,
        exp: "A person is privileged to use reasonable force to protect himself or herself from what he or she reasonably believes to be a threat of imminent bodily harm[cite: 29]. Potentially lethal force is reasonable when used in response to what the defendant reasonably perceives to be a threat of potentially lethal force[cite: 29]. Thus, if the defendant reasonably believed that the victim was reaching for a gun, her use of a gun in response may have been reasonable and therefore privileged[cite: 29]. While it is not certain that a court would come to this conclusion, the argument in C is the only one listed that could possibly provide the defendant with an effective defense[cite: 29].\n\nA person is guilty of a criminal attempt when, with the intent to bring about a criminally prohibited result, he or she comes substantially close to achieving it[cite: 29]. A is incorrect because the fact that a death did not actually occur will not prevent a conviction for attempting to cause one[cite: 29]. If the defendant had the intent to kill the victim when she aimed her pistol at the victim's chest, she would be guilty of attempted murder if she came subsequently close to causing the victim's death[cite: 29]. This might be so even if she did not strike the victim in the chest, or even if she did not strike the victim at all[cite: 29]. For this reason, B is incorrect[cite: 29]. D is incorrect because deadly force is force that is likely to result in death or great bodily harm[cite: 29]. The use of a pistol thus constitutes deadly force even though the harm that it actually causes happens to be slight[cite: 29]."
    },
    // SOURCE: FINZ-CriminalLaw.pdf, Question 85
    {
        ...
        ans: 3,
        exp: "Murder is the unjustified killing of a human being with malice aforethought[cite: 29]. In addition to reckless disregard for human life, and the intent to kill, to cause great bodily harm, or to resist a lawful arrest, malice aforethought includes the intent to commit a dangerous felony[cite: 29]. Since arson is a dangerous felony, D is correct[cite: 29].\n\nA is incorrect because malice aforethought may exist even though the defendants did not intend to kill[cite: 29]. Some jurisdictions have held that the felony-murder rule cannot be applied unless the deaths were totally independent of the defendants' purpose in committing a felony[cite: 29]. B is a misstatement of this rule and is therefore incorrect[cite: 29]. C is incorrect because unreasonable conduct is not sufficient to constitute malice aforethought[cite: 29]."
    },
    // SOURCE: FINZ-CriminalLaw.pdf, Question 86
    {
        ...
        ans: 1,
        exp: "Kidnapping consists of intentionally transporting and confining a person against that person's will by force or threat and without legal authority[cite: 29]. The essential difference between kidnapping and criminal false imprisonment is the requirement of asportation: Unless the defendant has moved the victim to the place of confinement, there is no kidnapping[cite: 29]. Since the defendant forced the hostage to accompany him to his car, where he confined her for a period of 15 minutes, he has kidnapped her[cite: 29]. Because he did not move any of the other victims to the place of their confinement, he did not kidnap them[cite: 29].\n\nA, C, and D are therefore incorrect[cite: 29]."
    },
    // SOURCE: FINZ-CriminalLaw.pdf, Question 87
    {
        ...
        ans: 0,
        exp: "A defendant is guilty of criminally receiving stolen property when he or she acquires stolen personal property with knowledge that it is stolen and with the intent to permanently deprive its owner[cite: 29]. Since the car that the defendant purchased from the other officer had been requisitioned from the police department, it was not stolen property[cite: 29]. Since the defendant never received stolen property, he cannot be guilty of this crime[cite: 29].\n\nB is incorrect because guilt does not require that the defendant pay for stolen property with his own money (or that he pay for it at all)[cite: 29]. Police officers are supposed to prevent crime, not to cause it[cite: 29]. For this reason, many jurisdictions hold that a defendant who was entrapped (i.e., induced by a police officer to commit a crime that he or she was not otherwise inclined to commit), cannot be convicted of committing it[cite: 29]. The officers did not entrap the defendant because the defendant indicated his inclination to purchase a stolen car before either officer suggested that he do so[cite: 29]. C is therefore incorrect[cite: 29]. A search or arrest warrant may not be issued without a showing of probable cause, but no such showing is required before beginning an investigation[cite: 29]. For this reason, D is incorrect[cite: 29]."
    },
    // SOURCE: FINZ-CriminalLaw.pdf, Question 88
    {
        ...
        ans: 1,
        exp: "Arson is the intentional or malicious burning of the dwelling of another[cite: 29]. Since even the slightest charring of the walls or ceiling is regarded as a burning, there was a burning of the boyfriend's dwelling[cite: 29]. Since malice includes recklessness, and since it was clearly reckless to set fire to a couch while it was inside the house, the necessary state of mind is present[cite: 29]. The defendant is therefore guilty of arson[cite: 29].\n\nBurglary is the trespassory breaking and entering of the dwelling of another at night with the intent to commit a larceny or any felony therein[cite: 29]. The defendant entered the boyfriend's dwelling at night[cite: 29]. The unauthorized opening of a closed door can constitute a breaking, and any unauthorized entry is trespassory[cite: 29]. Although the defendant did commit a felony inside (i.e., arson), she cannot be guilty of burglary unless she intended to do so when she entered[cite: 29]. Since at the time the defendant entered the boyfriend's house, she meant only to retrieve her own property, she did not have the requisite intent to make her guilty of burglary[cite: 29]. A and C are therefore incorrect[cite: 29]. D is incorrect because the defendant is guilty of arson as explained above[cite: 29]."
    },
    // SOURCE: FINZ-CriminalLaw.pdf, Question 90
    {
        ...
        ans: 2,
        exp: "Under the 'irresistible impulse' test, a person is not guilty by reason of insanity if mental disease made him or her incapable of controlling his or her conduct at the time of the alleged criminal act[cite: 29]. Although not all jurisdictions accept this definition of insanity, under the facts given, C is the only argument listed that would serve as an effective defense in any jurisdiction[cite: 29].\n\nThe M'Naghten rule provides that a person is not guilty by reason of insanity if, at the time of the allegedly criminal act, mental disease prevented him or her from knowing either the nature and quality of his or her act or that it was wrong[cite: 29]. A defendant is said to know that his or her act is 'wrong,' however, if he or she is aware that it is prohibited by law[cite: 29]. Since the defendant knew that if he was caught, he would be imprisoned for murder, he had sufficient understanding that his act was wrong to make him sane under this rule[cite: 29]. A is therefore incorrect[cite: 29]. The concept of 'intent' relates to the defendant's state of mind regarding the immediate consequences of his or her act, quite apart from the concept of 'motive,' which refers to a defendant's purpose in bringing that consequence about[cite: 29]. Since the defendant desired to kill the victim, he had the necessary intent to make him guilty of murder, in spite of his noble motive (i.e., to save the world)[cite: 29]. B is therefore incorrect[cite: 29]. A person who, by reason of mental illness, is incapable of understanding the nature and quality of his or her act is insane under the M'Naghten rule discussed above[cite: 29]. The phrase nature and quality of the act, however, refers to the physical character of the act and to its physical consequences[cite: 29]. Since the defendant understood that he was pushing the victim down the stairs and that this could result in her death, he did understand the nature and quality of his act[cite: 29]. D is therefore incorrect[cite: 29]."
    },
    // SOURCE: FINZ-CriminalLaw.pdf, Question 92
    {
        ...
        ans: 1,
        exp: "A person is guilty of a criminal attempt when, with the specific intent to bring about a criminally prohibited result, he or she comes substantially close to bringing about that result[cite: 29]. Thus, while certain crimes may be committed without intending the prohibited consequences, criminal attempt always requires the specific intent to bring about the prohibited result[cite: 29]. Although the employee could be convicted of violating the statute if he actually sold ammunition to the teenager, he could not be convicted of attempting to violate the statute unless he knew that the teenager was under the age of 16 and intended to sell her the ammunition[cite: 29].\n\nFor obvious practical reasons, there is usually an irrebuttable presumption that all persons know the law[cite: 29]. Ignorance of the law, therefore, would not provide the employee with a defense[cite: 29]. A is therefore incorrect[cite: 29]. The fact that the owner is vicariously liable under the statute would not furnish the employee with a defense since the statute imposes liability on both employee and employer[cite: 29]. C is incorrect for this reason, and because the statute imposes vicarious liability on the employer only if the employee actually makes a sale, which the employee did not do[cite: 29]. D is incorrect because the statute does not make knowledge or experience an element of guilt[cite: 29]."
    },
    // SOURCE: FINZ-CriminalLaw.pdf, Question 95
    {
        ...
        ans: 3,
        exp: "Criminal battery consists of the intentional, reckless, or criminally negligent application of force to the body of another[cite: 29]. Since it is thus a general intent crime, it may be committed without the intent to make contact with the victim[cite: 29]. While voluntary intoxication is no defense to a general intent crime, involuntary intoxication ordinarily is[cite: 29]. A person has become involuntarily intoxicated when his or her intoxication was the result of an unpredictable and grossly excessive reaction to an intoxicating substance[cite: 29]. Thus, if the defendant had never before been overcome by the alcohol in one drink, it may be that his intoxication was involuntary and that it will provide him with a defense to the charge of criminal battery[cite: 29]. It is not certain that this defense would be successful, since a court might find that although the response was unpredictable, it was not grossly excessive[cite: 29]. The fact set forth in D, however, is the only one listed that might possibly provide the defendant with an effective defense[cite: 29].\n\nA person may become 'voluntarily' intoxicated even without the intent to become drunk so long as he or she is aware that the substance that he or she is taking has an intoxicating potential[cite: 29]. Since the defendant was aware that the drink had some alcohol in it, his intoxication may be called voluntary even if he did not intend to become drunk[cite: 29]. A is therefore incorrect[cite: 29]. If the defendant's conduct in drinking the drink was reckless or criminally negligent, he could have the necessary mens rea to be guilty of battery (i.e., general intent), even though he did not specifically know what risk he was creating (i.e., that he would fall off the bar stool)[cite: 29]. B is therefore incorrect[cite: 29]. C is incorrect because battery is a general intent crime, and therefore it does not require the intent to make contact with another human being[cite: 29]."
    },
    // SOURCE: FINZ-CriminalLaw.pdf, Question 96
    {
        ...
        ans: 0,
        exp: "A person is privileged by self-defense to use reasonable force to protect himself or herself against what reasonably appears to be an imminent threat of bodily harm[cite: 29]. In this connection, reasonable force is the force that would appear necessary to the reasonable person[cite: 29]. Even deadly force is reasonable if the person using it reasonably believes that he or she is being threatened with deadly force[cite: 29]. Thus, since the defendant reasonably believed that his life was in danger, the force that he used in self-defense was probably reasonable, making the defendant not guilty of attempted murder[cite: 29].\n\nAlthough deadly force is not ordinarily considered reasonable in defense of mere property, B is incorrect because the defendant's shot was probably fired in response to a threat against his person and may have been justified by self-defense[cite: 29]. Although the intent to kill or inflict serious injury can be inferred from the fact that the defendant fired at the officer, C is incorrect because, if reasonable, his conduct was privileged by self-defense[cite: 29]. Since the defendant had no way of knowing that the person threatening him was a police officer, the officer's status as such can have no bearing on the reasonableness of the defendant's actions[cite: 29]. D is therefore incorrect[cite: 29]."
    },
    // SOURCE: FINZ-CriminalLaw.pdf, Question 97
    {
        ...
        ans: 2,
        exp: "One who intentionally aids, abets, or facilitates the commission of a crime is criminally responsible for the crime as an accomplice[cite: 29]. In addition, an accomplice is criminally responsible for all the foreseeable consequences of the crime that he or she facilitated[cite: 29]. Since the use of the defendant's apartment to escape detection was part of the bank robber's plan in preparing for the robbery, the defendant's agreement to permit the bank robber to use it facilitated the robbery, making the defendant an accomplice to it[cite: 29]. As such, the defendant may be guilty of felony murder in the death that resulted from the robbery, but only if it was foreseeable that such a death would occur[cite: 29].\n\nOne who becomes an accessory after a crime has been committed (i.e., accessory after the fact) by knowingly harboring the person who committed it is not criminally responsible for prior acts committed by the person harbored[cite: 29]. A person who facilitates the commission of a crime by agreeing in advance that he or she will harbor the perpetrator after the crime is committed is guilty as an accomplice (i.e., accessory before the fact), however[cite: 29]. As such, he or she is criminally responsible for all foreseeable consequences of the crime to which he or she was an accomplice[cite: 29]. A is therefore incorrect[cite: 29]. Since an accomplice is criminally responsible for those consequences that were foreseeable, the fact that the defendant did not actually know that the bank robber would use a gun does not protect him from liability if the bank robber's use of a gun was foreseeable[cite: 29]. B is therefore incorrect[cite: 29]. A conspirator is criminally responsible for all crimes committed by co-conspirators in furtherance of the subject of the conspiracy[cite: 29]. D is incorrect, however, because an accessory is criminally responsible only for consequences that were foreseeable[cite: 29]."
    },
    // SOURCE: FINZ-CriminalLaw.pdf, Question 99
    {
        ...
        ans: 3,
        exp: "A person is guilty of a criminal attempt when, with the specific intent to bring about a result that is criminally prohibited, he or she comes substantially close to accomplishing that result[cite: 29]. Since the defendant believed that the time was five minutes past eleven, and since it would have been lawful to sell liquor at that time, he did not have the specific intent to bring about a result that was criminally prohibited[cite: 29]. For this reason, he could not be guilty of attempting to violate the statute[cite: 29].\n\nA and B are therefore incorrect[cite: 29]. Attempt always requires specific intent, even where the substantive crime does not[cite: 29]. Thus, even if the statute did not require specific intent, the defendant could not be guilty of attempting to violate it without specifically intending to sell liquor after midnight[cite: 29]. C is therefore incorrect[cite: 29]."
    },
    // SOURCE: FINZ-CriminalLaw.pdf, Question 100
    {
        ...
        ans: 0,
        exp: "At common law, larceny is defined as a trespassory taking and carrying off of personal property known to be another's with the intent to permanently deprive the owner thereof[cite: 29]. A person who is reclaiming his or her own property is not committing larceny since he or she is not carrying off the property of another[cite: 29]. Thus, the defendant's taking of $50 to pay himself back for the money that the victim owed him was not a larceny[cite: 29]. Except in the case of fungible goods, however, this rule does not protect a defendant who takes something that is not his or her own, even though it is equivalent in value to the property that he or she seeks to reclaim[cite: 29]. Thus, the defendant's taking of $50 cash to pay himself for the watch that the victim refused to return is a larceny[cite: 29].\n\nSince the statute provides that a larceny of $50 or less is a misdemeanor, A is correct, and B, C, and D are incorrect[cite: 29]."
    },
    // SOURCE: FINZ-CriminalLaw.pdf, Question 101
    {
        ...
        ans: 0,
        exp: "A person has to be the 'cause-in-fact' of a death in order to be convicted for it[cite: 29]. The mistress is not a 'but-for' cause-in-fact of the wife's death since the wife would have died anyway from the poison[cite: 29]. However, a person can meet the cause-in-fact requirement if he or she is a 'substantial factor' in causing the death[cite: 29]. Here, the mistress's actions significantly sped up the death, so she was a substantial factor in causing the death[cite: 29]. Consequently, she would fulfill the cause-in-fact requirement and could be found guilty of the murder[cite: 29]. Therefore, C and D are incorrect[cite: 29]. B is irrelevant because the fact that the mistress was in the house unlawfully does not change the analysis[cite: 29]."
    },
    // SOURCE: FINZ-CriminalLaw.pdf, Question 102
    {
        ...
        ans: 2,
        exp: "A criminal conspiracy is an agreement to commit a crime and is complete when the agreement is made[cite: 29]. Since the defendant agreed to commit a robbery with the two other men, he is guilty of conspiracy[cite: 29]. A person is guilty of a criminal attempt when, with the specific intent to bring about a result that is criminally prohibited, he comes substantially close to bringing about that result[cite: 29]. Since the two other men intended to rob the bank and came substantially close to doing so, they are guilty of attempted robbery[cite: 29]. Co-conspirators are vicariously liable for crimes committed in furtherance of the agreement[cite: 29]. Since the attempted robbery was committed in furtherance of the agreement between the defendant and the two other men, the defendant is criminally liable for the attempt even though he did not physically participate in it[cite: 29]."
    },
    // SOURCE: FINZ-CriminalLaw.pdf, Question 105
    {
        ...
        ans: 3,
        exp: "Under the state's definition, conspiracy requires an agreement to commit a crime with the specific intent to commit a crime[cite: 29]. If the act that the first boy and the girl agreed to commit was not a crime, the first boy lacked the specific intent required[cite: 29]. Since neither the common law nor the statute prohibits sexual intercourse between persons of the second boy's and the girl's ages, intercourse between them would not have been a crime, and therefore the agreement between the first boy and the girl was not a conspiracy[cite: 29].\n\nFor certain crimes, Wharton's Rule provides that there can be no conviction for conspiracy unless one of the parties to the agreement was not logically essential to the commission of the act that they agreed to commit[cite: 29]. A is incorrect, however, because although the girl's participation was essential to the seduction of the second boy, the first boy's participation was not[cite: 29]. In addition, Wharton's Rule does not apply to statutory rape[cite: 29]. Conspiracy is a separate crime and is committed when the conspiratorial agreement is made[cite: 29]. Some jurisdictions also require that there have been an overt act in furtherance of the conspiracy[cite: 29]. B is incorrect, however, because such an act need only be committed by one of the co-conspirators, and the girl's acts would suffice[cite: 29]. Since the crime is committed when the agreement is made, the fact that the act that the parties agreed to commit never actually took place is not a defense[cite: 29]. C is thus incorrect[cite: 29]."
    },
    // SOURCE: FINZ-CriminalLaw.pdf, Question 106
    {
        ...
        ans: 3,
        exp: "A lesser included offense is an offense the elements of which are completely included among the elements of a more serious crime[cite: 29]. Attempting to commit a crime is always a lesser included offense since its elements are always included among the elements of the completed crime[cite: 29]. One who commits a crime is guilty of all lesser included offenses[cite: 29]. Since the defendant offered to commit bribery, he is guilty of bribery in the second degree, and since the attempt is included in the completed crime, he is guilty of attempting to commit bribery in the second degree[cite: 29].\n\nA person is guilty of attempting to commit a crime when, with the specific intent to commit that crime, he or she comes substantially close to committing it[cite: 29]. A is incorrect because bribery in the second degree is not an 'attempt' crime[cite: 29]. It is statutorily defined as offering to commit bribery and is committed when the offer is made[cite: 29]. B is incorrect because although the clerk first offered to accept the money, the defendant's subsequent agreement was also an offer to pay the money[cite: 29]. In addition, the defendant's trip to the clerk's office the following day was for the purpose of offering to pay the money[cite: 29]. C is based on a misinterpretation of the law[cite: 29]. A lesser included crime is said to 'merge' with the more serious one, but this means only that a defendant cannot be convicted of both[cite: 29]. There is no reason why he or she cannot be convicted of the lesser one only[cite: 29]."
    },
    // SOURCE: FINZ-CriminalLaw.pdf, Question 107
    {
        ...
        ans: 2,
        exp: "A person is guilty of a criminal attempt when, with the specific intent to bring about a prohibited result, he or she comes substantially close to doing so[cite: 29]. Thus, all attempts are 'specific intent' crimes[cite: 29]. This means that although murder does not require a specific intent to cause the death of a person, attempted murder does[cite: 29]. Since the defendant did not intend to cause the death of a human being, she lacks the intent required to make her guilty of attempted murder[cite: 29].\n\nA is therefore incorrect[cite: 29]. The death of the friend does not satisfy the specific intent requirement unless the defendant intended to bring it about[cite: 29]. For this reason, B is also incorrect[cite: 29]. Although the attempt to murder a person may merge with the actual murder of the person, D is incorrect because the coworker did not die and so could not have been murdered[cite: 29]."
    }
];
