const examData = [
    // FACT PATTERN 1 (Q1)
    {
        ...
        ans: 3,
        exp: "Larceny is a trespassory taking and carrying off of personal property known to be another's with the intent to permanently deprive the owner of it[cite: 29]. Although the defendant planned to return the money in the event of one contingency, she planned not to return it in the event of another[cite: 29]. This contingent intent to permanently deprive is sufficient to make her guilty of larceny when she took and carried off the money on Friday night[cite: 29].\n\nA is incorrect because she took the money with the intent (contingent at least) to permanently deprive the owner[cite: 29]. B is incorrect because she intended not to return it if she lost[cite: 29]. Since the crime was committed when she took the money, the fact that she did or did not return it all on Monday morning is irrelevant[cite: 29]. C is therefore incorrect[cite: 29]."
    },
    // FACT PATTERN 2 (Q2)
    {
        id: 2,
        ...
        ans: 1,
        exp: "Although most statutes that forbid the sale of alcohol to minors impose strict liability (i.e., defendant's knowledge is not an element), this one does not because it prohibits only the knowing sale[cite: 29]. If the defendant reasonably believed that the teenager was over the age of 21, he lacked the knowledge that is requisite to a conviction[cite: 29].\n\nNot knowing whether wine was an intoxicating substance under the statute would not be a defense because all persons are conclusively presumed to know the law[cite: 29]. Ignorance of the law is not a defense[cite: 29]. A is therefore incorrect[cite: 29]. Entrapment is available as a defense only when a police officer induced the defendant to commit a crime that he or she was not already disposed to commit[cite: 29]. C is incorrect because the police officer did nothing to encourage the sale[cite: 29]. The statute prohibits the sale of intoxicating substances without regard to whether or not anyone becomes intoxicated by them[cite: 29]. D is therefore incorrect[cite: 29]."
    },
    // FACT PATTERN 3 (Q3)
    {
        id: 3,
        ...
        ans: 1,
        exp: "Self-defense involves a privilege to use reasonable force to prevent what is reasonably perceived as a threat of imminent bodily harm[cite: 29]. If a defendant makes a mistake regarding the need for self-defense, courts will look at whether such a mistake was reasonable[cite: 29]. If the mistake was reasonable, the defendant is entitled to claim he or she acted in self-defense[cite: 29]. Here, the recent robberies, time of day, robber's threat, and the metal spatula handle in the back likely made it reasonable for the defendant to believe he was in danger of being shot[cite: 29]. A is incorrect because the primary question is whether the defendant's actions were reasonable, not whether they were justified[cite: 29]. C is incorrect because self-defense does not require a defendant to verify the truth of his or her belief; it just requires that that belief is reasonable[cite: 29]. D is incorrect because the circumstances here likely made the defendant's actions reasonable[cite: 29]."
    },
    // FACT PATTERN 4 (Q4)
    {
        id: 4,
        ...
        ans: 0,
        exp: "A person is guilty as an accessory to a crime when he or she aids and abets in its perpetration[cite: 29]. At common law, a defendant commits rape when he or she has sexual intercourse with a woman who is not his wife without the woman's consent[cite: 29]. Although under this definition a husband cannot be guilty as a principal of raping his wife, he can be guilty as an accessory if he aids and abets another to have sexual intercourse with her without her consent[cite: 29]. Since the defendant assisted the drug dealer in committing rape (i.e., having intercourse with the wife without her consent), he is guilty of rape as an accessory[cite: 29].\n\nDepending on the statutory definitions of procuring for prostitution and possession of narcotics, the defendant may be guilty of all the crimes listed[cite: 29]. B, C, and D are incorrect, however, because rape is clearly the most serious of them[cite: 29]."
    },
    // FACT PATTERN 5 (Q5)
    {
        id: 5,
        ...
        ans: 0,
        exp: "Larceny is defined as the trespassory taking and carrying off of personal property known to be another's with the intent to permanently deprive the owner thereof[cite: 29]. Since the defendant's taking and carrying off of the candy dish was inconsistent with his friend's rights, it was trespassory[cite: 29]. Since the defendant knew that the candy dish was his friend's, and since giving it to his sister as a wedding present would permanently deprive his friend of it, he committed larceny, and A is correct[cite: 29].\n\nBurglary is the breaking and entering into the dwelling house of another for the purpose of committing a felony therein[cite: 29]. Since the defendant entered to recover his own camera, his purpose was not to commit a felony, and he is not guilty of burglary, B is therefore incorrect[cite: 29]. A person is guilty of a criminal attempt when, with the specific intent to bring about a result that is criminally prohibited, he or she comes substantially close to bringing about that result[cite: 29]. Since the defendant did not have the purpose of committing a felony inside his friend's home, he lacked the intent necessary for burglary and therefore could not be convicted of attempted burglary[cite: 29]. C is therefore incorrect[cite: 29]. D is incorrect because the defendant is guilty of larceny as explained above[cite: 29]. The larceny was committed at the moment that the defendant carried off the candy dish with the requisite intent, and it was not uncommitted when he returned the item[cite: 29]."
    },
    // FACT PATTERN 6 (Q6)
    {
        id: 6,
        ...
        ans: 2,
        exp: "A person is guilty of attempting to commit a crime when, with the specific intent to bring about a criminally prohibited result, he or she comes substantially close to achieving that result[cite: 29]. Since involuntary manslaughter is unintended homicide, there can be no attempt to commit it because the requisite state of mind cannot exist[cite: 29].\n\nA and B are therefore incorrect[cite: 29]. Since there is no requirement that a person be prosecuted for the highest possible crime that he or she committed, D is incorrect[cite: 29]."
    },
    // FACT PATTERN 7 (Q7)
    {
        id: 7,
        ...
        ans: 2,
        exp: "The defendant obviously did not have the intent to cause the death of the accomplice and was obviously not engaged in committing rape, robbery, or kidnapping at the time that the accomplice was killed[cite: 29]. Under the common law definition, burglary is a breaking and entering into the dwelling of another at night for the purpose of committing a felony therein[cite: 29]. Since the defendant was not attempting to enter a dwelling house, he was not committing a burglary either[cite: 29].\n\nA is incorrect because most jurisdictions apply the felony-murder rule to the killing of one felon by another[cite: 29]. B is incorrect because the statute does not require that the felony being committed is a dangerous one[cite: 29]. While assumption of the risk is a defense in tort actions, it is not in criminal prosecutions[cite: 29]. D is therefore incorrect[cite: 29]."
    },
    // FACT PATTERN 8 (Q8)
    {
        id: 8,
        ...
        ans: 3,
        exp: "The victim of a crime does not share the guilt of the perpetrator, even though the victim's participation was necessary to the crime's commission[cite: 29]. If the law was designed to protect people in the defendant's position against people in the personnel manager's position, the defendant can be regarded as the victim of the personnel manager's act and thus escape criminal liability[cite: 29]. While it is not certain that a court would be persuaded by this argument, it is the only one listed that could possibly result in dismissal[cite: 29].\n\nAlthough the statement contained in A was correct at early common law, it is no longer true in a majority of jurisdictions[cite: 29]. B is factually incorrect, since the personnel manager could not have committed the crime if the defendant had not paid him the money[cite: 29]. Under Wharton's Rule, persons who agree to commit a crime cannot be convicted of conspiracy unless at least one of them was not essential to the commission of that crime[cite: 29]. Wharton's Rule applies to bigamy, incest, gambling, bribery, adultery, and dueling[cite: 29]. Since the crime created by the statute could not have been committed by one person alone, Wharton's Rule would prevent the conviction of the personnel manager and the defendant for conspiracy to commit it[cite: 29]. C is incorrect, however, because the defendant is not being charged with conspiracy, but with being an accessory to the substantive crime, and because accessories frequently are people without whom the crime could not have been committed[cite: 29]."
    },
    // FACT PATTERN 9 (Q9)
    {
        id: 9,
        ...
        ans: 0,
        exp: "Robbery is larceny accomplished by force or a threat of force directed at the lawful possessor of the property taken[cite: 29]. The defendant's snatching of the purse was accomplished by force, and the hand in his pocket coupled with his words constituted a threat of force[cite: 29].\n\nLarceny by trick requires that the victim give up the property in reliance on the defendant's fraud[cite: 29]. Since the victim's purse was taken by force, B is incorrect[cite: 29]. Embezzlement is criminal conversion of personal property by one in lawful possession[cite: 29]. C is incorrect because the defendant did not obtain possession of the property lawfully[cite: 29]. Larceny by false pretenses involves a misrepresentation of fact that is intended to and does in fact cause the victim to transfer title to property[cite: 29]. D is incorrect because the victim did not transfer title to the defendant[cite: 29]."
    },
    // FACT PATTERN 10 (Q10)
    {
        id: 10,
        ...
        ans: 0,
        exp: "Larceny is a trespassory taking and carrying off of property known to be another's with the intent to permanently deprive[cite: 29]. There is no requirement that the victim's possession of the property be lawful[cite: 29]. The defendant's taking of the plant was trespassory, and therefore a larceny, because she had been authorized to water it, not to carry it off[cite: 29]. The defendant could not be guilty of burglary since her use of the key that the doctor gave her prevents her entry from constituting a breaking, which requires force against the premises[cite: 29]."
    },
    // FACT PATTERN 11 (Q11)
    {
        id: 11,
        ...
        ans: 1,
        exp: "Rape is sexual intercourse without consent of the female[cite: 29]. Since the bank teller's resistance was overcome by the defendant's threat and her resulting fear of death, the intercourse occurred without her consent[cite: 29]. One who commands another to do an act is responsible for the criminal consequences thereof[cite: 29]. Although the defendant did not himself have sexual intercourse with the teller, he is guilty of rape because he commanded the bank manager to do so[cite: 29]. Solicitation is committed by encouraging, ordering, or commanding another to commit a crime[cite: 29]. If the person solicited actually commits the crime, however, solicitation merges with the substantive crime and is not subject to separate prosecution[cite: 29]."
    },
    // FACT PATTERN 12 (Q12)
    {
        id: 12,
        ...
        ans: 3,
        exp: "Under the common law, burglary is the breaking and entering into the dwelling house of another, at night, with the intent to commit a felony therein[cite: 29]. Most states have changed burglary to include entry into any kind of structure at any time of the day[cite: 29]. Here, since what the man was intending to do wasn't a crime, he can't be convicted of burglary[cite: 29].\n\nA is incorrect because the issue is whether what the man intended to do was a felony, not that the man intended to commit a felony by doing something that wasn't actually a crime[cite: 29]. B is incorrect because the burglary would have been complete the minute he entered the church if what he was doing was actually a felony[cite: 29]. Importantly, burglary requires the intent to commit a felony, not its actual completion[cite: 29]. C is incorrect because his underlying actions did not actually add up to burglary, so he clearly could not be liable for attempt[cite: 29]."
    },
    // FACT PATTERN 13 (Q13)
    {
        id: 13,
        ...
        ans: 1,
        exp: "One who, with the intent that a crime will be committed, encourages another to commit that crime, is liable for it as an accessory[cite: 29].\n\nA is incorrect because mere presence at the scene of a crime is not sufficient, even if the defendant intended or was willing for the crime to be committed[cite: 29]. C is incorrect because the words of encouragement need not create a new danger for liability to be imposed[cite: 29]. D is incorrect for two reasons: First, under some circumstances, words alone might be sufficient, and second, here, the words were coupled with intent[cite: 29]."
    },
    // FACT PATTERN 14 (Q14)
    {
        id: 14,
        ...
        ans: 3,
        exp: "Depending on the seriousness of the wrongdoing, a defendant who engages in wrongful conduct that results in a homicide is guilty of either involuntary homicide or second-degree murder[cite: 29]. Involuntary homicide is appropriate when the wrongful conduct did not create a very high risk of death or serious injury[cite: 29]. Here, poisoning the water to make the players sick was unlikely to cause death or serious injury[cite: 29]. In fact, the player died because of a peanut allergy, not through the actions of the chemical itself[cite: 29].\n\nA is incorrect because the student did not intend to kill anyone[cite: 29]. B is incorrect because the student was not engaging in an inherently dangerous felony[cite: 29]. Even if she was, such a murder is traditionally second-degree murder[cite: 29]. C is incorrect because the poisoning did not create a high risk of death or serious injury, so it could not be second-degree murder under abandoned and malignant heart[cite: 29]."
    },
    // FACT PATTERN 15 (Q15)
    {
        id: 15,
        ...
        ans: 2,
        exp: "Although statutory rape is sometimes called a strict liability crime, this means only that liability can be imposed even though the defendant was not aware that the female with whom he was having intercourse was underage[cite: 29]. No liability can be imposed, however, unless the defendant had intent to engage in intercourse[cite: 29].\n\nA is incorrect because liability for involuntary manslaughter may be imposed if the victim's death resulted from reckless conduct by the defendant[cite: 29]. Driving while drunk may be sufficiently reckless to result in liability[cite: 29]. C is incorrect because even if the defendant did not know that she was drunk, it may have been reckless for her to drive while she knew that her vision and motor abilities were impaired[cite: 29]. Since voluntary manslaughter is the killing of a human being with the intent to kill or to cause great bodily harm under circumstances of great emotional distress, D is incorrect because the facts asserted by the defendant would inculpate rather than exculpate him[cite: 29]."
    },
    // FACT PATTERN 16 (Q16)
    {
        id: 16,
        ...
        ans: 2,
        exp: "Murder is defined as criminal homicide with malice aforethought[cite: 29]. Since homicide involves an act that causes the death of a human being, and since the victim's death in C did not result from the defendant's act, the defendant could not be guilty of murdering the victim[cite: 29].\n\nMalice aforethought is the intent to kill, the intent to cause great bodily harm, the intent to commit a felony, the intent to escape from lawful custody, or acting with wanton disregard for human life[cite: 29]. A is incorrect because the defendant's desire to cause the victim great bodily harm might constitute malice aforethought[cite: 29]. B is incorrect because knowledge of the victim's identity is not a material element of either murder or of malice aforethought[cite: 29]. Since the defendant did intend to cause the victim's death, he had the requisite mens rea, even though he believed the victim to be someone else[cite: 29]. D is incorrect for two reasons: First, shooting at the bank guard was a felony, and the intent to commit a felony may constitute malice aforethought in a prosecution for the death of any person killed during the course of that felony, and second, starting a gun battle in a bank can be regarded as wanton disregard for human life, which may also constitute malice aforethought[cite: 29]."
    },
    // FACT PATTERN 17 (Q17)
    {
        id: 17,
        ...
        ans: 3,
        exp: "Kidnapping is defined as the intentional asportation and confinement of a person against that person's will, by force or threat, and without lawful authority[cite: 29]. Since the defendant did not know that the daughter was in the car when he drove it away, he lacked the requisite intent[cite: 29].\n\nA is therefore incorrect[cite: 29]. B is incorrect because kidnapping has no equivalent of the felony-murder rule[cite: 29]. C is incorrect since if he knew that the daughter was in the car, the defendant could be guilty of kidnapping even if the asportation of the daughter was secondary to his stealing of the car[cite: 29]."
    },
    // FACT PATTERN 18 (Q18)
    {
        id: 18,
        ...
        ans: 1,
        exp: "Since the statute prohibits possession of a skeleton key with the intent to commit an unlawful entry, and since the defendant was, in fact, attempting to effect an unlawful entry with his skeleton key, he is guilty of violating the statute[cite: 29].\n\nA is incorrect because the fact that the defendant was a professional thief is not enough to make him guilty of violating any law, even one designed to protect the public against professional thieves[cite: 29]. The crime defined by the statute would merge into the crime of attempted burglary if the defendant was charged with or convicted of attempted burglary[cite: 29]. But in the absence of an attempted burglary charge, there is no reason why the lesser crime cannot be prosecuted[cite: 29]. C is therefore incorrect[cite: 29]. A careful reading of the statute discloses that it punishes conduct (i.e., possession of a skeleton key) coupled with a guilty mind[cite: 29]. D is therefore incorrect[cite: 29]."
    },
    // FACT PATTERN 19 (Q19)
    {
        id: 19,
        ...
        ans: 0,
        exp: "Duress is not a defense to murder because one person's life is not more important than another person's life[cite: 29]. Here, the hostage clearly intended to kill the policeman, and the fact that he did so under duress does not change the analysis[cite: 29].\n\nB is incorrect because he clearly intended to kill the policeman when he decided to shoot him[cite: 29]. C and D are incorrect because they would not excuse taking the life of another[cite: 29]."
    },
    // FACT PATTERN 20 (Q20)
    {
        id: 20,
        ...
        ans: 2,
        exp: "One who intentionally aids or facilitates the commission of a crime is guilty of the crime as an accessory[cite: 29]. Robbery is larceny committed by force or threat of force[cite: 29]. Although the defendant did not point a gun and demand money, she aided and abetted the student by operating the getaway car[cite: 29]. She is thus guilty as an accessory[cite: 29]. Conspiracy is an agreement to commit a crime made by two or more people who have specific intent[cite: 29]. The defendant and the student committed the crime of conspiracy when they agreed on the commission of the robbery[cite: 29].\n\nA, B, and D are incorrect because the crime of conspiracy is separate from and does not merge into the substantive crime that the conspirators agreed to commit[cite: 29]."
    },
    // FACT PATTERN 21 (Q21)
    {
        id: 21,
        ...
        ans: 1,
        exp: "A defendant is guilty of murder when he or she proximately causes the death of another human being unlawfully and with malice aforethought[cite: 29]. Malice aforethought consists of the intent to kill, the intent to cause great bodily harm, escape from lawful custody, the commission of a felony, or reckless disregard for human life[cite: 29]. Since there are no facts indicating that the defendant in B intended to kill or cause harm, was escaping from lawful custody, or engaged in conduct demonstrating a reckless disregard for human life, the only way he could be convicted of murder would be if the pedestrian's death proximately resulted from the commission of a felony[cite: 29]. There is no fact indicating that violation of the insurance statute was a felony[cite: 29]. Even if it was, the violation was not causally related to the pedestrian's death since the death would have occurred whether or not the vehicle was insured[cite: 29]. For this reason, the defendant could not be convicted of murder[cite: 29].\n\nAn unlawful killing committed with the intent to kill or inflict great bodily harm might be voluntary manslaughter if the defendant was acting under extreme emotional distress or mistaken justification[cite: 29]. The defendant in A might still be convicted of murder, however, because the lapse of time between his discovery of the atrocity that the neighbor committed and his killing of the neighbor could prevent a court from finding that he was acting under extreme emotional distress[cite: 29]. A is therefore incorrect[cite: 29]. Although the defendant in C did not have an intent to kill, his conduct might be regarded as sufficiently reckless to result in a conviction for murder[cite: 29]. Although it is possible that the defendant in D was acting under sufficient emotional distress for the killing to be regarded as voluntary manslaughter rather than murder, courts rarely make special allowances for 'mercy' killings[cite: 29]. D is therefore incorrect[cite: 29]."
    },
    // FACT PATTERN 22 (Q22)
    {
        id: 22,
        ...
        ans: 1,
        exp: "A person is guilty of a criminal attempt when, with the specific intent to bring about a criminally prohibited result, he or she performs some act that comes substantially close to achieving that result[cite: 29]. Many jurisdictions hold that if the result that the defendant specifically intended to bring about was not a crime, the defendant cannot be guilty of a criminal attempt[cite: 29]. This is sometimes known as the doctrine of legal impossibility[cite: 29]. Although not all jurisdictions recognize this defense, it is the only argument listed that could furnish the defendant with an effective defense in any jurisdiction[cite: 29].\n\nSince the elements of criminal attempt are often included among the elements of the substantive crime that was attempted, criminal attempts are often lesser included offenses of the substantive crimes[cite: 29]. Lesser offenses are said to merge with the crime in which they are included, which means that a person who is convicted of a substantive crime cannot also be convicted of attempting it[cite: 29]. There is no requirement that a defendant be prosecuted for the highest or most serious crime resulting from his or her act, however[cite: 29]. This means that a prosecutor may choose to charge a defendant with attempting a crime, even if a conviction for the substantive crime could have been obtained[cite: 29]. For this reason, the fact that the defendant actually succeeded in killing a bird would not prevent his conviction for attempting to do so, and A and D are incorrect[cite: 29]. A person is in pari delicto with another when they are equally guilty[cite: 29]. Since the friend did not commit or attempt to commit a crime, he is not guilty of anything and therefore is not in pari delicto with the defendant[cite: 29]. C is therefore incorrect[cite: 29]."
    },
    // FACT PATTERN 23 (Q23)
    {
        id: 23,
        ...
        ans: 0,
        exp: "If a death occurs during a felony or attempted felony, the defendant is guilty of felony murder[cite: 29]. Importantly, the felony does not end until the defendant reaches a place of safety[cite: 29]. Here, the man committed attempted robbery at the store, a felony[cite: 29]. The death occurred while the man was still fleeing, so the felony was not over yet[cite: 29]. Thus, the most serious crime the man can be convicted of is felony murder[cite: 29].\n\nB is incorrect because the simple fact the murder was accidental would not take it out of the felony-murder rule[cite: 29]. C is incorrect because the overriding felony was still ongoing[cite: 29]. D is incorrect, because the man committed attempted robbery and the illegally parked car would not change the fact that the bus driver was killed during the man's commission of an attempted felony[cite: 29]."
    },
    // FACT PATTERN 24 (Q24)
    {
        id: 24,
        ...
        ans: 3,
        exp: "Arson is the intentional or reckless burning of the dwelling of another[cite: 29]. Although the defendant caused the burning of the homeowner's dwelling, he did not do so intentionally since he believed that there would be no damage[cite: 29]. (Note: Although some jurisdictions hold that a reckless burning may be arson, the facts indicate that the defendant acted reasonably.)[cite: 29]\n\nAlthough violation of a statute may be evidence of negligence or even of recklessness, a statutory violation is not in itself sufficient to satisfy the mens rea requirement for arson[cite: 29]. A is therefore incorrect[cite: 29]. B is incorrect because it would impose criminal liability without the necessary mens rea[cite: 29]. C is incorrect because consent by the homeowner to the defendant's use of fireworks is not equivalent to consent to the burning of his home[cite: 29]."
    },
    // FACT PATTERN 25 (Q25)
    {
        id: 25,
        ...
        ans: 1,
        exp: "Murder is a killing with malice aforethought[cite: 29]. Malice aforethought includes wanton disregard for human life, which means acting in deliberate disregard of the plain and strong likelihood that death or great bodily harm would result[cite: 29]. Operating a motor vehicle at a speed of 100 miles per hour might or might not be found to constitute wanton disregard for human life, but of the reasons listed, B is the only one that could result in a conviction for murder[cite: 29].\n\nA is incorrect for two reasons: First, culpable negligence is insufficient to constitute malice aforethought, and second, the facts do not indicate that the defendant was intoxicated at the time the accident occurred[cite: 29]. Under the misdemeanor-manslaughter rule, a death resulting from the commission of a misdemeanor might be classified as manslaughter[cite: 29]. Since driving without a license carries a maximum sentence of less than one year (i.e., 30 days), it is properly classified as a misdemeanor[cite: 29]. C and D are incorrect, however, because the misdemeanor-manslaughter rule cannot lead to a conviction for murder[cite: 29]."
    }
];